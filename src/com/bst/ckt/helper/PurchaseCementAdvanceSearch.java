...
public class PurchaseCementAdvanceSearch implements Comparable<Object>,Serializable{
	...
	public PurchaseCementAdvanceSearch()
	{
		//do nothing.
		
	}
	
	public PurchaseCementAdvanceSearch(int id)
	{
		this.id=id;
		
	}
	
	public PurchaseCementAdvanceSearch(String value)
	{
		this.value=value;
		
	}
	
	public PurchaseCementAdvanceSearch(int id,String value)
	{
		this.value=value;
		this.id=id;
	}
	...
	public static String getPurchaseCementSearchValue(int advanceSearchId)
	{
	...
	public static HashMap<Integer, String> getPurchaseCementSearchList()
	{
