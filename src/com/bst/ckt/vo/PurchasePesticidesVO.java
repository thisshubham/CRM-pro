...
public class PurchasePesticidesVO {
	...
	private int dealerRef;
	private String placeOfSupply;
	private String district;
	private String materialCode;
	private String hsnCode;
	private int quantity;
	private String modeOfTtansport;
	...
	public int getDealerRef() {
		return dealerRef;
	}
	public void setDealerRef(int dealerRef) {
	...
	public String getModeOfTtansport() {
		return modeOfTtansport;
	}
	public void setModeOfTtansport(String modeOfTtansport) {
		this.modeOfTtansport = modeOfTtansport;
	}
