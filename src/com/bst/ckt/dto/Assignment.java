...
public class Assignment {
	...
	/**
	 * @return the assignmentOwner
	 */
	public String getAssignmentOwner() {
		return assignmentOwner;
	}
	/**
	 * @param assignmentOwner the assignmentOwner to set
	 */
	...
	/**
	 * @param expectedClosingDate the expectedClosingDate to set
	 */
	...
	/**
	 * @return the weightedRevenue
	 */
	public String getWeightedRevenue() {
		return weightedRevenue;
	}
	/**
	 * @param weightedRevenue the weightedRevenue to set
	 */
	public void setWeightedRevenue(String weightedRevenue) {
		this.weightedRevenue = weightedRevenue;
	}
	/**
