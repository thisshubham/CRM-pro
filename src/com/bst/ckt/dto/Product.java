...
public class Product  {
	...
	/**
	 * @return the supportExpiryDate
	 */
	public String getSupportExpiryDate() {
		return supportExpiryDate;
	}
	/**
	 * @param supportExpiryDate the supportExpiryDate to set
	 */
	public void setSupportExpiryDate(String supportExpiryDate) {
	...
	/**
	 * @return the mrfPartNo
	 */
	public String getMrfPartNo() {
		return mrfPartNo;
	}
	/**
	 * @param mrfPartNo the mrfPartNo to set
	 */
	public void setMrfPartNo(String mrfPartNo) {
		this.mrfPartNo = mrfPartNo;
	}
	/**
	 * @return the vendorPartNo
	 */
	public String getVendorPartNo() {
		return vendorPartNo;
	}
	/**
	 * @param vendorPartNo the vendorPartNo to set
	 */
	public void setVendorPartNo(String vendorPartNo) {
		this.vendorPartNo = vendorPartNo;
	}
	/**
	 * @return the productSheet
	 */
	public String getProductSheet() {
		return productSheet;
	}
	/**
	 * @param productSheet the productSheet to set
	 */
	...
	/**
	 * @param usageUnit the usageUnit to set
	 */
	...
	/**
	 * @return the qtyInDemand
	 */
	public int getQtyInDemand() {
		return qtyInDemand;
	}
	/**
	 * @param qtyInDemand the qtyInDemand to set
	 */
