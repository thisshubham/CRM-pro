 ...
 * 
 * Class Name     CreateFailedException.java     
 *                                                            
 ...
 * This exception will be thrown when error occurs while inserting data in DB.</p>
 * @author Yogendra Singh Rajput
 * @version 1.0
 */

public class CreateFailedException extends OMIApplicationException
{
    private static final long serialVersionUID = -5829545098534135052L;

    
    /**
     * <p>Creates a new <code>CreateFailedException</code> object.
     */
     ...
     */
    public CreateFailedException(String errorMessage)
    {
     ...
     */
    public CreateFailedException(String errorMessage, Throwable t)
    {
        this.errorMessage = errorMessage;
        this.initCause(t);
    }
     ...
     * @param errorMessage  Message to be set when exception is thrown
     */
    public CreateFailedException(int errorCode, String errorMessage)
    {
     ...
     * @param t Throwable   Object to be rethrown to set the cause of the exception
     */
    public CreateFailedException(int errorCode, String errorMessage, Throwable t)
    {
        this.errorCode = errorCode;
        this.errorMessage = errorMessage;
        this.initCause(t);
