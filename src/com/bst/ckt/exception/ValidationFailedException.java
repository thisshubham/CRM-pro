 ...
 * 
 * Class Name     ValidationFailedException.java     
 *                                                            
 ...
 * This exception will be thrown when error occurs while performing validations..</p>
 * @author Yogendra Singh Rajput
 * @version 1.0
 */
public class ValidationFailedException extends OMIApplicationException
{
    private static final long serialVersionUID = -5829545098534135052L;

   /**
     * <p>Creates a new <code>ValidationFailedException</code> object.
     */
   ...
   /**
     ...
     */
    public ValidationFailedException(String errorMessage, Throwable t)
    {
        this.errorMessage = errorMessage;
        this.initCause(t);
    }
     ...
     * @param errorMessage 	   Message to be set when exception is thrown
     */
    public ValidationFailedException(int errorCode, String errorMessage)
    {
     ...
     * @param t 			  Throwable object to be rethrown to set the cause of the exception
     */
    public ValidationFailedException(int errorCode, String errorMessage, Throwable t)
    {
        this.errorCode = errorCode;
        this.errorMessage = errorMessage;
        this.initCause(t);
