 ...
 * 
 * Class Name     DeleteFailedException.java     
 *                                                            
 ...
 * This exception will be thrown when error occurs while deleting data from DB..</p>
 * @author Yogendra Singh Rajput
 * @version 1.0
 */

public class DeleteFailedException extends OMIApplicationException
{
    private static final long serialVersionUID = -5829545098534135052L;

    /**
     * <p>Creates a new <code>DeleteFailedException</code> object.
     */
     ...
     */
    public DeleteFailedException(String errorMessage, Throwable t)
    {
        this.errorMessage = errorMessage;
        this.initCause(t);
    }
     ...
     * @param errorMessage 	Message to be set when exception is thrown
     */
    public DeleteFailedException(int errorCode, String errorMessage)
    {
     ...
     * @param t 			Throwable object to be rethrown to set the cause of the exception
     */
    public DeleteFailedException(int errorCode, String errorMessage, Throwable t)
    {
        this.errorCode = errorCode;
        this.errorMessage = errorMessage;
        this.initCause(t);
