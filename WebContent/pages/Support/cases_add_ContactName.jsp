...
<script type="text/javascript">
	...
	/* This function will check the existing  Contact name*/
	function isCasesContactNameExist(contactName) {
		xmlhttp.onreadystatechange = function() {
			if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
				document.getElementById("server1Response").innerHTML = xmlhttp.responseText;
			}
		};
		xmlhttp.open("GET", "isCasesContactNameExist.action?contactName=" + contactName,
				true);
		xmlhttp.send();
	}
</script>
...
<body>
				...
				<div class="box">
					...
					<div class="pull-left">
						<a class="icons" type="button" onclick="window.close();" href=""
							...
							data-original-title="Back To New Cases"> <i
							class="fa fa-th-large"></i>
						</a>
						<h5>
							<s:text name="Support.cases.contact.name" />
						</h5>
					</div>
					...
					<div class="row">
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
									...
									<s:else>
										<div class="alert alert-info" role="alert"
											...
											<div class="infoIcon">
												...
												<s:text name="Support.cases.contact.infobar" />
											</div>
										</div>
									</s:else>
								</p>
							...
							<div class="row">
								<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
									<s:form name="contactNameForm" action="addCasesContactName"
											...
											<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
												<div class="col-lg-8 col-md-8 col-sm-8 col-xs-5 ">
													<s:textfield name="contactName" id="contactName"
														placeholder="Enter Contact Name" cssClass="form-control"
														onblur="isContactNameExist(contactName.value);" />
													<div id='contactNameForm_contactName_errorloc'
									...
									<div
										...
										<table class="table table-bordered responsive-table"
											...
											<thead style="background-color: gray; color: white;">
												<tr>
													<th><s:text name="Support.cases.contact.name" /></th>
												</tr>
											</thead>
											<tbody>
												<s:iterator value="contactNameGrid">
													<tr>
	...
	<script type="text/javascript">
		var frmvalidator = new Validator("contactNameForm");
		frmvalidator.EnableOnPageErrorDisplay();
		frmvalidator.EnableMsgsTogether();

		//Validation for lead title.
		frmvalidator.addValidation("contactName", "req", "Enter Contact Name");
		frmvalidator.addValidation("contactName", "maxlen=50",
				"Maximun Length Of Contact Name Should Be 50 Characters");
	</script>
</body>
</html>