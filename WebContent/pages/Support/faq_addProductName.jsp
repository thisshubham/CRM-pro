...
<script type="text/javascript">
	...
	function isFaqProductNameExist(productName) {
		xmlhttp.onreadystatechange = function() {
			if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
				document.getElementById("server1Response").innerHTML = xmlhttp.responseText;
			}
		};
		xmlhttp.open("GET", "isProductNameExists.action?productName=" + productName,
				true);
		xmlhttp.send();
	}
</script>
				...
				<div class="box">
					...
					<div class="pull-left">
						<a class="icons" type="button" onclick="window.close();" href=""
							...
							data-original-title="Back To New Faq"> <i
							class="fa fa-th-large"></i>
						</a>
						<h5>
							<s:text name="support_addFaq.product.name" />
						</h5>
					</div>
					...
					<div class="row">
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
							...
							<div class="row">
								<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
									<s:form name="productNameForm" action="addFaqProductName"
											...
											<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
												<div class="col-lg-8 col-md-8 col-sm-8 col-xs-5 ">
													<s:textfield name="productName" id="productName"
														...
														onblur="isFaqProductNmaeExist(productName.value);" />
									...
									<div
										...
										<table class="table table-bordered responsive-table"
											...
											<thead style="background-color: gray; color: white;">
												<tr>
													<th><s:text name="support_addFaq.product.name" /></th>
												</tr>
											</thead>
											<tbody>
												<s:iterator value="productNameGrid">
													<tr>
