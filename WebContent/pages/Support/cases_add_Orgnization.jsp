...
<script type="text/javascript">
	...
	/* This function will check the existing Orgnization*/
	function isCasesOrgnizationExist(productName) {
		xmlhttp.onreadystatechange = function() {
			if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
				document.getElementById("server1Response").innerHTML = xmlhttp.responseText;
			}
		};
		xmlhttp.open("GET", "isCasesOrgnizationExist.action?orgnization=" + orgnization,
				true);
		xmlhttp.send();
	}
</script>
...
<body>
			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<div class="box">
					...
					<div class="pull-left">
						...
						<h5>
							<s:text name="Support.cases.organization.name" />
						</h5>
					</div>
					...
					<div class="row">
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
									...
									<s:else>
										<div class="alert alert-info" role="alert"
											...
											<div class="infoIcon">
												...
												<s:text name="Support.cases.orgnization.infobar" />
											</div>
										</div>
									</s:else>
								</p>
							...
							<div class="row">
								<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
									<s:form name="casesOrgnizationForm" action="addCasesOrganizationName"
										class="form-horizontal" id="block-validate">
										<div class="row">
											<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
												<div class="col-lg-8 col-md-8 col-sm-8 col-xs-5 ">
													<s:textfield name="organiztionaName" id="organizationName"
														placeholder="Enter Orgnization Name" cssClass="form-control"
														onblur="isCasesOrgnizationExist(orgnization.value);" />
													<div id='casesOrgnizationForm_orgnization_errorloc'
									...
									<div
										...
										<table class="table table-bordered responsive-table"
											...
											<thead style="background-color: gray; color: white;">
												<tr>
													<th><s:text name="Support.cases.organization.name" /></th>
												</tr>
											</thead>
											<tbody>
												<s:iterator value="casesOrganizationNameGrid">
													<tr>
														<td><s:property value="organiztionaName" /></td>
													</tr>
												</s:iterator>
											</tbody>
										</table>
	...
	<script type="text/javascript">
		var frmvalidator = new Validator("casesOrgnizationForm");
