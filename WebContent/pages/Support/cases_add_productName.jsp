...
<script type="text/javascript">
	...
	function isCasesProductNameExist(productName) {
		...
		xmlhttp.open("GET", "isCasesProductNameExist.action?productName=" + productName,
				true);
		xmlhttp.send();
	}
</script>
				...
				<div class="box">
					...
					<div class="row">
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
							...
							<div class="row">
								<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
									<s:form name="productNameForm" action="addCasesProductName"
											...
											<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
												<div class="col-lg-8 col-md-8 col-sm-8 col-xs-5 ">
													<s:textfield name="productName" id="productName"
														...
														onblur="isProductNameExist(ProductName.value);" />
