...
<script type="text/javascript">
	...
	function isSlaNameExist(slaName) {
		...
		xmlhttp.open("GET", "isSlaNameExist.action?slaName=" + slaName,
				true);
		xmlhttp.send();
	}
</script>
...
<body>
			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<div class="box">
					...
					<div class="pull-left">
						...
						<h5>
							<s:text name="Support.cases.sla.name" />
						</h5>
					</div>
									...
									<s:else>
										<div class="alert alert-info" role="alert"
											...
											<div class="infoIcon">
												...
												<s:text name="Support.cases.sla.infobar" />
											</div>
										</div>
									</s:else>
								</p>
										...
										<div class="row">
											<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
												<div class="col-lg-8 col-md-8 col-sm-8 col-xs-5 ">
													<s:textfield name="slaName" id="slaName"
														placeholder="Enter Sla Name" cssClass="form-control"
														onblur="isCasesSlaNameExist(SlaName.value);" />
													<div id='slaNameForm_slaName_errorloc'
									...
									<div
										...
										<table class="table table-bordered responsive-table"
											...
											<thead style="background-color: gray; color: white;">
												<tr>
													<th><s:text name="Support.cases.sla.name" /></th>
												</tr>
											</thead>
											<tbody>
												<s:iterator value="casesGridList">
													<tr>
														<td><s:property value="slaName" /></td>
													</tr>
												</s:iterator>
											</tbody>
										</table>
	...
	<script type="text/javascript">
		var frmvalidator = new Validator("slaNameForm");
		frmvalidator.EnableOnPageErrorDisplay();
		frmvalidator.EnableMsgsTogether();

		//Validation for lead title.
		frmvalidator.addValidation("slaName", "req", "Enter Sla Name");
		frmvalidator.addValidation("slaName", "maxlen=50",
				"Maximun Length Of Sla Name Should Be 50 Characters");
	</script>
</body>
</html>