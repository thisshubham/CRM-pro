...
<body>
				...
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<ol class="breadcrumb" style="margin-top: 10px;">
							...
							<li><a href="settingFinanceGLaccount.action" class="active"><s:text
							...
							<li class="active"><s:text name="Edit GL Account "></s:text></li>


						</ol>
						<div class="box ">
							<s:form class="form-horizontal" action="settingUpdateGLAccount"
								name="finanaceEditGLAccountForm">
								<header>
								<div class="icons">
																...
																<s:else>
																	<div class="alert alert-info" role="alert"
																		...
																		<div class="infoIcon">
																			...
																			<s:text
																				name="setting.finance.GLaccount.edit.information.bar" />
																		</div>
																	</div>
																</s:else>
															</p>
														...
														<div class="row" style="margin-top: 20px;">
															...
															<div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
																<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
																	...
																	<div
																		id='finanaceEditGLAccountForm_glAccountName_errorloc'
	...
	<script type="text/javascript">
		var frmvalidator = new Validator("finanaceEditGLAccountForm");
		frmvalidator.EnableOnPageErrorDisplay();
		frmvalidator.EnableMsgsTogether();
		frmvalidator.addValidation("glAccountName", "req",
				"Please Enter GL AccountName");
		frmvalidator.addValidation("description", "maxlen=4000",
				"Enter Description detail below 4000");
		frmvalidator.addValidation("glAccountName", "req",
				"Please Enter GL Account Name");
		frmvalidator.addValidation("glAccountName", "maxlen=100",
