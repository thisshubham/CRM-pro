...
<body>
					...
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<ol class="breadcrumb" style="margin-top: 10px;">
							...
							<li><a href="assignmentsDashboard.action"><s:text
										name="Assignments Dashboard"></s:text></a></li>

							<li class="active"><s:text name="Edit Assignment"></s:text></li>
						</ol>
						<s:form name="editAssignmentForm" action="updateAssignments"
								...
								<div class="pull-right">
									<div class="btn-group">
										...
										<a
											...
											href="#.action" class="btn btn-default btnheight"><i
										...
										<s:else>
											...
											<div class="alert alert-info" role="alert"
												...
												<div class="infoIcon">
													...
													<s:text name="You can edit assignment here" />
												</div>
											</div>
										</s:else>
									</p>
										...
										<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
											<div class="row form-group">
												<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
													<s:text name="add.new.assignment.assignment.name" />
													<div class="star">*</div>
												</div>
												<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
													<s:textfield type="text" name="assignmentName"
														cssClass="form-control" tabindex="1" />
													<div id='editAssignmentForm_assignmentName_errorloc'
										...
										<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
											<div class="row form-group">
												...
												<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
													...
													<div id='editAssignmentForm_assignmentOwner_errorloc'
														class="error_strings"></div>
												</div>
										...
										<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
											<div class="row form-group">
												...
												<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
													...
													<div id='editAssignmentForm_expectedClosing_errorloc'
														class="error_strings"></div>
												</div>
											</div>
										</div>
											...
											<div class="row form-group">
												...
												<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
													<s:select name="leadSource" id=""
														...
														list="leadSourceNameList" headerKey="1" tabindex="9" />
											...
											<div class="row form-group">
												...
												<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
													...
													<s:select cssClass="form-control chzn-select"
														...
														headerKey="-1" headerValue="Select Assigned To" />
													<div id='editAssignmentForm_assignedTo_errorloc'
														class="error_strings"></div>
												</div>
											</div>
										</div>
											...
											<div class="row form-group">
												...
												<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
													<s:textfield type="text" name="probability"
														cssClass="form-control" tabindex="1" />
													<div id='editAssignmentForm_probability_errorloc'
														class="error_strings"></diV>
												</div>
											</div>
										</div>
											...
											<div class="row form-group">
												...
												<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
													<s:textfield type="text" name="primaryEmailId"
														cssClass="form-control" tabindex="1" />
													<div id='editAssignmentForm_priEmailId_errorloc'
														class="error_strings"></diV>
												...
												<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
													<div class="row">
														<div class="col-lg-3 col-md-3 col-sm-3 col-xs-3"
															...
															<div id='editAssignmentForm_phoneIsd_errorloc'
																class="error_strings"></div>
														...
														<div class="col-lg-3 col-md-3 col-sm-3 col-xs-3"
															...
															<div id='editAssignmentForm_phoneStd_errorloc'
																class="error_strings"></div>
														...
														<div class="col-lg-5 col-md-5 col-sm-5 col-xs-5"
															...
															<s:textfield name="phoneNumber" cssClass="form-control"
																...
																tabindex="28" />
															<div id='editAssignmentForm_phoneNo_errorloc'
																class="error_strings"></div>
									...
									<div class="row">
										<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
											<div class="row form-group">
												...
												<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
													<s:select name="assignmentStatus" id=""
														cssClass="form-control chzn-select"
														list="assignmentStatusList" headerKey="1" tabindex="9" />
												</div>
											</div>
										</div>
									...
									<div class="form-group">
										<div class="row" style="margin: 1% 2%;" id="data_grid">
											<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
												...
												<div id='editAssignmentForm_description_errorloc'
													class="error_strings"></div>
											</div>
										</div>
									</div>
	...
	<script type="text/javascript">
		var frmvalidator = new Validator("editAssignmentForm");
		...
		frmvalidator.addValidation("phoneIsd", "minlen=2",
				"Minimum 2 no are required");
		frmvalidator.addValidation("phoneIsd", "maxlen=5",
				"Maximum 4 no are allowed");

		//validation for STD.
		frmvalidator.addValidation("phoneStd", "numeric",
				"STD No should be digits");
		frmvalidator.addValidation("phoneStd", "req", "Enter STD No.");
		frmvalidator.addValidation("phoneStd", "minlen=3",
				"Minimum 3 no are required");
		frmvalidator.addValidation("phoneStd", "maxlen=6",
				"Maximum 6 no are allowed");
