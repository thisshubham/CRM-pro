			...
			<div class="box">
				<div class="container-fluid">
					<ol class="breadcrumb" style="margin-top: 10px;">
						...
						<li> <a href="productDashboard.action"><s:text name="Purchase WallPaint"></s:text></li>
					...
					<h5>
						<s:text name="View WallPaint Purchase Details" />
					</h5>
					<div class="pull-right">
						<div class="btn-group">
								...
								href="PurchaseWallPaintPDF?command=<s:property value='purchaseId' />"
								...
								href="viewPreviousPurchaseWallpaintInfo.action?command=<s:property value='purchaseId' />"
								...
								href="viewNextPurchaseWallpaintInfo.action?command=<s:property value='purchaseId' />"
									...
									<div class="alert alert-info" role="alert">
										<div class="infoIcon">
											<i class="fa fa-info-circle "> <s:text
													name=" You can view wallpaint purchase from here" /></i>
										</div>
									</div>
								</s:else>
							</p>
							...
							<%-- 	<s:iterator value="purchaseCementVO" var="testObje"> --%>
									<div class="row">
										<div
											...
											<h5>
												<s:text name="WallPaint Purchase Information" />
											</h5>
										</div>
									</div>
						...
						<div class="row">
									...
									<div class="row">
										<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"
											align="center">
											<a href="purchasePaint" data-toggle="tooltip"
