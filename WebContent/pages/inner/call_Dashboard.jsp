								...
								<div class="table-responsive">
											...
											<div class="col-lg-4  col-md-4  col-sm-12 col-xs-12">
												<div class="col-lg-6  col-md-6  col-sm-12 col-xs-12">
													<div class="form-group" style="margin-left: 14px;">
														<a href="addCreatedCall.action" data-toggle="tooltip"
									...
									<table id="dataTable"
										...
										<tbody>
											...
											<tr>
												<td><a href="viewFollowUpCall.action" id="row_a_link">12546358958</a></td>
												...
												<td><div class="btn-group">
													...
													<div class="btn-group">
														<a href="updateFollowUpCall.action" data-toggle="tooltip"
