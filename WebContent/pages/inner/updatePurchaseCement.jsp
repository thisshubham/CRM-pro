...
<title>Update Cement Purchase</title>

<%-- <script type="text/javascript" src="outer/js/angular.min.js"></script> --%>
<script>
			...
			<div class="inner bg-light lter">
				...
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						...
						<s:form name="addCreatedProductForm" action="updatePurchaseDetail"
							id="block-validate">
							<div class="box dark">
								<header>
								<div class="pull-left">
												...
												<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
													<div class="row">
														...
														<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="amountIdDiv">
															<s:textfield  name="netAmount" id="amountId"
																cssClass="form-control" tabindex="22"  /><!--  value='{{uprice }}' -->
															<div id='addCreatedProductForm_weekNo_errorloc'
																class="error_strings"></div>
														</div>
													</div>
