...
<body>
				...
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<ol class="breadcrumb" style="margin-top: 10px;">
							...
							<li class="active"><s:text
									name="setting.support.task.Area.navigation.bar"></s:text></li>

						</ol>
						<div class="box ">
							<s:form class="form-horizontal" action="insertTaskAreaDetails"
								name="supportTaskAreaForm">
								<header>
								<div class="icons">
								...
								<div class="pull-right">
									<div class="btn-group">
										...
										<a href="settingSupportTaskArea.action" data-toggle="tooltip"
									...
									<div class="col-lg-12  col-md-12  col-sm-12 col-xs-12"
										...
										<ul class="nav nav-tabs" role="tablist">
											...
											<li role="presentation" class="active"><a
												href="settingSupportTaskArea.action"
																...
																<s:else>
																	<div class="alert alert-info" role="alert"
																		...
																		<div class="infoIcon">
																			...
																			<s:text
																				name="setting.support.task.Area.information.bar" />
																		</div>
																	</div>
																</s:else>
															</p>
														...
														<div class="row">
															...
															<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
																<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
																	<s:text name="setting.support.task.Area.label"></s:text>
																	<div class="star">*</div>
																</div>
																<div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
																	...
																	<div id='supportTaskAreaForm_taskarea_errorloc'
															...
															<thead>
																<tr id="myrow">
																	...
																	<th style="width: 20%;"><s:text
																			name="setting.support.FAQcategory.id"></s:text></th>
																	<th><s:text name="setting.support.task.Area.label"></s:text></th>
																</tr>
															</thead>
															<tbody>
																<s:iterator value="showSupportTaskAreaList">
																	<tr>
																		<td align="center">
																			<div class="btn-group">
	...
	<script type="text/javascript">
		var frmvalidator = new Validator("supportTaskAreaForm");
		frmvalidator.EnableOnPageErrorDisplay();
		frmvalidator.EnableMsgsTogether();
		frmvalidator.addValidation("taskarea", "req", "Please Enter Task Area");
		frmvalidator.addValidation("taskarea", "maxlen=100",
				"Please Enter maxlen 100");
		frmvalidator.addValidation("taskarea", "minlen=3",
