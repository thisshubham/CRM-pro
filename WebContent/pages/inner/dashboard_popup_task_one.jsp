...
<title>dashboard_task_window_one</title>
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<div class="alert alert-info" role="alert"><s:text name="dashboard.task.informationbar"/> </div>
				<div class="panel panel-default">
					<div class="panel-body">


						<s:form name="myform" id="myform" cssClass="form-horizontal" action=""
							method="post">
							<div class="form-group">
								<label class="col-sm-2 control-label"><s:text name="dashboard.task.subject"/><span
							...
							<div class="form-group">
								<label class="col-sm-2 control-label"><s:text name="dashboard.task.description"/><span
									class="error_strings">*</span></label>
								<div class="col-sm-10">
									<s:textarea cssClass="form-control" rows="3" name="description"/>
									<div id='myform_description_errorloc' class="error_strings"></div>
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-2 control-label"><s:text name="dashboard.task.date"/><span
									class="error_strings">*</span></label>
								<div class="col-sm-10">
									<div class="input-group bootstrap-datepicker">
										<s:textfield type="text" cssClass="form-control" id="dp1" name="date"/>
							...
							<div class="form-group">
								<label class="col-sm-2 control-label"><s:text name="dashboard.task.time"/><span
									class="error_strings">*</span></label>
								<div class="col-sm-10">
									<div class="input-group bootstrap-timepicker">
										<s:textfield cssClass="timepicker-24 form-control" type="text"
							...
							<div class="form-group">
								<div class="col-sm-offset-5 col-sm-7">
									...
									<button class="btn btn-default"><s:text name="project.form.button.cancel"/></button>
									<button class="btn btn-primary"><s:text name="project.form.button.submit"/></button>
								</div>
