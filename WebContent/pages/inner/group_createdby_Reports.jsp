					...
					<div class="col-lg-12">
						<div class="box">
							<header>
								...
								<h5>
									<s:text name="Search By Group Created" />
								</h5>
													...
													<div class="col-lg-9  col-md-9 col-sm-12 col-xs-12">
														<div class="row">
															<div class="col-lg-3 col-md-3 col-sm-9 col-xs-7">
																...
																<s:select list="{'1','2'}" headerKey="-1"
																	headerValue="Select Custom Search" name="customeSearch"
															...
															<div class="col-lg-2 col-md-3 col-sm-9 col-xs-7">
																<input type="text" name="leadDate" value=""
																	tabindex="14" id="dp1" class="form-control">
