											...
											<div class="center">
												...
												<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"
													...
													<div class="col-lg-1 col-md-1 col-sm-4 col-xs-4">
														<s:checkbox name="leadId"></s:checkbox>
													</div>
													<div class="col-lg-2 col-md-2 col-sm-8 col-xs-8">
														<s:text name="lead.dashboard.leadtitle"></s:text>
													</div>
													<div class="col-lg-1 col-md-1 col-sm-4 col-xs-4">
														<s:checkbox name="leadTitle" checked="checked"></s:checkbox>
													</div>
													<div class="col-lg-2 col-md-2 col-sm-8 col-xs-8">
														<s:text name="lead.dashboard.company"></s:text>
													</div>
													<div class="col-lg-1 col-md-1 col-sm-4 col-xs-4">
														<s:checkbox name="company" checked="checked"></s:checkbox>
													</div>
												</div>
												<div id="view_lable_value3"
													...
													<div class="col-lg-1 col-md-1 col-sm-4 col-xs-4">
														<s:checkbox name="companyType"></s:checkbox>
													</div>
													<div class="col-lg-2 col-md-2 col-sm-8 col-xs-8">
														<s:text name="lead.dashboard.companyCategory"></s:text>
													</div>
													<div class="col-lg-1 col-md-1 col-sm-4 col-xs-4">
														<s:checkbox name="companyCategory"></s:checkbox>
													</div>
													<div class="col-lg-2 col-md-2 col-sm-8 col-xs-8">
														<s:text name="lead.dashboard.companySector"></s:text>
													</div>
													<div class="col-lg-1 col-md-1 col-sm-4 col-xs-4">
														<s:checkbox name="companySector"></s:checkbox>
													</div>
												</div>
												<div id="view_lable_value1"
													...
													<div class="col-lg-1 col-md-1 col-sm-4 col-xs-4">
														<s:checkbox name="contactPerson" checked="checked"></s:checkbox>
													</div>
													<div class="col-lg-2 col-md-2 col-sm-8 col-xs-8">
														<s:text name="lead.dashboard.leadSourceName"></s:text>
													</div>
													<div class="col-lg-1 col-md-1 col-sm-4 col-xs-4">
														<s:checkbox name="leadSourceName"></s:checkbox>
													</div>
													<div class="col-lg-2 col-md-2 col-sm-8 col-xs-8">
														<s:text name="lead.dashboard.leadowner"></s:text>
													</div>
													<div class="col-lg-1 col-md-1 col-sm-4 col-xs-4">
														<s:checkbox name="leadOwner" checked="checked"></s:checkbox>
													</div>
												</div>
												...
												<div id="view_lable_value3"
													...
													<div class="col-lg-1 col-md-1 col-sm-4 col-xs-4">
														<s:checkbox name="annualRevenue"></s:checkbox>
													</div>
													<div class="col-lg-2 col-md-2 col-sm-8 col-xs-8">
														<s:text name="lead.dashboard.phoneNo"></s:text>
													</div>
													<div class="col-lg-1 col-md-1 col-sm-4 col-xs-4">
														<s:checkbox name="phoneNo"></s:checkbox>
													</div>
													<div class="col-lg-2 col-md-2 col-sm-8 col-xs-8">
														<s:text name="lead.dashboard.mobileNo"></s:text>
													</div>
													<div class="col-lg-1 col-md-1 col-sm-4 col-xs-4">
														<s:checkbox name="mobileNo"></s:checkbox>
													</div>
												</div>
												...
												<div id="view_lable_value1"
													...
													<div class="col-lg-1 col-md-1 col-sm-4 col-xs-4">
														<s:checkbox name="leadDate" checked="checked"></s:checkbox>
													</div>
													<div class="col-lg-2 col-md-2 col-sm-8 col-xs-8">
														<s:text name="lead.dashboard.expecteddate"></s:text>
													</div>
													<div class="col-lg-1 col-md-1 col-sm-4 col-xs-4">
														<s:checkbox name="expectedDate" checked="checked"></s:checkbox>
													</div>
													<div class="col-lg-2 col-md-2 col-sm-8 col-xs-8">
														<s:text name="lead.dashboard.leadSourceName"></s:text>
													</div>
												...
												<div id="view_lable_value3"
													...
													<div class="col-lg-1 col-md-1 col-sm-4 col-xs-4">
														<s:checkbox name="noOfAssociates"></s:checkbox>
													</div>
													<div class="col-lg-2 col-md-2 col-sm-8 col-xs-8">
														<s:text name="lead.dashboard.status"></s:text>
													</div>
													<div class="col-lg-1 col-md-1 col-sm-4 col-xs-4">
														<s:checkbox name="status" checked="checked"></s:checkbox>
													</div>
													<div class="col-lg-2 col-md-2 col-sm-8 col-xs-8">
														<s:text name="lead.dashboard.add1"></s:text>
													</div>
													<div class="col-lg-1 col-md-1 col-sm-4 col-xs-4">
														<s:checkbox name="add1"></s:checkbox>
													</div>
												</div>
												<div id="view_lable_value1"
													class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
													...
													<div class="col-lg-1 col-md-1 col-sm-4 col-xs-4">
														<s:checkbox name="city"></s:checkbox>
													</div>
													<div class="col-lg-2 col-md-2 col-sm-8 col-xs-8">
														<s:text name="lead.dashboard.state"></s:text>
													</div>
													<div class="col-lg-1 col-md-1 col-sm-4 col-xs-4">
														<s:checkbox name="state"></s:checkbox>
													</div>
													<div class="col-lg-2 col-md-2 col-sm-8 col-xs-8">
														<s:text name="lead.dashboard.emailID"></s:text>
													</div>
													<div class="col-lg-1 col-md-1 col-sm-4 col-xs-4">
														<s:checkbox name="emailID"></s:checkbox>
													</div>
												</div>
												<div id="view_lable_value3"
													class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
													...
													<div class="col-lg-1 col-md-1 col-sm-4 col-xs-4">
														<s:checkbox name="requirement"></s:checkbox>
													</div>
													<div class="col-lg-2 col-md-2 col-sm-8 col-xs-8">
														<s:text name="lead.dashboard.website"></s:text>
													</div>
													<div class="col-lg-1 col-md-1 col-sm-4 col-xs-4">
														<s:checkbox name="website"></s:checkbox>
													</div>
													<div class="col-lg-2 col-md-2 col-sm-8 col-xs-8">
														<s:text name="lead.dashboard.rating"></s:text>
													</div>
													<div class="col-lg-1 col-md-1 col-sm-4 col-xs-4">
														<s:checkbox name="rating"></s:checkbox>
													</div>
												</div>
												...
												<div id="view_lable_value1"
													...
													<div class="col-lg-1 col-md-1 col-sm-4 col-xs-4">
														<s:checkbox name="leadUrl"></s:checkbox>
													</div>
													<div class="col-lg-2 col-md-2 col-sm-8 col-xs-8">
														<s:text name="lead.dashboard.leadOwner"></s:text>
													</div>
													<div class="col-lg-1 col-md-1 col-sm-4 col-xs-4">
														<s:checkbox name="leadOwner"></s:checkbox>
													</div>
													<div class="col-lg-2 col-md-2 col-sm-8 col-xs-8">
														<s:text name="lead.dashboard.LeadFilePath"></s:text>
													</div>
													<div class="col-lg-1 col-md-1 col-sm-4 col-xs-4">
														<s:checkbox name="LeadFilePath"></s:checkbox>
													</div>
												...
												<div id="view_lable_value3"
													...
													<div class="col-lg-1 col-md-1 col-sm-4 col-xs-4">
														<s:checkbox name="createdBy"></s:checkbox>
													</div>
													<div class="col-lg-2 col-md-2 col-sm-8 col-xs-8">
														<s:text name="lead.dashboard.createdDate"></s:text>
													</div>
													<div class="col-lg-1 col-md-1 col-sm-4 col-xs-4">
														<s:checkbox name="createdDate"></s:checkbox>
													</div>
													<div class="col-lg-2 col-md-2 col-sm-8 col-xs-8">
														<s:text name="lead.dashboard.rating"></s:text>
													</div>
