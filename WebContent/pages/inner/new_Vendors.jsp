				...
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<ol class="breadcrumb" style="margin-top: 10px;">
							...
							<li class="active"><s:text name="new.vendors.new.vendors" /></li>
						</ol>
						<s:form name="addCreatedvendorsForm" action="addVendorsInfo"
							...
							<div class="box dark">
								...
								<div class="pull-left">
									...
									<h5>
										<s:text name="new.vendors.new.vendors" />
									</h5>
								</div>
								...
								<div class="row">
									<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"
										...
										<a href="vendorsDashboard.action" data-toggle="tooltip"
											...
											data-original-title="Reset" class="btn btn-success btnheight"
											tabindex="38"><i class="fa fa-refresh "></i> <s:text
