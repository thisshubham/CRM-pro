						...
						<div class="row">
								...
								<div class="form-group">
									...
									<div class="col-sm-10" style="width: 70%;">
										...
										<s:select list="currencyList" name="currencyId"
											...
											headerKey="-1" headerValue="Select Currency" /><!--list="currencyList"  -->
									
									<%-- <select class="form-control" name="currencyId" theme="css_xhtml" cssStyle="width: 100%;height:35px; "
									...
									<div class="col-md-2 col-sm-2">
										<img alt="Add New Client" src="assets/img/plus-icon.png"
							...
							<div class="col-md-6 col-sm-6">
								<div class="form-group">
									...
									<div class="col-md-2 col-sm-2">
										<img alt="AddReminder" src="assets/img/plus-icon.png"
											style="height: 30px; width: 30px; margin-left: -20px;"
