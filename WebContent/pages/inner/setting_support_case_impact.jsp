...
<body>
					...
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<ol class="breadcrumb" style="margin-top: 10px;">
							...
							<li class="active"><s:text
									name="setting.support.navigation.bar"></s:text></li>
							<li class="active"><s:text
									name="setting.support.case.impact.navigation.bar"></s:text></li>
						...
						<div class="box ">
							...
							<div class="pull-right">
								<div class="btn-group">
									...
									<a href="settingSupportCaseImpact.action" data-toggle="tooltip"
								...
								<div class="col-lg-12  col-md-12  col-sm-12 col-xs-12"
									...
									<ul class="nav nav-tabs" role="tablist">
										<li role="presentation"><a
											href="settingSupportFAQCategory.action"><s:text
													name="setting.support.menus.FAQcategory" /> </a></li>
										<li role="presentation"><a
											href="settingSupportChannel.action"><s:text
													name="setting.support.menus.channel" /></a></li>
										<li role="presentation" class="active"><a
											href="settingSupportCaseImpact.action"
											style="color: Gray; background-color: #F9F9F9;"><s:text
													name="setting.support.menus.case.impact" /></a></li>
										<li role="presentation"><a
											href="settingSupportTaskArea.action"><s:text
											...
											<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
												<div class="box inverse"
															...
															<s:else>
																<div class="alert alert-info" role="alert"
																	...
																	<div class="infoIcon">
																		...
																		<s:text
																			name="setting.support.case.impact.information.bar" />
																	</div>
																</div>
															</s:else>
														</p>
													...
													<s:form class="form-horizontal"
														action="insertCaseImpactDetails" name="caseImpactForm">
																...
																<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
																		...
																		<div class="row form-group">
																			<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
																				<label for="text1" class="control-label col-lg-4">
																					<s:text name="setting.support.case.impact.type" />
																				</label>
																			</div>
																			<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
																				<s:textfield name="caseimpacttype"
																	...
																	<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
																		<div class="row form-group">
																			<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
																				<label for="text1" class="control-label col-lg-4">
																					<s:text name="setting.support.case.impact.area" />
																				</label>
																			</div>
																			<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
																				<s:textfield name="caseimpactarea"
																					cssClass="form-control" />
																			</div>
																		</div>
																	</div>
																	...
																	<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
																		<div class="row form-group">
																			<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
																				<label for="text1" class="control-label col-lg-4">
																					<s:text
																						name="setting.support.case.impact.resolution.type" />
																				</label>
																			</div>
																			<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
																				<s:textfield
															...
															<thead>
																<tr id="myrow">
																	...
																	<th style="width: 20%;"><s:text
																			name="setting.support.case.impact.id"></s:text></th>
																	<th><s:text
																			name="setting.support.case.impact.type"></s:text></th>
																	<th><s:text
																			name="setting.support.case.impact.area"></s:text></th>
																	<th><s:text
																			name="setting.support.case.impact.resolution.type"></s:text></th>
																</tr>
															</thead>
															<tbody>
																<s:iterator value="FinanceGLaccountList">
																	<tr>
																		<td align="center">
																			<div class="btn-group">
	...
	<script type="text/javascript">
		var frmvalidator = new Validator("caseImpactForm");
		frmvalidator.EnableOnPageErrorDisplay();
		frmvalidator.EnableMsgsTogether();
		frmvalidator.addValidation("caseimpactarea", "req",
				"Please Enter Case Impact");
		frmvalidator.addValidation("caseimpactarea", "maxlen=100",
				"Please Enter maxlen 100");
		frmvalidator.addValidation("caseimpactarea", "minlen=3",
