					...
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						...
						<div class="box ">
							<s:form class="form-horizontal"
								action="insertProductType" name="productUsesUnitForm">
								<header>
								<div class="icons">
											...
											<div class="row form-group">
												...
												<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
													<div class="row">
														...
														list="categoryList" name="productCategory" headerKey="1"
														tabindex="15">
													</s:select>
											...
											<div class="row form-group">
												...
												<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
													<div class="row">
														...
														<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
															<s:textfield type="text" name="productType"
																...
																<s:iterator value="productTypeList">
																	<tr>
																		<td align="center">
																			<div class="btn-group">
																				<a id="edit"
																					href="settingEditProductType.action?command=<s:property value='productTypeId'/>"
																		...
																		<td><a style="color: blue" href=""><s:property value='productTypeId' /></a></td>
