									...
									<table id="dataTable"
										...
										<thead>
											<tr id="myrow">
												...
												<th><%-- <s:text name="add.new.ticket.ticketId"></s:text> --%>Ledger Id</th>
												<th><%-- <s:text name="add.new.ticket.category"></s:text> --%>Dealer Name</th>
												<th><%-- <s:text name="add.new.ticket.category"></s:text> --%>Dealer Ref.</th>
												<th><%-- <s:text name="add.new.ticket.ticketOwner"></s:text> --%>Tax Type</th>
												<th><%-- <s:text name="add.new.ticket.priority"></s:text> --%>Truck no</th>
												<th><%-- <s:text name="add.new.ticket.channel"></s:text> --%>Destination</th>
												<th><%-- <s:text name="add.new.ticket.dueDate"></s:text> --%>Bill No</th>
												<th><%-- <s:text name="add.new.ticket.productName"></s:text> --%>Paid</th>
												<th><%-- <s:text name="add.new.ticket.contactName"></s:text> --%>Due</th>
												<th><%-- <s:text name="add.new.ticket.contactName"></s:text> --%>Due</th>
												<!-- <th>Amount</th> -->
											</tr>
										</thead>
										<tbody>
											<s:iterator value="ledgerList">
												<tr>
													...
													<td><s:property value="ledgerTaxType" /></td>
													<td><s:property value="truckNo" /></td>
													<td><s:property value="destination" /></td>
													
													<td><s:property value="ledgerBillNo" /></td>
