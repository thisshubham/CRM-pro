		...
		<nav class="navbar navbar-default navbar-static-top" id="mynavbar">
			<div class="container-fluid">
				...
				<div class="topnav" style="margin-right: 20px;">
					<i class="fa fa-calendar-o btniconcolor"></i> </a>
					<!-- <a
						href="dashboardGraphReports.action" data-toggle="tooltip"
						data-original-title="Report" data-placement="bottom"
						class="btn btn-default btn-sm"> <i
						class="fa fa-folder-o fa-1x btniconcolor"></i>
					</a> -->
					 <a
						href="noteDashboard.action" data-toggle="tooltip"
						data-original-title="Notes" data-placement="bottom"
						class="btn btn-default btn-sm"> <i
						class="fa fa-file-o fa-1x btniconcolor"></i>
					</a> <a href="settingDashboardPage" data-toggle="tooltip"
						data-original-title="Setting" data-placement="bottom"
						class="btn btn-default btn-sm "> <i
						class="fa fa-gear btniconcolor"></i>
					</a> <a href="profileTemplet.action" data-toggle="tooltip"
						data-original-title="User Profile" data-placement="bottom"
						class="btn btn-default btn-sm"> <i
						class="fa fa-user btniconcolor"></i>
					</a> <a onclick="logoutUser()" data-toggle="tooltip"
				...
				<div class="collapse navbar-collapse navbar-ex1-collapse">
					...
					<ul class="nav navbar-nav" style="margin-left: 25px;">
						<li><a href="omiInnerDashboard.action"><i
								class="fa fa-home" style="margin-top: 4px; margin-right: 2px"></i>Home<b></b>
						</a></li>
						
						
							<li><a href="stockDashboard.action"><i
										class="fa fa-user"></i> Stock</a></li>
										
										<li class="dropdown"><a aria-expanded="false" href="#"
							class="dropdown-toggle" data-toggle="dropdown"><i
								class="fa fa-paper-plane-o  icon"></i> Purchase <b
								class="caret"></b> </a>
								
							<ul class="dropdown-menu">
								
								<li><a href="purchaseDashbord.action"> <i
										class="fa fa-lightbulb-o icon"></i> cement Purchase
								</a></li>
								<li><a href="steelBarDashbord.action"><i
										class="fa fa-building-o icon"></i> Steel Bars Purchase </a></li>
										
										<li><a href="purchasePaint"><i
										class="fa fa-building-o icon"></i > Wall Paint Purchase</a></li>
										
										<li><a href="purchasePesticidesAction"><i
										class="fa fa-building-o icon"></i > Pesticides Purchase</a></li>
										
								
									<!-- 	<li><a href="ledgerDashboard"><i
										class="fa fa-user"></i> Ledger</a></li> -->
                        
                        <!-- <li><a href="steelbarStock.action"><i
										class="fa fa-user"></i>Steelbar Stock </a></li> -->
										...
										<!-- /// -->
										<!-- <li><a href="salesDashboard.action"><i
										class="fa fa-ticket icon"></i> Sales</a></li> -->
										
										
											<li class="dropdown"><a aria-expanded="false" href="#"
							class="dropdown-toggle" data-toggle="dropdown"><i
								class="fa fa-paper-plane-o  icon"></i> Customer <b
								class="caret"></b> </a>
								
							<ul class="dropdown-menu">
								
								
								<li><a href="consumerDashboardAction"><i
										class="fa fa-building-o icon"></i>Consumer</a></li><!--  -->
										
								<li><a href="customerDashboard"> <i
										class="fa fa-lightbulb-o icon"></i> Retailer
								</a></li>
										...
										<li><a href="invoiceDashbord.action"><i
										class="fa fa-ticket icon"></i> Sales</a></li>
						 <li class="dropdown"><a aria-expanded="false" href="#"
							class="dropdown-toggle" data-toggle="dropdown"><i
								class="fa fa-paper-plane-o  icon"></i> Essentials <b
								class="caret"></b> </a>
							<ul class="dropdown-menu">
								
								<li><a href="contactsDashboard.action"> <i
										class="fa fa-lightbulb-o icon"></i> Contacts
								</a></li>
								<!-- <li><a href="renderAcccountsDashboard.action"><i
										class="fa fa-building-o icon"></i> Accounts</a></li> --> <!--  -->
								
								<!-- <li><a href="documentDashboard.action"><i
										class="fa fa-user"></i> Documents</a></li> -->
...
<!-- //////////////////////////////// -->
						...
						<li class="dropdown"><a aria-expanded="false" href="#"
							class="dropdown-toggle" data-toggle="dropdown"><i
								class="fa fa-shopping-cart icon"></i> Transaction <b class="caret"></b>
						</a>
							<ul class="dropdown-menu">
								
								
										<li><a href="completeRetailerTransaction"><i
										class="fa fa-tasks icon"></i> Retailer Transaction </a></li>
										
										<li><a href="completeConsumerTransaction"><i
										class="fa fa-tasks icon"></i> Consumer Transaction </a></li> 
										
										<!-- <li><a href="payDueAmountOfCustomerAction"><i
										class="fa fa-tasks icon"></i>Pay Due Of Retailer</a></li> --> 
										
										<!-- <li><a href="payDueAmountOfConsumerAction"><i
										class="fa fa-tasks icon"></i>Pay Due Of Consumer</a></li> --> 
										
										
										 <li><a href="viewDealerTransactionDashboard"><i
										class="fa fa-user"></i> Dealer Transaction</a></li>
						...
						<li class="dropdown"><a aria-expanded="false" href="#"
							class="dropdown-toggle" data-toggle="dropdown"><i
								class="fa fa-shopping-cart icon"></i> Inventory <b class="caret"></b>
						</a>
							<ul class="dropdown-menu">
 ...
 -->
 								<li><a href="viewDealerDashboard"><i
										class="fa fa-building-o icon"></i>&nbsp;&nbsp;Company</a></li>
...
<li><a href="transportDashboardAction"><i
										class="fa fa-taxi icon"></i> Transport</a></li>
							</ul></li> -->
						...
						<!-- <li class="dropdown"><a aria-expanded="false" href="#"
							...
							<ul class="dropdown-menu">
								...
								<li><a href="#"><i class="fa fa-building-o icon"></i>
										Utilities</a></li>
