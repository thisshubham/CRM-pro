...
<body>
				...
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<ol class="breadcrumb" style="margin-top: 10px;">
							...
							<li class="active"><s:text
									name="setting.product.category.navigation.bar"></s:text></li>

						</ol>
						<div class="box ">
							<s:form class="form-horizontal"
								action="insertProductCategoryDetails" name="productCategoryForm">
								<header>
								<div class="icons">
																...
																<s:else>
																	<div class="alert alert-info" role="alert"
																		...
																		<div class="infoIcon">
																			...
																			<s:text
																				name="setting.product.category.information.bar" />
																		</div>
																	</div>
																</s:else>
															</p>
														...
														<div class="row">
															...
															<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
																<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
																	<s:text name="setting.product.category.label"></s:text>
																	<div class="star">*</div>
																</div>
																<div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
																	...
																	<div id='productCategoryForm_productCategory_errorloc'
															...
															<thead>
																<tr id="myrow">
																	...
																	<th style="width: 20%;"><s:text
																			name="setting.product.category.id"></s:text></th>
																	<th><s:text name="setting.product.category.label"></s:text></th>
																</tr>
															</thead>
															<tbody>
																<s:iterator value="productCategoryList">
																	<tr>
																		<td align="center">
																			...
																			<div class="btn-group">
																				<a id="edit"
																					href="settingEditProductCategory.action?command=<s:property value='productCategoryId'/>"
	...
	<script type="text/javascript">
		var frmvalidator = new Validator("productCategoryForm");
		frmvalidator.EnableOnPageErrorDisplay();
		frmvalidator.EnableMsgsTogether();
		frmvalidator.addValidation("productCategory", "req",
				"Please Enter Product Category");
		frmvalidator.addValidation("productCategory", "maxlen=100",
				"Please Enter maxlen 100");
		frmvalidator.addValidation("productCategory", "minlen=3",
