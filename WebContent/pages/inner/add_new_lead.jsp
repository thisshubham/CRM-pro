				...
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<ol class="breadcrumb" style="margin-top: 10px;">
							...
							<li class="active"><s:text name="navbar.newlead"></s:text></li>
						</ol>
									...
									<div class="row">
										...
										<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
											<div class="row form-group">
												...
												<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
													<s:select list="companyTypeList" name="companyType" id=""
									...
									<div class="row">
											...
											<div class="row form-group">
												...
												<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
													<s:select cssClass="form-control chzn-select"
														name="companyCategory" list="companyCategoryList"
														tabindex="7" />
										...
										<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
											<div class="row form-group">
												...
												<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
													<s:select cssClass="form-control chzn-select"
														list="companySectorList" name="companySector" tabindex="8" />
											...
											<div class="row form-group">
												...
												<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
													<s:select name="leadSource" id=""
														cssClass="form-control chzn-select" list="leadSourceList"
									...
									<div class="row">
										<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
											<div class="row form-group">
												...
												<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
													<s:select cssClass="form-control chzn-select"
														name="leadOwnerId" id="" list="customerNameList"
