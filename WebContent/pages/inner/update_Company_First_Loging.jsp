				...
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					 <ol class="breadcrumb" style="margin-top: 10px;">
							...
							<li class="active"><s:text name="Update Company Setting"></s:text></li>
										...
										<s:else>
											...
											<div class="alert alert-info" role="alert"
												...
												<div class="infoIcon">
													...
													<s:text name="Update Your Company Information." />
												</div>
											</div>
										</s:else>
									</p>
									...
									<div class="row">
										<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
											<div class="box inverse"
												...
												<s:form action="updateFirstLogingCompanySetting"
													name="FirstLogingCompanySettingForm" class="form-horizontal"
													id="block-validate">
														...
														<div class="row">
															<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
																...
																<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
																	...
																	headerValue="Select Currency" name="currency"
															...
															<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
																...
																<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
																	<div class="row">
																		...
																		<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
																			<s:select list="languageList" headerKey="-1"
																	headerValue="Select Language" name="language"
																	cssClass="form-control chzn-select" />
														...
														<div class="row">
															<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
																...
																<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
																	<div class="row">
																		<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
																			<s:text name="Time Zone" />
																			<div class="star">*</div>

																		</div>
																		<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
																			<s:select list="timeZoneList" headerKey="-1"
																	headerValue="Select Time Zone" name="timeZone"
																	cssClass="form-control chzn-select" />
