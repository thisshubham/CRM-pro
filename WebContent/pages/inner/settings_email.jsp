							...
							<div class="container"
								...
								<ul class="nav nav-tabs" role="tablist">
									<li role="presentation"><a
										href="renderCompanySettings.action" style="color: Gray;"><s:text
									...
									<li role="presentation" ><a
										href="settingsDisclaimar.action"
										style="color: Gray;"><s:text
												name="add.user.menus.disclaimer" /></a></li>
									<li role="presentation" class="active"><a href="settingsEmail.action"
										style="color: Gray; background-color: #F9F9F9;"><s:text name="add.user.menus.email" /></a></li>
