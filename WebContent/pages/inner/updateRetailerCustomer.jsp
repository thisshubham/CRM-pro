...
function getCityList() {
	...
	xmlhttp.onreadystatechange = function() {
		if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
			console.log(xmlhttp.responseText+"conssssssssss");
			var array = JSON.parse(xmlhttp.responseText);
			console.log("array.cityList.City.length"+array.cityList.city[2].cityName);
	...
	xmlhttp.open("GET", "cityListForRetailer.action?stateId=" +stateId, true);
					...
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<ol class="breadcrumb" style="margin-top: 10px;">
							...
							<li><a href="contactsDashboard.action"><s:text
										name="Retailer"></s:text></a></li>
							<li class="active"><s:text name="Retailer Dashboard"></s:text></li>
							<li class="active"><s:text name="New Retailer"></s:text></li>
						</ol>
						<s:form name="addContactForm" cssClass="form-horizontal"
							method="post" action="updateRetailerDone">
							<div class="box dark">
								<header>
								<div class="pull-left">
									<a class="icons" href="contactsDashboard.action"
										data-toggle="tooltip"
										data-original-title="Back To Retailer DashBoard"
										style="color: black;"> <i class="fa fa-th-large"></i>
									</a>
									<h5>
										<s:text name="New Retailer" />
									</h5>
								</div>
								...
								<div class="container-fluid">
										...
										<s:else>
											...
											<div class="alert alert-info" role="alert"
												...
												<div class="infoIcon">
													...
													<s:text name=" You Can Manage Add New Retailer from hare" />
												</div>
											</div>
										</s:else>
									</p>
									<div class="row" style="margin-top: 20px;">
										<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
											<h5 class="innertitle">
												<s:text name="Retailer Information"></s:text>
											</h5>
...
<%-- <select class="form-control" name="accountTypeId" theme="css_xhtml" 
			...
			5									<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                     ...
                                     <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
										...
										<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
											<div class="row form-group">
												...
												<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
													<s:select cssClass="form-control chzn-select"
														list="stateList" name="state" headerKey="1"
									...
									<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
											<div class="row form-group">
												...
												<div id="cityDiv">
														 <s:select cssClass="form-control chzn-select"
														list="cityList" name="city" headerKey="1"
														tabindex="15">
													</s:select>
 ...
 <!--  //////////////////////////////////////////////////////-->
	...
	frmvalidator.addValidation("contactperson", "req",
		...
		frmvalidator.addValidation("fullName", "maxlen=50",
				"Full Name Should Be 50 Characters");

		frmvalidator.addValidation("fullName", "alpha",
				"Full Name Should Be in Characters");
...
<!--***********************************************************************  -->
	...
	<script type="text/javascript">
		...
		frmvalidator.addValidation("contactPerson", "maxlen=10",
				"Maximun Length of contactPerson  is 15");
	
		//validations for product Name
		frmvalidator.addValidation("fullName", "req", " Enter Full Name");
		frmvalidator.addValidation("fullName", "maxlen=10",
				"Maximun Length of fullName  is 15");
		
		//validations for product Name
		frmvalidator.addValidation("accountTypeId", "req", " Enter Account Type");
		frmvalidator.addValidation("accountTypeId", "maxlen=10",
				"Maximun Length of accountTypeId  is 15");
	
		//validations for product Name
		frmvalidator.addValidation("createdBy", "req", " Enter Createdby");
		frmvalidator.addValidation("createdBy", "maxlen=10",
				"Maximun Length of createdBy  is 15");
	
		//validations for product Name
		frmvalidator.addValidation("creationDate", "req", " Enter Creation Date");
		frmvalidator.addValidation("creationDate", "maxlen=10",
				"Maximun Length of creationDate  is 15");
	
		
		//validations for product Name
		frmvalidator.addValidation("dob", "req", " Enter DOB");
		frmvalidator.addValidation("dob", "maxlen=10",
				"Maximun Length of dob  is 15");
	
		
		//validations for product Name
		frmvalidator.addValidation("phoneNumberIsd", "req", " Enter Phon Number Isd");
		frmvalidator.addValidation("phoneNumberIsd", "maxlen=10",
				"Maximun Length of phoneNumberIsd  is 15");
	
		//validations for product Name
		frmvalidator.addValidation("mobileNo", "req", " Enter Mobile Number");
		frmvalidator.addValidation("mobileNo", "maxlen=10",
				"Maximun Length of mobileNo  is 15");
	
		//validations for product Name
		frmvalidator.addValidation("socialMailId", "req", " Enter Email ID");
		frmvalidator.addValidation("socialMailId", "maxlen=10",
				"Maximun Length of socialMailId  is 15");
	
		//validations for product Name
		frmvalidator.addValidation("referredBy", "req", " Enter Referred By");
		frmvalidator.addValidation("referredBy", "maxlen=10",
				"Maximun Length of referredBy  is 15");
		

		
		//validations for product Name
		frmvalidator.addValidation("address1", "req", " Enter Address1");
		frmvalidator.addValidation("address1", "maxlen=10",
				"Maximun Length of address1  is 15");
		
		//validations for product Name
		frmvalidator.addValidation("address2", "req", " Enter Address2");
		frmvalidator.addValidation("address2", "maxlen=10",
				"Maximun Length of address2  is 15");
		
		//validations for product Name
		frmvalidator.addValidation("city", "req", " Enter City");
		frmvalidator.addValidation("city", "maxlen=10",
				"Maximun Length of city  is 15");
		
		//validations for product Name
		frmvalidator.addValidation("state", "req", " Enter State");
		frmvalidator.addValidation("state", "maxlen=10",
				"Maximun Length of state  is 15");
		
		//validations for product Name
		frmvalidator.addValidation("country", "req", " Enter Country");
		frmvalidator.addValidation("country", "maxlen=10",
				"Maximun Length of country  is 15");
		
		//validations for product Name
		frmvalidator.addValidation("pinCode", "req", " Enter Pincode");
		frmvalidator.addValidation("pinCode", "maxlen=10",
				"Maximun Length of pin Code  is 6");
		
		//validations for product Name
		frmvalidator.addValidation("phoneNumberIsd2", "req", " Enter Phone Number");
		frmvalidator.addValidation("phoneNumberIsd2", "maxlen=10",
				"Maximun Length of phoneNumberIsd2  is 15");
		
		//validations for product Name
		frmvalidator.addValidation("Phone", "req", " Enter Phone");
		frmvalidator.addValidation("Phone", "maxlen=10",
				"Maximun Length of Phone  is 15");
		
		//validations for product Name
		frmvalidator.addValidation("phoneNo2", "req", " Enter Phone 2");
		frmvalidator.addValidation("phoneNo2", "maxlen=10",
				"Maximun Length of phoneNo2  is 15");
		
		//validations for product Name
		frmvalidator.addValidation("mobileNum1Isd2", "req", " Enter mobile number");
		frmvalidator.addValidation("mobileNum1Isd2", "maxlen=10",
				"Maximun Length of mobileNum1Isd2  is 15");
		
		//validations for product Name
		frmvalidator.addValidation("mobileNo2", "req", " Enter mobile");
		frmvalidator.addValidation("mobileNo2", "maxlen=10",
				"Maximun Length of mobileNo2  is 15");
		
		//validations for product Name
		frmvalidator.addValidation("peimaryMailId", "req", " Enter Primary MailId");
		frmvalidator.addValidation("peimaryMailId", "maxlen=10",
				"Maximun Length of peimaryMailId  is 15");
		
		//validations for product Name
		frmvalidator.addValidation("alternativeMail", "req", " Enter Alternative Mail");
		frmvalidator.addValidation("alternativeMail", "maxlen=10",
				"Maximun Length of alternative Mail  is 15");
		
		
		//validations for product Name
		frmvalidator.addValidation("homeContFaxNumIsd", "req", " Enter Home Count FaxNum");
		frmvalidator.addValidation("homeContFaxNumIsd", "maxlen=10",
				"Maximun Length of homeContFaxNumIsd  is 15");
		
		//validations for product Name
		frmvalidator.addValidation("homeContactFaxStd", "req", " Enter Home Count FaxStd");
		frmvalidator.addValidation("homeContactFaxStd", "maxlen=10",
				"Maximun Length of homeContactFaxStd  is 15");
		
		
		//validations for product Name                                                          
		frmvalidator.addValidation("homeContFaxNum", "req", " Enter  home Fax Num");
		frmvalidator.addValidation("homeContFaxNum", "maxlen=10",
				"Maximun Length of homeContFaxNum  is 15");
		
		//validations for product Name
		frmvalidator.addValidation("homewebsite", "req", " Enter Web site");
		frmvalidator.addValidation("homewebsite", "maxlen=10",
				"Maximun Length of home website  is 15");
		
		//validations for product Name
		frmvalidator.addValidation("profileDescription", "req", " Enter Profile Desciption");
		frmvalidator.addValidation("profileDescription", "maxlen=10",
				"Maximun Length of profile Description  is 15");
		
		
		//validations for product Name
		frmvalidator.addValidation("phoneStd", "req", " Enter Phone STD");
		frmvalidator.addValidation("phoneStd", "maxlen=10",
				"Maximun Length of phoneStd  is 15");
