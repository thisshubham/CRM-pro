...
function getCityList() {
	...
	xmlhttp.open("GET", "cityListForConsumer.action?stateId=" +stateId, true);
				...
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<ol class="breadcrumb" style="margin-top: 10px;">
							...
							<li class="active"><s:text name="New Consumer"></s:text></li>
						</ol>
						<s:form name="addContactForm" cssClass="form-horizontal"
							method="post" action="insertConsumerInfo">
							<div class="box dark">
								<header>
								<div class="pull-left">
								...
								<div class="pull-right">
									<div class="btn-group">
										...
										<a href="addConsumerCustomerAction" data-toggle="tooltip"
										...
										<s:else>
											...
											<div class="alert alert-info" role="alert"
												...
												<div class="infoIcon">
													...
													<s:text name="You Can Add Consumer from hare" />
												</div>
											</div>
										</s:else>
									</p>
...
<select class="form-control" name="accountTypeId" theme="css_xhtml" cssStyle="width: 10px;height:35px;"
									...
									<div class="row">
										<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"
											...
											<a href="consumerDashboardAction" data-toggle="tooltip"
												...
												href="addConsumerCustomerAction" data-toggle="tooltip"
												data-original-title="Reset"
												class="btn btn-success btnheight"><i
 ...
 <script src="assets/js/script.js"></script>
	...
	<script type="text/javascript">
		...
		frmvalidator.addValidation("emailId", "req", " Enter your email id");
		frmvalidator.addValidation("emailId", "maxlen=50",
				"Maximun Length of emailId  is 15");
		...
		frmvalidator.addValidation("mobileNum1Isd", "req", " Enter your mobile numIsd");
		...
		//validations for product Name                                                          
		frmvalidator.addValidation("homeContFaxNum", "req", " Enter your Faxstd");
		frmvalidator.addValidation("homeContFaxNum", "maxlen=10",
				"Maximun Length of homeContFaxNum  is 1");
