...
<body>
					...
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<ol class="breadcrumb" style="margin-top: 10px;">
							...
							<li class="active"><s:text
									name="setting.company.sector.navigation"></s:text></li>

						</ol>
						<div class="box ">
							<s:form class="form-horizontal" action="insertCompanySector"
								name="settingCompanySectorForm">
								<header>
								<div class="icons">
									...
									<div class="col-lg-12  col-md-12  col-sm-12 col-xs-12"
										...
										<ul class="nav nav-tabs" role="tablist">
											...
											<li role="presentation" class="active"><a
												href="settingCompanySector.action"
											...
											<li role="presentation"><a
												href="settingCompanyTimezone.action" style="color:Grey;"><s:text
																...
																<s:else>
																	<div class="alert alert-info" role="alert"
																		...
																		<div class="infoIcon">
																			...
																			<s:text name="add.setting.company.sector.infobar" />
																		</div>
																	</div>
																</s:else>
															</p>
														...
														<div class="row">
															...
															<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
																<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
																	<s:text name="add.setting.company.sector.label"></s:text>
																	<div class="star">*</div>
																</div>
																<div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">

																	<s:textfield type="text" name="sector"
																		class="form-control" cssClass="form-control"
																		placeholder="Enter Company Sector" />
																	<div id='settingCompanySectorForm_sector_errorloc'
															...
															<thead>
																<tr id="myrow">
																	<th style="width: 10%;"><s:text
																			name="setting.company.sector.action"></s:text></th>
																	<th style="width: 20%;"><s:text
																			name="setting.company.sector.id"></s:text></th>
																	<th><s:text name="setting.company.sector.name"></s:text></th>

																</tr>
															</thead>
															<tbody>
																<s:iterator value="showCompanySectorList">
																	<tr>
																		<td align="center">

																			<div class="btn-group">
																				<a id="edit"
																					href="settingEditSector.action?command=<s:property value='companysectorid'/>"
	...
	<script type="text/javascript">
		var frmvalidator = new Validator("settingCompanySectorForm");
		frmvalidator.EnableOnPageErrorDisplay();
		frmvalidator.EnableMsgsTogether();
		frmvalidator.addValidation("sector", "req",
				"Please Enter company Sector");
		frmvalidator.addValidation("sector", "maxlen=100",
				"Please Enter maxlen 100");
		frmvalidator.addValidation("sector", "minlen=3",
