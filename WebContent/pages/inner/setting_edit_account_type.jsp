...
<body>
				...
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<ol class="breadcrumb" style="margin-top: 10px;">
							...
							<li class="active"><s:text
									name="setting.marketing.menus.edit.account.type"></s:text></li>
						</ol>
						<div class="box ">
							<s:form class="form-horizontal" action="settingUpdateAccountType"
																...
																<s:else>
																	<div class="alert alert-info" role="alert"
																		...
																		<div class="infoIcon">
																			...
																			<s:text
																				name="setting.marketing.edit.account.type.infobar" />
																		</div>
																	</div>
																</s:else>
															</p>
													...
													<div class="row">
														...
														<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
															...
															<div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
																...
																<s:textfield type="text" name="accountType"
																	class="form-control" cssClass="form-control" />
																<div id='editaccountTypeForm_accountType_errorloc'
	...
	<script type="text/javascript">
		var frmvalidator = new Validator("editaccountTypeForm");
