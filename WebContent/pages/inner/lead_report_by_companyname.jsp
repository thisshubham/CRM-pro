...
<body>
					...
					<div class="col-lg-12">
						<div class="box">
							<header>
								...
								<h5>
									<s:text name="Search By Company Name" />
								</h5>
											...
											<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"
												...
												<div class="row" style="margin-right: 27px;">
													<div class="col-lg-1 col-md-1 col-sm-12 col-xs-12">
														<h5>
															<label> <s:text name="Company Name :" />
															</label>
															<div class="star">*</div>
														</h5>
													</div>
													<s:form name="LeadReportByCompanyNameForm">
														<div class="col-lg-9  col-md-9 col-sm-12 col-xs-12">
															<div class="row">
																<div class="col-lg-3 col-md-3 col-sm-9 col-xs-7">
																	<s:select list="companyNameList" headerKey="-1"
																		headerValue="Select Company Name" name="companyName"
																		cssClass="form-control"></s:select>
																	<div
																		id='LeadReportByCompanyNameForm_companyName_errorloc'
																...
																<div class="col-lg-2 col-md-3 col-sm-9 col-xs-7">
																	<s:textfield name="leadStartDate"
																		placeholder="Select Start Date" id="dp2"
																		cssClass="form-control"></s:textfield>
																	<div
																		id='LeadReportByCompanyNameForm_leadStartDate_errorloc'
																		class="error_strings"></div>
																</div>
																...
																<div class="col-lg-2 col-md-3 col-sm-9 col-xs-7">
																	<!-- <input type="text" name="leadEndDate" value=""
																		tabindex="14" id="dp2" class="form-control"> -->
																	<s:textfield name="leadEndDate"
																		placeholder="Select End Date" id="dp2"
																		cssClass="form-control"></s:textfield>
																	<div
																		id='LeadReportByCompanyNameForm_leadEndDate_errorloc'
																		class="error_strings"></div>
																</div>
									...
									<table id="dataTable"
										...
										<thead>
											<tr id="myrow">
												...
												<th><s:text name="lead.dashboard.createddate"></s:text></th>
	...
	<script type="text/javascript">
		var frmvalidator = new Validator("LeadReportByCompanyNameForm");
		...
		function DoCustomValidation() {
			var frm1 = document.forms["LeadReportByCompanyNameForm"];
