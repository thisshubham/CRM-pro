...
<body>
					...
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<ol class="breadcrumb" style="margin-top: 10px;">
							...
							<li class="active"><s:text
									name="setting.product.navigation.bar"></s:text></li>
							<li class="active"><s:text
									name="setting.product.uses.unit.navigation.bar"></s:text></li>

						</ol>
						<div class="box ">
							<s:form class="form-horizontal"
								action="insertProductUsesUnitDetails" name="productUsesUnitForm">
								<header>
								<div class="icons">
									...
									<div class="col-lg-12  col-md-12  col-sm-12 col-xs-12"
										...
										<ul class="nav nav-tabs" role="tablist">
											<li role="presentation"><a
												href="settingProductCategory.action"><s:text
														name="setting.product.category" /> </a></li>
											<li role="presentation" ><a
												href="settingProductUsesUnit.action"
												style="color: Gray; background-color: #F9F9F9;"><s:text
														name="setting.product.uses.unit" /></a></li>
                                                   <li role="presentation" ><a
												href="settingProductTypeAction"
												><s:text
														name="Product Type" /></a></li>
										</ul>
													...
													<div class=""
																...
																<s:else>
																	<div class="alert alert-info" role="alert"
																		...
																		<div class="infoIcon">
																			...
																			<s:text
																				name="setting.product.uses.unit.information.bar" />
																		</div>
																	</div>
																</s:else>
															</p>
														...
														<div class="row">
															...
															<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
																<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
																	<s:text name="setting.product.uses.unit.label"></s:text>
																	<div class="star">*</div>
																</div>
																<div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">

																	<s:textfield type="text" name="productUsesUnit"
																		class="form-control" cssClass="form-control" />
																	<div id='productUsesUnitForm_productUsesUnit_errorloc'
														...
														<div class="form-group" style="margin-top: 15px;">
															<div class="row" style="margin: 1% 2%;" id="data_grid">
																<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
																	<s:textarea id="wysihtml5"
																		name="measurementdescription" class="form-control"
																		rows="10" tabindex="2">
																	</s:textarea>
															...
															<thead>
																<tr id="myrow">
																	...
																	<th style="width: 20%;"><s:text
																			name="setting.product.uses.unit.id"></s:text></th>
																	<th><s:text name="setting.product.uses.unit.label"></s:text></th>
																</tr>
															</thead>
															<tbody>
																<s:iterator value="showProductUsesUnitList">
																	<tr>
																		<td align="center">
																			<div class="btn-group">
																				<a id="edit"
																					href="settingEditProductUsesUnit.action?command=<s:property value='productUsesUnitId'/>"
																		...
																		<td><a style="color: blue" href=""><s:property
																					value='productUsesUnitId' /></a></td>
																		<td><s:property value="productUsesUnit" /></td>
																	</tr>
																</s:iterator>
															</tbody>
														</table>
	...
	<script type="text/javascript">
		var frmvalidator = new Validator("productUsesUnitForm");
		frmvalidator.EnableOnPageErrorDisplay();
		frmvalidator.EnableMsgsTogether();
		frmvalidator.addValidation("productUsesUnit", "req",
				"Please Enter Product Measurement Unit");
		frmvalidator.addValidation("productUsesUnit", "maxlen=100",
				"Please Enter maxlen 100");
		frmvalidator.addValidation("productUsesUnit", "minlen=3",
				"Please Enter Minlen 3");
		frmvalidator.addValidation("measurementdescription", "maxlen=400",
				"Description should be 400");
	</script>
</body>
</html>