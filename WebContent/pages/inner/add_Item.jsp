	...
	function getTypeList() {
		...
		xmlhttp.onreadystatechange = function() {
			if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
				...
				console.log("array.typeList.type.length"+array.typeList.type[0].typeName);
			...
			var	array_element1="	<select style='width:400px; height:25px' name='productName'";
				
					array_element1 += "<option  >Select city</option>";
					/* alert("array.cityList.City.length"+array.cityList.city[0]); */
					for ( var i = 0; i < array.typeList.type.length; i++) {
						
						array_element1 += "<option value='"+array.typeList.type[i].typeId+"' >"
								+ array.typeList.type[i].typeName + "</option>";
					}

					array_element1 += "</select>";          
		document.getElementById("typeDiv").innerHTML = array_element1;
		/* document.getElementById("contact").innerHTML = array_element2; */
		
	       }
		};
		xmlhttp.open("GET", "productTypeListByCategory.action?categoryId=" +categoryId, true);
...
<body>
								...
								<div class="pull-right">
									<div class="btn-group">
										...
										<a href="addCreatedProduct.action" data-toggle="tooltip"
											...
											class="fa fa-refresh "></i></a> <a href="productDashboard.action"
											...
											<div class="row form-group">
												...
												<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
													<%-- <s:textfield type="text" name="productName"
														...
														list="itemNameList" name="productCategory" headerKey="-1" headerValue= "Select Category"
														tabindex="15" id="categoryId" onchange="getTypeList()" >
													</s:select>
									...
									<div class="row">
										<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
											<div class="row form-group">
												...
												<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12" id="typeDiv">
													<%-- <s:textfield type="text" name="productCategory"
														cssClass="form-control" tabindex="1" /> --%>
														
														<s:select cssClass="form-control chzn-select"
														list="categoyList" name="productName" headerKey="-1" headerValue= "Select Type"
														tabindex="15">
													</s:select>
									...
									<%-- <div class="row">
										<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
											<div class="row form-group">
												...
												<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
													<s:select cssClass="form-control chzn-select"
														name="productCategory" list="productCategoryList"
														headerKey="-1" headerValue=" Product Category"
														tabindex="3" />
													<div id='addCreatedProductForm_productCategory_errorloc'
														class="error_strings"></div>
												</div>
										...
										<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
											<div class="row form-group">
												...
												<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
													<s:checkbox name="productActive" tabindex="4"></s:checkbox>
												</div>
											...
											<div class="row form-group">
												...
												<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
													<s:select cssClass="form-control chzn-select"
														...
														headerValue=" Vender Name" tabindex="5" />
											...
											<div class="row form-group">
												...
												<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
													<div class="input-group">
														<s:select cssClass="form-control chzn-select" tabindex="5"
															headerKey="-1" name="manufacturer" id="leadTitle"
															list="productManufacturerList"
															headerValue=" Manufacturer" />
											...
											<div class="row form-group">
												...
												<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
													<s:textfield type="text" name="salesEndDate"
														class="form-control" id="dp5" cssClass="form-control"
											...
											<div class="row form-group">
												...
												<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
													<s:textfield type="text" name="supportStartDate"
														cssClass="form-control" id="dp2" tabindex="9"
														readonly="true" />
													<div id='addCreatedProductForm_supportStartDate_errorloc'
														class="error_strings"></div>
												</div>
											</div>
										</div>
											...
											<div class="row form-group">
												...
												<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
													<s:textfield type="text" name="supportExpiryDate"
														cssClass="form-control" id="dp3" tabindex="10"
														readonly="true" />
										...
										<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
											<div class="row form-group">
												...
												<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
													...
													<div id='addCreatedProductForm_mrfPartNo_errorloc'
														class="error_strings"></div>
												</div>
											</div>
										</div>
										...
										<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
											<div class="row form-group">
												...
												<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
													...
													<div id='addCreatedProductForm_vendorPartNo_errorloc'
														class="error_strings"></div>
												</div>
											</div>
										</div>
										...
										<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
											<div class="row form-group">
												...
												<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
													...
													<div id='addCreatedProductForm_website_errorloc'
														class="error_strings"></div>
												</div>
											...
											<div class="row form-group">
												...
												<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
													<s:select cssClass="form-control chzn-select"
														...
														headerKey="-1" headerValue=" GL Account" tabindex="16" />
 ...
 --%>
										...
										<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
											<div class="row form-group">
												...
												<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
													...
													<div id='addCreatedProductForm_commisionRate_errorloc'
														class="error_strings"></div>
												</div>
											</div>
										</div>
									...
									<div class="row">
										...
										<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
											<div class="row form-group">
												...
												<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
													<div class="input-group">
														<s:select cssClass="form-control chzn-select" tabindex="20"
															headerKey="1" name="tax" id="leadTitle"
															list="productTaxList" headerValue="Tax" />
														<span class="input-group-btn">
															<button type="button" tabindex="21"
											...
											<div class="row form-group">
												...
												<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
													<div class="input-group">
														...
														<div id='addCreatedProductForm_purchaseCost_errorloc'
															class="error_strings"></div>
														<span class="input-group-btn"> <a type="button"
															class="btn btn-metis-5 btn-line" type="button"
															tabindex="23" data-toggle="modal" style="height: 34px"
															data-target="#calculater"> <i
																class="fa fa-calculator" data-toggle="tooltip"
																data-original-title="Calculator"></i>
														</a>
									...
									<div class="row">
										<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
											<div class="row form-group">
												...
												<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
													<div class="input-group">
														<s:select cssClass="form-control chzn-select" tabindex="24"
											...
											<div class="row form-group">
												...
												<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
													<s:textfield name="qtyPerUnit" cssClass="form-control"
														tabindex="27" />
													<div id='addCreatedProductForm_qtyPerUnit_errorloc'
														class="error_strings"></div>
												</div>
											</div>
										</div>
									...
									<div class="row">
										<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
											<div class="row form-group">
												...
												<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
													<s:select list="productHandlerList" name="handler"
														id="country" headerKey="-1" headerValue="Handler"
														theme="css_xhtml" cssClass="form-control" tabindex="30" />
	...
	<script type="text/javascript">
		...
		frmvalidator
		.addValidation("productName", "dontselect=-1", "Please Select Category"); 
		frmvalidator
		.addValidation("productCategory", "dontselect=-1", "Please Select Type"); 
		//Validation for Product Code.productCategory
 	...
 	//Validation for Vendor Part Number. 
		...
		frmvalidator.addValidation("reorderLevel", "req", "Enter Reorder Level");
		...
		frmvalidator.addValidation("qtyInDemand", "req", "Enter Quantity In Demand");
		frmvalidator.addValidation("reorderLevel", "maxlen=100",
