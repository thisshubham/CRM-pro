...
<body>
				...
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<ol class="breadcrumb" style="margin-top: 10px;">
							...
							<li class="active"><s:text
									name="setting.support.FAQcategory.navigation.bar"></s:text></li>

						</ol>
						<div class="box ">
							<s:form class="form-horizontal" action="insertFAQCategoryDetails" name="faqCategoryform">
								<header>
								<div class="icons">
								...
								<div class="pull-right">
									<div class="btn-group">
										...
										<a href="settingSupportFAQCategory.action"
									...
									<div class="col-lg-12  col-md-12  col-sm-12 col-xs-12"
										...
										<ul class="nav nav-tabs" role="tablist">
											<li role="presentation" class="active"><a
												href="settingSupportFAQCategory.action"
																...
																<s:else>
																	<div class="alert alert-info" role="alert"
																		...
																		<div class="infoIcon">
																			...
																			<s:text
																				name="setting.support.FAQcategory.information.bar" />
																		</div>
																	</div>
																</s:else>
															</p>
														...
														<div class="row">
															...
															<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
																<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
																	<s:text name="setting.support.FAQcategory.label"></s:text>
																	<div class="star">*</div>
																</div>
																<div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
																	...
																	<s:textfield type="text"
																		...
																		<div
																	id='faqCategoryform_faqcategory_errorloc'
														...
														<table id="dataTable"
															...
															<thead>
																<tr id="myrow">
																	...
																	<th><s:text
																			name="setting.support.FAQcategory.label"></s:text></th>
																</tr>
															</thead>
															<tbody>
																<s:iterator value="showSupportfaqCategoryList">
																	<tr>
																		<td align="center">
																			<div class="btn-group">
																		...
																		<td><a style="color: blue" href=""><s:property
																					value='faqcategoryId' /></a></td>
																		<td><s:property value="faqcategory" /></td>
	...
	<script type="text/javascript">
		var frmvalidator = new Validator("faqCategoryform");
		frmvalidator.EnableOnPageErrorDisplay();
		frmvalidator.EnableMsgsTogether();
		frmvalidator.addValidation("faqcategory", "req",
				"Please Enter FAQ category");
		frmvalidator.addValidation("faqcategory", "maxlen=100",
				"Please Enter maxlen 100");
		frmvalidator.addValidation("faqcategory", "minlen=3",
