				...
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<ol class="breadcrumb" style="margin-top: 10px;">
							...
							<li><a href="settingCompanyCategory.action"><s:text
										name="add.user.menus.company"></s:text></a></li>
							<li class="active"><s:text
									name="add.user.menus.company.category"></s:text></li>
							<li class="active"><s:text
									name="setting.company.menu.edit.company.category"></s:text></li>


						</ol>
						<div class="box ">
							<s:form class="form-horizontal" action="settingUpdateCategory"
																...
																<s:else>
																	<div class="alert alert-info" role="alert"
																		...
																		<div class="infoIcon">
																			...
																			<s:text name="setting.company.edit.category" />
																		</div>
																	</div>
																</s:else>
															</p>
