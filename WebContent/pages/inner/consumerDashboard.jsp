							...
							<header>
								...
								<div class="pull-right">
									...
									<div class="btn-group">
										...
										<a href="consumerDetailExcelReport.action" type="button" class="btn btn-default btnheight"><i
										...
										<s:else>
											...
											<div class="alert alert-info" role="alert"
												...
												<div class="infoIcon">
													...
													<s:text name="You can manage consumer Dashboard here" />
												</div>
											</div>
										</s:else>
									</p>
									<div id="collapse1" class="panel-collapse collapse">
										<div class="row searchBar">
											 <s:form name="consumerAdvanceSearchForm" method="POST"
												action="populateConsumerDetailsAsPerSearch">
												<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"
													...
													<div class="col-lg-4  col-md-4  col-sm-12 col-xs-12">
														<s:select list="consumerCustomerSearchList" headerKey="-1"
									...
									<table id="dataTable"
										...
										<thead>
											...
											<th style="width: 7%;"><s:text
												...
												<th><s:text name="Customer Id"></s:text>
												</th>
										...
										<tbody>
											<s:iterator value="consumerDetailList">
												<tr>
													
													<td align="center">
														<div class="btn-group">
															<a id="view"
																href="viewConsumerDetailsAction.action?command=<s:property value='customerId'/>"
														...
														<div class="btn-group">
															<a id="edit"
																href="updateConsumerDetailsAction?command=<s:property value='customerId' />"
																data-toggle="tooltip" data-.Actionoriginal-title="Edit"
																data-placement="bottom"> <i class="fa fa-edit"></i>
															</a>
														</div>
														<div class="btn-group">
															<a id="delete" onclick="confirmDelete('deleteConsumerRecord.action?command=<s:property value='customerId' />')" data-toggle="tooltip"
