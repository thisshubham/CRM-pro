...
<body>
				...
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<ol class="breadcrumb" style="margin-top: 10px;">
							...
							<li class="active"><s:text
									name="setting.finance.taxes.navigation.bar"></s:text></li>

						</ol>
						<div class="box ">
							<s:form class="form-horizontal" name="settingFinanceTaxForm"
								action="insertFinanceTaxes">
								<header>
								<div class="icons">
								...
								<div class="container-fluid">
									<div class="col-lg-12  col-md-12  col-sm-12 col-xs-12"
										...
										<ul class="nav nav-tabs" role="">
											<li class="active"><a href="settingFinanceTaxes.action"
												style="color: Gray; background-color: #F9F9F9;"><s:text
														name="setting.finance.taxes" /></a></li>
											<li role="presentation"><a
												href="settingFinanceGLaccount.action"><s:text
																...
																<s:else>
																	<div class="alert alert-info" role="alert"
																		...
																		<div class="infoIcon">
																			...
																			<s:text name="setting.finance.taxes.information.bar" />
																		</div>
																	</div>
																</s:else>
															</p>
													...
													<div class="row"
														...
														<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
															<div class="row form-group">
																<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
																	<s:text name="Tax Display Name" />
																	<div class="star">*</div>
																</div>
																<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
																	<s:textfield type="text" name="taxDisplayName"
																		cssClass="form-control" />
																	<div id='settingFinanceTaxForm_taxDisplayName_errorloc'
															...
															<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
																<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
																	<div class="form-group">
																		<h5 class="innertitle">
																			<s:label class="innerclass">Tax Components</s:label>
																		</h5>
																		<hr>
																	</div>
														...
														<div class="row"
															...
															<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
																<div class="row form-group">
																	<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
																		<s:text name="Tax Name One" />
																	</div>
																	<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
																		<s:textfield type="text" name="taxNameOne"
																			cssClass="form-control" />
															...
															<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
																<div class="row form-group">
																	<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
																		<s:text name="Tax Rate One" />
																	</div>
																	<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
																		<s:textfield type="text" name="taxRateOne"
																			cssClass="form-control" />
															...
															<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
																<div class="row form-group">
																	<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
																		<s:text name="Tax Name Two" />
																	</div>
																	<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
																		<s:textfield type="text" name="taxNameTwo"
																			cssClass="form-control" />
															...
															<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
																<div class="row form-group">
																	<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
																		<s:text name="Tax Rate Two" />
																	</div>
																	<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
																		<s:textfield type="text" name="taxRateTwo"
																			cssClass="form-control" />
															...
															<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
																<div class="row form-group">
																	<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
																		<s:text name="Tax Name Three" />
																	</div>
																	<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
																		<s:textfield type="text" name="taxNameThree"
																			cssClass="form-control" />
															...
															<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
																<div class="row form-group">
																	<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
																		<s:text name="Tax Rate Three" />
																	</div>
																	<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
																		<s:textfield type="text" name="taxRateThree"
																			cssClass="form-control" />
															...
															<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
																<div class="row form-group">
																	<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
																		<s:text name="Tax Name Four" />
																	</div>
																	<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
																		<s:textfield type="text" name="taxNameFour"
																			cssClass="form-control" />
															...
															<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
																<div class="row form-group">
																	<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
																		<s:text name="Tax Rate Four" />
																	</div>
																	<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
																		<s:textfield type="text" name="taxRateFour"
																			cssClass="form-control" />
															...
															<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
																<div class="row form-group">
																	<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
																		<s:text name="Tax Name Five" />
																	</div>
																	<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
																		<s:textfield type="text" name="taxNameFive"
																			cssClass="form-control" />
															...
															<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
																<div class="row form-group">
																	<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
																		<s:text name="Tax Rate Five" />
																	</div>
																	<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
																		<s:textfield type="text" name="taxRateFive"
																			cssClass="form-control" />
													...
													<div class="row"
														...
														<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
															<div class="row form-group">
																<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
																	<h5>
																		<b><s:text name="Total Tax Rate:" /></b>
																	</h5>
																</div>
																<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
																	<s:textfield type="text" name="taxTotal"
																		cssClass="form-control" />
																</div>
															</div>
														</div>
														...
														<thead>
															<tr id="myrow">
																...
																<th style="width: 20%;"><s:text
																		name="setting.finance.taxes.id"></s:text></th>
																<th><s:text name="Tax Display Name"></s:text></th>
																<th><s:text name="Total Tax Rate"></s:text></th>
															</tr>
														</thead>
														<tbody>
															<s:iterator value="financeTaxList">
																<tr>
																	<td align="center">
	...
	<script type="text/javascript">
		var frmvalidator = new Validator("settingFinanceTaxForm");
