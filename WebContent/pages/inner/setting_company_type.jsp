			...
			<div class="inner bg-light lter">
				...
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						...
						<div class="box ">
							<s:form class="form-horizontal" action="insertCompanyTypeDetails"
																...
																<s:else>
																	<div class="alert alert-info" role="alert"
																		...
																		<div class="infoIcon">
																			...
																			<s:text name="add.setting.company.type.infobar" />
																		</div>
																	</div>
																</s:else>
															</p>
														...
														<thead>
															<tr id="myrow">
																<th style="width: 10%;"><s:text
																		name="setting.company.type.action"></s:text></th>
																<th style="width: 20%"><s:text name="Id"></s:text></th>
																<th><s:text name="Type"></s:text></th>
															</tr>
														</thead>
														<tbody>
															<s:iterator value="showcompanyTypeList">
																<tr>
																	<td align="center">
																		<div class="btn-group">
																			<a id="edit"
																				href="settingEditCompanyType.action?command=<s:property value='companyId'/>"
