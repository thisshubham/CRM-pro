				...
				<div class="container-fluid">
					...
					<div class="pull-right">
						<div class="btn-group">
								...
								href="purchasePrintPDF.action?command=<s:property value='purchaseId' />"
								...
								href="viewPreviousPurchaseCementInfo.action?command=<s:property value='purchaseId' />"
								...
								href="viewNextPurchaseCementInfo.action?command=<s:property value='purchaseId' />"
