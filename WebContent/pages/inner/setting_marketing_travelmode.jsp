...
<body>
				...
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<ol class="breadcrumb" style="margin-top: 10px;">
							...
							<li class="active"><s:text
									name="setting.marketing.travelmode.navigation.bar"></s:text></li>

						</ol>
						<div class="box ">
							<s:form class="form-horizontal" action="insertTravelModeDetails"
								name="travelModeForm">
								<header>
								<div class="icons">
									...
									<div class="col-lg-12  col-md-12  col-sm-12 col-xs-12"
										...
										<ul class="nav nav-tabs" role="tablist">
											...
											<li role="presentation" class="active"><a
												href="settingMarketingTravelMode.action"
																...
																<s:else>
																	<div class="alert alert-info" role="alert"
																		...
																		<div class="infoIcon">
																			...
																			<s:text
																				name="setting.marketing.travelmode.information.bar" />
																		</div>
																	</div>
																</s:else>
															</p>
														...
														<div class="row">
															...
															<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
																<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
																	<s:text name="setting.marketing.travelmode.label"></s:text>
																	<div class="star">*</div>
																</div>
																<div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">

																	<s:textfield type="text" name="travelmode"
																		class="form-control" cssClass="form-control" />
																	<div id='travelModeForm_travelmode_errorloc'
															...
															<thead>
																<tr id="myrow">
																	...
																	<th style="width: 20%;"><s:text
																			name="setting.marketing.travelmode.id"></s:text></th>
																	<th><s:text
																			name="setting.marketing.travelmode.label"></s:text></th>
																</tr>
															</thead>
															<tbody>
																<s:iterator value="showMarketingtravelModeList">
																	<tr>
																		<td align="center">
																			<div class="btn-group">
																				<a id="edit"
																					href="settingEditTravelMode.action?command=<s:property value='travelmodeID'/>"
	...
	<script type="text/javascript">
		var frmvalidator = new Validator("travelModeForm");
		frmvalidator.EnableOnPageErrorDisplay();
		frmvalidator.EnableMsgsTogether();
		frmvalidator.addValidation("travelmode", "req",
				"Please Enter Travel Mode");
		frmvalidator.addValidation("travelmode", "maxlen=100",
				"Please Enter maxlen 100");
		frmvalidator.addValidation("travelmode", "minlen=3",
