...
<body>
					...
					<div class="col-lg-12">
						<div class="box">
							<header>
								...
								<h5>
									<s:text name="Search By Custom Lead Date" />
								</h5>
									...
									<div id="dashboard_search_tools"
										...
										<div class="row">
											<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"
												...
												<div class="row"
													style="margin-right: 30px; margin-left: 20px; white-space: normal;">
													...
													<s:form name="CustomDateLeadReportForm">
														<div class="col-lg-8  col-md-8 col-sm-12 col-xs-12">
															<div class="row">
																<div class="col-lg-2 col-md-3 col-sm-9 col-xs-7">
																	<s:textfield name="leadStartDate"
																		placeholder="Select Lead Start Date" id="dp3"
																		cssClass="form-control">
																	</s:textfield>
																	<div id='CustomDateLeadReportForm_leadStartDate_errorloc'
																...
																<div class="col-lg-2 col-md-3 col-sm-9 col-xs-7">
																	<s:textfield name="leadEndDate"
																		placeholder="Select Lead End Date" id="dp2"
																		cssClass="form-control">
																	</s:textfield>
																	<div id='CustomDateLeadReportForm_leadEndDate_errorloc'
																		class="error_strings"></div>
																</div>
	...
	<script type="text/javascript">
		var frmvalidator = new Validator("CustomDateLeadReportForm");
		...
		frmvalidator.addValidation("leadEndDate", "req",
				"Select Lead End Date");
		
		//lead date and expected closing date difference validation 
		function DoCustomValidation() {
			var frm1 = document.forms["CustomDateLeadReportForm"];
			var ndate = frm1.leadStartDat.value;
