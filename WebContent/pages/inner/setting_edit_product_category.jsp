...
<body>
				...
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<ol class="breadcrumb" style="margin-top: 10px;">
							...
							<li class="active"><s:text
									name="setting.product,edit.menus.product.category"></s:text></li>

						</ol>
						<div class="box ">
							<s:form class="form-horizontal"
								action="settingUpdateProductCategory"
																...
																<s:else>
																	<div class="alert alert-info" role="alert"
																		...
																		<div class="infoIcon">
																			...
																			<s:text name="setting.product.edit.product.category" />
																		</div>
																	</div>
																</s:else>
															</p>
														...
														<div class="row" style="margin-bottom: 5px;">
															...
															<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
																...
																<div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
																	...
																	<div
																		id='editproductCategoryForm_productCategory_errorloc'
 ...
 --%>
	...
	<script type="text/javascript">
		var frmvalidator = new Validator("editproductCategoryForm");
