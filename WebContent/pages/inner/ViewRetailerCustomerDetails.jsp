				...
				<div class="container-fluid">
					<ol class="breadcrumb" style="margin-top: 10px;">
						...
						<li><a href="salesDashboard"><%-- <s:text
									name="ticket.Dashboard.navbar"></s:text> --%>Retailer</a></li>
						<li><a href="salesDashboard"><%-- <s:text
									name="ticket.Dashboard.panel.heading"></s:text> --%>Retailer Dashboard</a></li>
						<li><a
							href="viewEstimateAction?command=<s:property value='id'/>"
							data-placement="bottom"> <%-- <s:text
									name="view.Ticket.panel.heading"></s:text> --%>View Retailer
						</a></li>
					</ol>
					...
					<h5>
						<%-- <s:text name="view.Ticket.panel.heading" /> --%>View Retailer Details
					</h5>
					<div class="pull-right">
						<div class="btn-group">
							<a class="btn btn-default btnheight" data-toggle="tooltip"
								...
								href="retailerDetailPrintPDF.action?command=<s:property value='customerId' />"
									...
									<div class="alert alert-info" role="alert">
										<div class="infoIcon">
											<i class="fa fa-info-circle "><%--  <s:text
													name="view.Ticket.infobar" /> --%>You can see Retailer Details here</i>
										</div>
									</div>
								</s:else>
							</p>
								...
								<s:iterator value="retailerCustomerVO">
									<div class="row">
										<div
											...
											<h5>
												<%-- <s:text name="add.new.ticket.title" /> --%>Retailer Information
											</h5>
										</div>
									</div>
									<hr>
										...
										<div class="col-md-12 col-sm-12 col-xs-12"
											...
											<div class="col-md-2 col-sm-12 col-xs-12">
												<label for="text1" class="control-label" id="viewlable">
													<%-- <s:text name="add.new.ticket.ticketId"></s:text> --%>Retailer Id
												</label>
											</div>
