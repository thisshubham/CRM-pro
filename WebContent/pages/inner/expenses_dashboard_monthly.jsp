					...
					<div class="col-lg-12">
						<ol class="breadcrumb" style="margin-top: 10px;">
							<li><a href="omiInnerDashboard.action"><i
								...
								<li><a href="expensesDasbord.action"><s:text name="Expenses Dashboard"></s:text>
								</a></li>
							<li class="active"><s:text name="Monthly Expenses Dashboard"></s:text></li>
						</ol>
						<div class="box">
							<header>
								<div class="pull-left">
									...
									<h5 class="header_color">
										<s:text name="Expenses Dashboard"></s:text>
									</h5>
								</div>
								<div class="pull-right">
									<div class="btn-group">
										<a href="expensesMonthly.action" data-toggle="tooltip"
											data-original-title="New  Monthly Expenses"
											class="btn btn-primary btnheight"><i
											class="fa fa-plus fontawesomeht ">&nbsp;<s:text
													name="New Monthly Expenses"></s:text></i></a>
										<button type="button" class="btn btn-info "
											data-toggle="collapse" data-target="#collapse1">
											<i class="fa fa-filter"></i> Filter
										</button>
										<a class="btn btn-success btnheight" data-toggle="tooltip"
											data-original-title="Refresh" href="expensesDasbord.action"><i
											class="fa fa-refresh "></i></a> <a href="expensesMonthlyExcelReport.action"
										...
										<s:else>
											...
											<div class="alert alert-info" role="alert">
												<div class="infoIcon">
													...
													<s:text name="you can add new expenses here" />
												</div>
											</div>
										</s:else>
									</p>
									...
									<table id="dataTable"
										...
										<thead>
											...
											<th style="width: 5%;"><s:text
												...
												<th><s:text name="MC_ID"></s:text></th>
												...
												<th><s:text name="Approved By"></s:text></th>
											</tr>
										</thead>
										<tbody>
											<s:iterator value="expensesMonthlyList">
												<tr>
													<td align="center">
														<div class="btn-group">
															<a id="view"
																href="viewExpensesMonthly?command=<s:property value='monthlyClaimId'/>"
														...
														<div class="btn-group">
															<a id="edit"
																href="editExpensesMonthly?command=<s:property value='monthlyClaimId' />"
													...
													<td><a style="color: blue"
														href="viewExpensesMonthly?command=<s:property value='monthlyClaimId' />"><s:property
																value='monthlyClaimId' /></a></td>
													
													<td><s:property value="name" /></td>
													<td><s:property value="claimedBalance" /></td>
