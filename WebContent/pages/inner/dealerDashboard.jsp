...
<style>
#dealerId,#cityId,#mobileId,#stateId
	{
	display: none;
}
</style>
...
<script type="text/javascript">
	 function showElements() {
		...
		var selectedIndex = document.getElementById('advanceDealerDetailSearch');

		var element1 = document.getElementById('dealerId');
				...
				<div class="row">
					<div class="col-lg-12">
						<ol class="breadcrumb" style="margin-top: 10px;">
							...
							<li class="active"><s:text name="Company"></s:text></li>
						...
						<div class="box">
							...
							<header>
								<div class="pull-left">
									<a class="icons" href="dashboard.action" data-toggle="tooltip"
										data-original-title="Back To Company DashBoard"> <i
										class="fa fa-table"></i>
									</a>

									<h5 class="header_color">
										<s:text name="Company Dashboard"></s:text>
									</h5>
								</div>
								<div class="pull-right">
									...
									<div class="btn-group">
										...
										<a href="addNewDealer" class="btn btn-primary btnheight"><i
											class="fa fa-plus fontawesomeht ">&nbsp;<s:text
													name="New Company"></s:text></i></a>
										...
										<a href="dealerDetailExcelReport" type="button" class="btn btn-default btnheight"><i
										...
										<s:else>
											...
											<div class="alert alert-info" role="alert"
												...
												<div class="infoIcon">
													...
													<s:text name="You can see Company dashboard from here" />
												</div>
											</div>
										</s:else>
									</p>
									<div id="collapse1" class="panel-collapse collapse">
										<div class="row searchBar">
											 <s:form name="purchaseAdvanceSearchForm" method="POST"
												action="populateDealerDetailsAsPerSearch">
												<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"
													...
													<div class="col-lg-4  col-md-4  col-sm-12 col-xs-12">
														<s:select list="dealerDetailSearchList" headerKey="-1"
															onchange="showElements();" id="advanceDealerDetailSearch"
													...
													<div class="col-lg-4  col-md-4  col-sm-12 col-xs-12">
														<div class="input-group">
															<s:textfield cssClass="form-control" id="dealerId"
																name="dealerId" placeholder="Company ID" />
									...
									<table id="dataTable"
										...
										<thead>
											...
											<th style="width: 7%;"><s:text
												...
												<th><s:text name="Company Id"></s:text>
												</th>
										...
										<tbody>
											<s:iterator value="dealerDetailList">
												<tr>
													
													<td align="center">
														<div class="btn-group">
															<a id="view"
																href="viewSpecificDealerDetail.action?command=<s:property value='dealerId'/>"
														...
														<div class="btn-group">
															<a id="edit"
																href="ViewDealerDetailForEdit?command=<s:property value='dealerId' />"
																data-toggle="tooltip" data-original-title="Edit"
																data-placement="bottom"> <i class="fa fa-edit"></i>
															</a>
														</div>
														<div class="btn-group">
															 <a id="delete" onclick="confirmDelete('deleteDealerDetail.action?command=<s:property value='dealerId' />')" data-toggle="tooltip"
