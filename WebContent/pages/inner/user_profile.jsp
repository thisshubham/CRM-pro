...
<body>
					...
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<div class="box inverse">
							<header>
								...
								<h5>
									<s:text name="User Management"></s:text>
								</h5>
									...
									<div class="row">
										<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
											<div class="box inverse"
												...
												<s:form action="updateUserProfile" name="myAccountForm"
																		...
																		<div class="row form-group">
																			...
																			<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
																				<s:textfield name="customerId"
																					placeholder="Customer ID" cssClass="form-control"
																					disabled="true" />
																			</div>
																		</div>
																	</div>
																	...
																	<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
																		<div class="row form-group">
																			...
																			<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
																					...
																					<s:select list="userStatusList" name="userStatus" headerKey="-1" cssClass="form-control"/>
																			...
																			<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
																				<div class="row form-group">
																					<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
																						<s:radio name="gender" list="{'Male'}"/>
																					</div>
																					<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
																						<s:radio name="gender" list="{'Female'}"/>
																					</div>
																					<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
																					</div>
																				</div>
																		...
																		<div class="row form-group">
																			...
																			<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
																				<s:textfield name="primaryEmailId"
																					placeholder="E-mail ID" cssClass="form-control" disabled="true"/>
																				<div id='myAccountForm_primaryEmailId_errorloc'
																					class="error_strings" ></div>
																			</div>
																		</div>
																	</div>
																...
																<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
																	...
																	<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
																		<div class="row form-group">
																			...
																			<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
																			<s:select list="designationList" name="designation" cssClass="form-control"/>
																...
																<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
																	<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
																		<div class="row form-group">
																			...
																			<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
																			<%-- 	<s:textfield name="userRole" placeholder="User Role"
																					cssClass="form-control" disabled="true" /> --%>
																					<s:select list="userRoleList" name="userRole" headerKey="-1" cssClass="form-control"/>
																			</div>
																		</div>
																	</div>
																	...
																	<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
																		<div class="row form-group">
																			...
																			<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
																					...
																					<s:select list="departmentList" name="department" cssClass="form-control"/>
																			</div>
																		</div>
																	</div>
																</div>
																...
																<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
																	<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
																		<div class="row form-group">
																			...
																			<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
																				<s:textfield name="location" placeholder="Location"
																					cssClass="form-control" />
																			</div>
																		</div>
																	</div>
																...
																<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
																	...
																	<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
																		<div class="row form-group">
																			...
																			<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
																				<s:textfield name="state" placeholder="State"
																					cssClass="form-control" />
																...
																<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
																	...
																	<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
																		<div class="row form-group">
																			...
																			<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
																				<s:select name="cuntry" id="cuntry" list="cuntryList"
																					headerKey="-1" headerValue="Select Country" theme="css_xhtml"
																					cssClass="form-control" />
																				<div id='myAccountForm_cuntry_errorloc'
																					class="error_strings"></div>
																			</div>
																		</div>
																	</div>
																	<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
																		<div class="row form-group">
																			...
																			<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
																				<s:textfield name="zipcode" placeholder="ZipCode"
																					cssClass="form-control" />
																...
																<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
																	...
																	<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
																		<div class="row form-group">
																			...
																			<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
																				<s:textfield name="phoneNo" placeholder="Phone"
																					cssClass="form-control" />
																	...
																	<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
																		<div class="row form-group">
																			...
																			<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
																				<s:textfield name="mobileNo" placeholder="Mobile"
																					cssClass="form-control" />
																...
																<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
																	...
																	<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
																		<div class="row form-group">
																			...
																			<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
																				<s:textfield name="faxNo" placeholder="Fax"
																					cssClass="form-control" />
																	...
																	<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
																		<div class="row form-group">
																			...
																			<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
																				<s:textfield name="webSite" placeholder="WebSite"
																					cssClass="form-control" />
																			</div>
					s													</div>
																	</div>
															...
															<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
																...
																<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
																	<div class="row form-group">
																		...
																		<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
																			...
																			<s:textfield name="language"
																					placeholder="Language" cssClass="form-control" disabled="true"/>
																				<%-- <s:select list="languageList" headerKey="1" name="language" cssClass="form-control"/> --%>
																...
																<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
																	<div class="row form-group">
																		...
																		<s:textfield name="currency"
																					placeholder="Currency" cssClass="form-control" disabled="true"/>
																			
																				<%-- <s:select list="currencyList" headerKey="1" name="currency" cssClass="form-control"/> --%>
															...
															<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
																...
																<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
																	<div class="row form-group">
																		...
																		<s:textfield name="timeZone"
																					placeholder="Timezone" cssClass="form-control" disabled="true"/>
																			
																				<%-- <s:select list="timeZoneList" headerKey="1" name="timeZone" cssClass="form-control"/> --%>
																				...
																				<div>
																					<span class="btn btn-default btn-file"><span
																						...
																						class="fileinput-exists"><s:text
																							...
																							type="file" name="userImage" /> </span> <a href="#"
	...
	<script type="text/javascript">
		...
		frmvalidator.addValidation("cuntry", "dontselect=-1",
				"Select Country Name");
