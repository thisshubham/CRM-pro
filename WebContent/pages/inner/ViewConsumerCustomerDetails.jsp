			...
			<div class="box">
				<div class="container-fluid">
					<ol class="breadcrumb" style="margin-top: 10px;">
						...
						<li><a href="salesDashboard"><%-- <s:text
									name="ticket.Dashboard.panel.heading"></s:text> --%>Consumer Dashboard</a></li>
						<li><a
							href="viewEstimateAction?command=<s:property value='id'/>"
							data-placement="bottom"> <%-- <s:text
									name="view.Ticket.panel.heading"></s:text> --%>View Consumer
						</a></li>
					</ol>
					...
					<h5>
						<%-- <s:text name="view.Ticket.panel.heading" /> --%>View Consumer Details
					</h5>
					<div class="pull-right">
						<div class="btn-group">
							<a class="btn btn-default btnheight" data-toggle="tooltip"
								...
								href="consumerDetailPrintPDF.action?command=<s:property value='customerId' />"
								...
								href="viewPreviousConsumerDetailInfo.action?command=<s:property value='customerId' />"
								...
								href="viewNextConsumerDetailInfo.action?command=<s:property value='customerId' />"
									...
									<div class="alert alert-info" role="alert">
										<div class="infoIcon">
											<i class="fa fa-info-circle "><%--  <s:text
													name="view.Ticket.infobar" /> --%>You can manage Consumer Details here</i>
										</div>
									</div>
								</s:else>
							</p>
								...
								<s:iterator value="consumerCustomerVO">
										...
										<div class="col-md-12 col-sm-12 col-xs-12"
											...
											<div class="col-md-2 col-sm-12 col-xs-12">
												<label for="text1" class="control-label" id="viewlable">
													<%-- <s:text name="add.new.ticket.ticketId"></s:text> --%>Consumer Id
												</label>
											</div>
									...
									<div class="row">
										<div class="col-md-12  col-sm-12 col-xs-12"
											...
											<div class="col-md-2 col-sm-12 col-xs-12">
												<label for="text1" class="control-label" id="viewlable">
													<%-- <s:text name="add.new.ticket.status" /> --%>Mobile Number 2
												</label>
											</div>
											<div class="col-md-10 col-sm-12 col-xs-12 control-label">
								...
								<%-- 	<div class="row">
									...
									<div class="row">
										<div class="col-md-12  col-sm-12 col-xs-12"
											...
											<div class="col-md-2 col-sm-12 col-xs-12">
												<label for="text1" class="control-label" id="viewlable">
												<%-- <s:text name="add.new.ticket.dueDate" /> --%>Home Website</label>
											</div>
											<div class="col-md-10 col-sm-12 col-xs-12 control-label">
