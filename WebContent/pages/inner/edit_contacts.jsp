...
<body>
				...
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<ol class="breadcrumb" style="margin-top: 10px;">
							...
							<li class="active"><s:text name="Edit Contact"></s:text></li>
						</ol>
						<s:form name="editContactForm" cssClass="form-horizontal"
							method="post" action="updateContacts.action">
							<div class="box dark">
								<header>
								<div class="pull-left">
										...
										<s:else>
											...
											<div class="alert alert-info" role="alert"
												...
												<div class="infoIcon">
													...
													<s:text name="You can edit contact information here" />
												</div>
											</div>
										</s:else>
									</p>
	...
	<script type="text/javascript">
		var frmvalidator = new Validator("editContactForm");
