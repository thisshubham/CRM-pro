			...
			<div class="box">
				<div class="container-fluid">
					<ol class="breadcrumb" style="margin-top: 10px;">
						...
						<li><a href="viewDealerTransactionDashboard"><%-- <s:text
									name="ticket.Dashboard.navbar"></s:text> --%>View Transaction</a></li>
						<li><a href="viewDealerTransactionDashboard"><%-- <s:text
									name="ticket.Dashboard.panel.heading"></s:text> --%>View Dealer Transaction Dashboard</a></li>
						<li><a
							href="viewDealerTransaction?command=<s:property value='id'/>"
							data-placement="bottom"> <%-- <s:text
									name="view.Ticket.panel.heading"></s:text> --%>View Dealer Transaction
						</a></li>
					</ol>
					...
					<h5>
						<%-- <s:text name="view.Ticket.panel.heading" /> --%>View Dealer Transaction
					</h5>
							...
							<a class="btn btn-default btnheight" data-toggle="tooltip"
								data-original-title="Help"><i class="fa fa-question"></i> <s:text
									name="project.form.button.help"></s:text></a>
									 <a href="generateLedgerPDF.action?command=<s:property value='retailerId' />"
								...
								href="dealerTransactionPrintPDF.action?command=<s:property value='transactionId' />"
								...
								href="viewPreviousDealerTransactionInfo.action?command=<s:property value='transactionId' />"
								...
								href="viewNextDealerTransactionInfo.action?command=<s:property value='transactionId' />"
									...
									<div class="alert alert-info" role="alert">
										<div class="infoIcon">
											<i class="fa fa-info-circle "><%--  <s:text
													name="view.Ticket.infobar" /> --%>You see dealer transaction from here</i>
										</div>
									</div>
								</s:else>
							</p>
								...
								<s:iterator value="dealerVO">
									<div class="row">
										<div
											...
											<h5>
												<%-- <s:text name="add.new.ticket.title" /> --%>Dealer Transaction Information
											</h5>
										</div>
									</div>
									<hr>
									...
									<div class="row">
										<div class="col-md-12  col-sm-12 col-xs-12"
											...
											<div class="col-md-2 col-sm-12 col-xs-12">
												<label for="text1" class="control-label" id="viewlable">
													<%-- <s:text name="add.new.ticket.status" /> --%>Dealer Id
												</label>
											</div>
											<div class="col-md-10 col-sm-12 col-xs-12 control-label">
									...
									<div class="row">
										<div class="col-md-12  col-sm-12 col-xs-12"
											...
											<div class="col-md-2 col-sm-12 col-xs-12">
												<label for="text1" class="control-label" id="viewlable">
													<%-- <s:text name="add.new.ticket.status" /> --%>Dealer Name
												</label>
											</div>
											<div class="col-md-10 col-sm-12 col-xs-12 control-label">
