							...
							<header>
								<div class="pull-left">
									...
									<h5 class="header_color">
										<s:text name="Item Dashboard"></s:text>
									</h5>
								</div>
									...
									<table id="dataTable"
										...
										<thead>
											<tr id="myrow">
												...
												<th><s:text name="Product Code"></s:text></th>
												<th><s:text name="Product Name"></s:text></th>
												<th><s:text name="Unite Price"></s:text></th>
												<th><s:text name="Quantity In Stock"></s:text></th>
										...
										<tbody>
											<s:iterator value="productGridList">
												<tr>
													...
													<td><s:property value="qtyInStock" /></td>
