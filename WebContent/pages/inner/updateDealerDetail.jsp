...
<title>Update Dealer Detail</title>
					...
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<ol class="breadcrumb" style="margin-top: 10px;">
							...
							<li><a href="contactsDashboard.action"><s:text
										name="Dealer"></s:text></a></li>
							<li class="active"><s:text name="Dealer Dashboard"></s:text></li>
							<li class="active"><s:text name="New Dealer"></s:text></li>
						</ol>
						<s:form name="addContactForm" cssClass="form-horizontal"
							method="post" action="updateDealerDetail">
							<div class="box dark">
								<header>
								<div class="pull-left">
									<a class="icons" href="contactsDashboard.action"
										data-toggle="tooltip"
										data-original-title="Back To Dealer DashBoard"
										style="color: black;"> <i class="fa fa-th-large"></i>
									</a>
									<h5>
										<s:text name="New Dealer" />
									</h5>
								</div>
										...
										<s:else>
											...
											<div class="alert alert-info" role="alert"
												...
												<div class="infoIcon">
													...
													<s:text name="You can see update dealer from here" />
												</div>
											</div>
										</s:else>
									</p>
								<div class="row" style="margin-top: 20px;">
										<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
											<h5 class="innertitle">
												<s:text name="Dealer Information"></s:text>
											</h5>
