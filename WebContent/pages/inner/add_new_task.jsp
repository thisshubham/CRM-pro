...
<body>
				...
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<div class="box dark">
							...
							<h5>
								<s:text name="add.new.task"></s:text>
							</h5>
							<div id="div1"></div>
							...
							<div class="body">
								...
								<s:form class="form-horizontal" name="addNewTaskForm"
									action="addNewTaskAllocationDetails">
										...
										<p>
											...
											<s:else>
												<div class="infoIcon">
													...
													name="add.new.task.information.bar" />
											</s:else>
										</p>
									</div>
													...
													<div class="row">
														<div class="col-lg-3 col-md-3 col-sm-3 col-xs-5">
															<s:select class="form-control" name="salutation"
																...
																<div id='addNewTaskForm_salutation_errorloc'
														...
														<div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
															...
															<div id='addNewTaskForm_taskAllocatedTo_errorloc'
																class="error_strings"></div>
														</div>
													</div>
												</div>
										...
										<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
											<div class="row form-group">
												...
												<div class="col-lg-6 col-md-6 col-sm-10 col-xs-10">
													...
													<div id='addNewTaskForm_taskSubject_errorloc'
														class="error_strings"></div>
												</div>
										...
										<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
											<div class="row form-group">
												...
												<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
													...
													<div id='addNewTaskForm_dueDate_errorloc'
														class="error_strings"></div>
												</div>
											</div>
										</div>
											...
											<div class="row form-group">
												...
												<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
													<s:select cssClass="form-control" id="selectOption"
														...
														list="repeatTypeList" />
													<div id='addNewTaskForm_repeatType_errorloc'
														class="error_strings"></div>
													<div id='addNewTaskForm_repeatForEveryWeek_errorloc'
														class="error_strings"></div>
													<div id='addNewTaskForm_numberOfWeeks_errorloc'
														class="error_strings"></div>
													<div id='addNewTaskForm_weeksDay_errorloc'
														class="error_strings"></div>
													<div id='addNewTaskForm_onDayOfMonths_errorloc'
														class="error_strings"></div>
													<div id='addNewTaskForm_monthsDay_errorloc'
														class="error_strings"></div>
													<div id='addNewTaskForm_numberOfMonths_errorloc'
														class="error_strings"></div>
													<div id='addNewTaskForm_onWeek_errorloc'
														class="error_strings"></div>
													<div id='addNewTaskForm_ofWeekDay_errorloc'
														class="error_strings"></div>
													<div id='addNewTaskForm_onEveryNoOfMonths_errorloc'
														class="error_strings"></div>
													<div id='addNewTaskForm_onEveryOfYear_errorloc'
														class="error_strings"></div>
													<div id='addNewTaskForm_onMonthOfYear_errorloc'
														class="error_strings"></div>
													<div id='addNewTaskForm_everyWeekOfYear_errorloc'
														class="error_strings"></div>
													<div id='addNewTaskForm_everyWeekDayOfYear_errorloc'
														class="error_strings"></div>
													<div id='addNewTaskForm_onDayOfYear_errorloc'
														class="error_strings"></div>
													<div id='addNewTaskForm_everyMonthOfYear_errorloc'
														class="error_strings"></div>
													<div id='addNewTaskForm_everyDay_errorloc'
														class="error_strings"></div>
													<div id='addNewTaskForm_numberOfDays_errorloc'
														class="error_strings"></div>
												</div>
											</div>
										</div>
										<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
											<div class="row form-group">
												...
												<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
													...
													<div id='addNewTaskForm_startDate_errorloc'
														class="error_strings"></div>
												</div>
												<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
													...
													<div id='addNewTaskForm_endDate_errorloc'
														class="error_strings"></div>
												</div>
											</div>
										</div>
									...
									<div class="form-group">
										<div id='addNewTaskForm_discription_errorloc'
	...
	<script type="text/javascript">
		var frmvalidator = new Validator("addNewTaskForm");
