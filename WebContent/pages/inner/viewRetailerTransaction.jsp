...
<title>View Retailer Transaction</title>
</head>
<body>
<div class="outer">
				...
				<div class="container-fluid">
					<ol class="breadcrumb" style="margin-top: 10px;">
						...
						<li><a href="salesDashboard"><%-- <s:text
									name="ticket.Dashboard.navbar"></s:text> --%>Retailer Transaction</a></li>
						<li><a href="salesDashboard"><%-- <s:text
									name="ticket.Dashboard.panel.heading"></s:text> --%>Retailer Transaction Dashboard</a></li>
						<li><a
							href="viewEstimateAction?command=<s:property value='id'/>"
							data-placement="bottom"> <%-- <s:text
									name="view.Ticket.panel.heading"></s:text> --%>View Retailer Transaction
						</a></li>
					</ol>
					...
					<h5>
						<%-- <s:text name="view.Ticket.panel.heading" /> --%>View Retailer Transaction Details
					</h5>
					<div class="pull-right">
						<div class="btn-group">
							<a class="btn btn-default btnheight" data-toggle="tooltip"
								...
								href="retailerTransactionPrintPDF.action?command=<s:property value='transactionId' />"
								...
								href="viewPreviousRetailerTransactionInfo.action?command=<s:property value='transactionId' />"
								...
								href="viewNextRetailerTransactionInfo.action?command=<s:property value='transactionId' />"
								class="btn btn-default btnheight"><i
								class="fa fa-chevron-right fontawesomeht"></i></a> <a
								data-toggle="tooltip" data-original-title="Close"
								href="completeRetailerTransaction" class="btn btn-danger btnheight"><i
									...
									<div class="alert alert-info" role="alert">
										<div class="infoIcon">
											<i class="fa fa-info-circle "><%--  <s:text
													name="view.Ticket.infobar" /> --%>You can see Retailer Transaction Details here</i>
										</div>
									</div>
								</s:else>
							</p>
								...
								<s:iterator value="retailerCustomerVO">
									<div class="row">
										<div
											...
											<h5>
												<%-- <s:text name="add.new.ticket.title" /> --%>Retailer Transaction Information
											</h5>
										</div>
									</div>
									<hr>
									...
									<div class="row">
										<div class="col-md-12  col-sm-12 col-xs-12"
											...
											<div class="col-md-2 col-sm-12 col-xs-12">
												<label for="text1" class="control-label" id="viewlable">
													<%-- <s:text name="add.new.ticket.status" /> --%>Retailer Id
												</label>
											</div>
											<div class="col-md-10 col-sm-12 col-xs-12 control-label">
									...
									<div class="row">
										<div class="col-md-12  col-sm-12 col-xs-12"
											...
											<div class="col-md-2 col-sm-12 col-xs-12">
												<label for="text1" class="control-label" id="viewlable">
													<%-- <s:text name="add.new.ticket.status" /> --%>Retailer Name
												</label>
											</div>
											<div class="col-md-10 col-sm-12 col-xs-12 control-label">
									...
									<div class="row">
										...
										<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"
											align="center">
											<a href="completeRetailerTransaction" data-toggle="tooltip"
