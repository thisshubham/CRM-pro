...
<title>Sale Quick Invoice</title>
	...
	function getProductList() {
		...
		xmlhttp.onreadystatechange = function() {
			if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
				...
				array_element += "<div class='col-md-2 col-sm-2' style='padding:2px;' id='productPrice"+adv+"'><input type='text' style='width:124px; height:35px' value='0' name='itemPrice' id='price1' placeholder='Price'/></div>";
	...
	var productId=document.getElementById("itemId").value;
		xmlhttp.onreadystatechange = function() {
			if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
				...
				var	array_element2= "<input type='text'  Class='form-control'  name='itemPrice' id='itemPrice' value='"+array.product.productPrice +"' />";
		...
		xmlhttp.onreadystatechange = function() {
			if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
				...
				/* var	array_element2= "<input type='text'  Class='form-control'  name='itemPrice' id='itemPrice' value='"+array.product.productPrice +"' readonly='true' />"; */
                  var	array_element1=" <input type='text' name= 'address' placeholder= 'Address' value= '"+array.regularCustomer.custAddress +"' style='width: 50%;height:30px;margin-left:18px;' id='purchaseitemName' Class ='form-control' />";
				
				var	array_element2=	" <input type='text' name = 'phoneNo' placeholder = 'ContactNo' value = '"+array.regularCustomer.custContact +"'  style ='width: 50%;height:30px;margin-left:18px;'   id = 'purchaseitemCode' Class = 'form-control' />" ;
...
function getConsumerCustomerDetails() {
		...
		xmlhttp.onreadystatechange = function() {
			if(xmlhttp.readyState == 4 && xmlhttp.status == 200) {
				...
				var	array_element4=" <input type='text' name = 'phoneNoConsumer' placeholder = 'ContactNo' value = '"+array.consumerCustomer.consuContact +"' style ='width: 50%;height:30px;'   id = 'customerPhoneNo2' Class = 'form-control' />" ;
				
				var	array_element3=" <input type='text' name= 'addressConsumer' placeholder= 'Address' value= '"+array.consumerCustomer.consuAddress +"' style='width: 50%;height:30px;' id='customerAddress2' Class ='form-control' />";
	...
	var productId=document.getElementById("itemId1"+adv).value;
		xmlhttp.onreadystatechange = function() {
			if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
				...
				var	array_element2= "<div class='col-md-2 col-sm-2' style='padding:2px;' id='productPrice"+advance+"'><input type='text' style='width:124px; height:35px' id='price1"+advance+"' value='"+array.product.productPrice +"'  name='itemPrice'  placeholder='Price'/></div>";
...
function calculateAmountWithTax() {
		...
		if(productTax==1){
			productTax=5;
		}else if(productTax==2){
			productTax=12;
		}else if(productTax==3){
			productTax=18;
		}else if(productTax==4){
			productTax=28;
		}
		var amount = productQuantity * productPrice;
		amountTotal = amountTotal + amount;
		/* alert("amount"+amount); */
		/* /////////////////////// */
		var cal= 100/(100+productTax);
		
		/* alert(cal+"DDDDDD"+productTax); */
		
		
		/* ////////////////////////////// */
	     /* amountTax=(amount*productTax)/100; */
	     amountWithTax=amount * cal;
	     amountTax=amount-amountWithTax;
	    // amountTaxper=amount-amountWithTax;
	      amountTaxper = amountTaxper + amountTax; 
	    /*  alert("total amount Tax value"+amountTaxper);
		alert("amountTax"+amountTax); */
		//amountWithTax=num.toFixed(2);
		/* var amountWithTax=Number(amount)+Number(amountTax); */
		/* alert("amountWithTax"+amountWithTax); */
		document.getElementById("amountId").innerHTML = "<input type='text' value='"+amountWithTax.toFixed(2)+"' name='amount' id='amountFirst' class='form-control' readonly='true'/>";
		document.getElementById("totalTax").innerHTML ="<input type='text' value='"+amountTax.toFixed(2)+"' name='totalTax' class='form-control' id='totalTaxId' placeholder='click here' onblur='calculateTotalTaxValue();' readonly='true' />";
	...
	function calculateAmountSecond(advance) {
		...
		calculatesubTotalAmount();
		calculateSubTotal();
		calculateNetTotalbyIdSec(advance);
}
	...
	function calculateAmountSecondWithTax(advance) {
		...
		var productPrice = document.getElementById("price1"+advance).value;
		var productTax = document.getElementById("itemTax"+advance).value;
		var tTax = document.getElementById("totalTaxId").value;
		/* var productTax = getItemTaxValue(pTax);
		//var productTax = document.getElementById("taxIDD").value;
		alert("totalTaxValue"+productTax); */
		if(productTax==1){
		...
		/* ////////////////////////////// */
	     /* amountTax=(amount*productTax)/100; */
	     amountWithTax=amount * cal;
	     amountTax=amount-amountWithTax.toFixed(2);
	     amountTaxper = amountTaxper + amountTax;
	     var allTax=parseFloat(amountTax.toFixed(2))+parseFloat(tTax);
	     //amountTaxper=amount-amountWithTax;
		/* var amount = productQuantity * productPrice;
		amountTotal = amountTotal + amount;
		 amountTax=(amount*productTax)/100; */
		...
		/* alert("total amount Tax value"+amountTaxper); */ 
		/* var amountWithTax=(amount)+(amountTax); */
		document.getElementById("amountId"+advance).innerHTML ="<div class='col-md-2 col-sm-2' style='padding:2px;' ><input type='text'  style='width:120px; height:35px' name='amount' value='"+amountWithTax.toFixed(2)+"' id='amounttID"+advance+"' placeholder='Amount' readonly='true'/>";
		document.getElementById("totalTax").innerHTML ="<input type='text' value='"+allTax+"' name='totalTax' id='totalTaxId' class='form-control' placeholder='click here' onblur='calculateTotalTaxValue();' readonly='true' />";
	...
	function calculateSubTotal()
	{
		...
		document.getElementById("subTotalId").innerHTML ="<input type='text' value='"+subTotal.toFixed(3)+"' name='total' id='totalINR' class='form-control' placeholder='click here' onblur='calculateSubTotal();' readonly='true' />";
	...
	{
		 var totalTaxValue = amountTaxper.toFixed(2);
	...
	function calculateNetTotal(discount)
	{
		...
		var totalINRValue = document.getElementById("nt").value;
		/* alert("totalINRValue"+totalINRValue); */
		//var disValue = (discount/100)*totalINRValue;
		/* alert("disValue"+disValue); */
		var totalnetValue = totalINRValue - discount;
		/* alert("totalnetValue"+totalnetValue);  */
		document.getElementById("netTotalId").innerHTML ="<input type='text' value='"+totalnetValue+"' name='netTotal' class='form-control' id='nt' placeholder='click here'  readonly='true' />";

		
	}
	
	function calculateNetTotalAfterTransportCharges(transportCharges)
	{
		
		var totalINRValue = document.getElementById("nt").value;
	
	
		var totalnetValue = parseFloat(totalINRValue) + parseFloat(transportCharges);
	...
	function calculateNetTotalbyId()
	{
		...
		/* alert("totalnetValue"+totalnetValue); */ 
		document.getElementById("netTotalId").innerHTML ="<input type='text' value='"+totalnetValue.toFixed(3)+"' name='netTotal' class='form-control' id='nt' placeholder='click here'  readonly='true' />";

		
	}
	
	function calculateNetTotalbyIdSec(advance){
		var discount = document.getElementById("discount").value;
		var totalINRValue = document.getElementById("amounttID"+advance).value;
		var nto = document.getElementById("nt").value;
		/* alert("totalINRValue"+totalINRValue); */
		var allTot=parseFloat(totalINRValue)+parseFloat(nto);
		/* alert("allTot"+allTot); */
		var disValue = (discount/100)*allTot;
	/* alert("disValue"+disValue); */ 
		var totalnetValue = allTot - disValue;
		/* alert("totalnetValue"+totalnetValue); */ 
		document.getElementById("netTotalId").innerHTML ="<input type='text' value='"+totalnetValue.toFixed(3)+"' name='netTotal' class='form-control' id='nt' placeholder='click here'  readonly='true' />";
 ...
 <div class="panel panel-default" style="margin-left:-30px;">
			...
			<div class="panel-heading">
			   ...
			   <%-- <div class="alert alert-info">
			    ...
			    <s:form action="addSalesDetails" name="addSales" cssClass="form-horizontal"
			   ...
			   <%--  <div class="col-md-6 col-sm-6 col-xs-8" >
							        ...
							        <!-- added by me -->
							         ...
							         <div id='addSales_account_errorloc'
													...
													<div class="col-sm-10 col-md-10" style="width: 80%;">
							       ...
							       <select class="form-control" name="accountTypeId" theme="css_xhtml" cssStyle="width: 10px;height:35px;"
									...
									<a href="addRetailercustomerAction"><img
										alt="Add New Client" src="assets/img/plus-icon.png"
										style="height: 30px; width: 30px; margin-left: -20px;"
										title="Add New Client"></a>
								</div>	
							        </div>
							        
							        <!-- added by me -->
							        <div class="form-group" id="customerPhoneNo">
							        <div class="col-sm-10 col-md-10" style="width: 70%;">
							      <div id='addSales_itemCode_errorloc'
													class="error_strings" style="color: red;"></div>
								     <s:textfield name="phoneNo" 
		 						       placeholder="ContactNo"
									   theme="css_xhtml" cssStyle="width: 80%;height:30px;" 
							         ...
							         <div class="col-sm-10 col-md-10" style="width: 70%;">
			   			        <div id='addSales_itemName_errorloc'
													class="error_strings" style="color: red;"></div>
								    
				      				 <s:textfield name="address" 
									          placeholder="Address"
									          theme="css_xhtml" cssStyle="height:30px;width: 80%;" 
								    ...
								    <div class="form-group">
								    <div class="col-sm-10 col-md-10" style="width: 70%;">
								      <div id='addSales_salesDate_errorloc'
													class="error_strings" style="color: red;"></div>
							              <s:textfield name="salesDate" tabindex="13"
														cssClass="form-control" theme="css_xhtml" cssStyle="width: 60%;"
													 placeholder="date"/>  
														 <input type="date" name="salesDate" tabindex="13"
														cssClass="form-control" theme="css_xhtml" style="width: 80%;height:30px;"
...
<!-- gggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggg -->						      
								    ...
								    <%--  <s:textfield name="fullNameConsumer" 
									   ...
									   <%--  <s:select cssClass="form-control chzn-select" list="consumerCustomersList" id="custId2"
											...
											cssStyle="width: 60%;"  onchange="getConsumerCustomerDetails()"/>   --%>
											 <s:textfield name="customerIdConsumer" 
									          placeholder="Customer Name"
									          theme="css_xhtml" cssStyle="width: 50%;height:30px;" 
									           cssClass="form-control"/>
											</div>
											
									<!-- <div class="col-md-2 col-sm-2">
									<a href="addConsumerCustomerAction"><img
										alt="Add New Client" src="assets/img/plus-icon.png"
										style="height: 30px; width: 30px; margin-left: -20px;"
										title="Add New Client"></a>
								</div> -->		
			   			        ...
			   			        <div id='addSales_salsetaxrate_errorloc'
								    ...
								    <div class="form-group" id="customerAddress2">
								      <div id='addSales_salseUnit_errorloc'
													class="error_strings" style="color: red;"></div>
							             <s:textfield name="addressConsumer"
														cssClass="form-control" theme="css_xhtml" cssStyle="width: 50%;height:30px;"
														 placeholder="Address" />
									  
								    </div>
						      
						     <div class="form-group">
								      <div id='addSales_salseunitprice_errorloc'
													class="error_strings" style="color: red;"></div>
							             <input type="date" name="salesDateConsumer" tabindex="13"
														cssClass="form-control" theme="css_xhtml" style="width: 50%;height:30px;"
														id="purchaseunit" placeholder="Current Date"/> 
										...
										<div class="col-md-2 col-sm-2 col-xs-12"
											...
											<div class="input-group" id="productPrice">
												<s:textfield name="itemPrice" value="0"
													...
													placeholder="%{getText('Price')}" readonly="false" />
											</div>
										</div>
								...
								<div class="row" style="padding: 3px;">
									...
									<div class="col-md-8 col-sm-8">
										<div class="col-md-8 col-sm-8">
											...
											<div class="col-md-6 col-sm-6">
												<div class="col-sm-2 control-div" style="width: 40%;">
													<s:text name="Discount(Rs.)"></s:text>
												</div>
											</div>
										</div>
										<div class="col-md-4 col-sm-4"
								...
								<div class="row" style="padding: 3px;">
									...
									<div class="col-md-8 col-sm-8">
										<div class="col-md-8 col-sm-8">
											...
											<div class="col-md-6 col-sm-6">
												<div class="col-sm-2 control-div" style="width: 40%;">
													<s:text name="Transport Charges(Rs.)"></s:text>
												</div>
											</div>
										</div>
										<div class="col-md-4 col-sm-4"
											style="width: 160px; height: 35px">
											<s:textfield name="transpportCharges" id="tchargesId" value="0"
												onkeypress="return isNumber(event)"
												onblur="calculateNetTotalAfterTransportCharges(tchargesId.value);"
												cssClass="form-control" theme="css_xhtml" />
										</div>
									</div>
								</div>
									...
									<div class="col-md-8 col-sm-8">
										...
										<div class="col-md-4 col-sm-4"
											...
											<s:textfield name="netTotal" value="0" 
												cssClass="form-control" theme="css_xhtml"  id="nt"/>
										</div>
									</div>
								</div>
