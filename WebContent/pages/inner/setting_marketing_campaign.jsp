...
<body>
				...
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<ol class="breadcrumb" style="margin-top: 10px;">
							...
							<li class="active"><s:text
									name="setting.marketing.campaign.navigation.bar"></s:text></li>

						</ol>
						<div class="box ">
							<s:form class="form-horizontal"
								action="insertCampaignTypeDetails" name="campaignTypeForm">
								<header>
								<div class="icons">
									...
									<div class="col-lg-12  col-md-12  col-sm-12 col-xs-12"
										...
										<ul class="nav nav-tabs" role="tablist">
											...
											<li role="presentation" class="active"><a
												href="settingMarketingCampaignType.action"
																...
																<s:else>
																	<div class="alert alert-info" role="alert"
																		...
																		<div class="infoIcon">
																			...
																			<s:text
																				name="setting.marketing.campaign.information.bar" />
																		</div>
																	</div>
																</s:else>
															</p>
														...
														<div class="row">
															...
															<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
																<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
																	<s:text name="setting.marketing.campaign.label"></s:text>
																	<div class="star">*</div>
																</div>
																<div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">

																	<s:textfield type="text" name="campaigntype"
																		class="form-control" cssClass="form-control" />
																	<div id='campaignTypeForm_campaigntype_errorloc'
															...
															<thead>
																<tr id="myrow">
																	...
																	<th style="width: 20%;"><s:text
																			name="setting.marketing.campaign.id"></s:text></th>
																	<th><s:text
																			name="setting.marketing.campaign.label"></s:text></th>
																</tr>
															</thead>
															<tbody>
																<s:iterator value="showMarketingCampaignTypeList">
																	<tr>
																		<td align="center">

																			<div class="btn-group">
																				<a id="edit"
																					href="settingEditCampaignType.action?command=<s:property value='campaigntypeID'/>"
	...
	<script type="text/javascript">
		var frmvalidator = new Validator("campaignTypeForm");
		frmvalidator.EnableOnPageErrorDisplay();
		frmvalidator.EnableMsgsTogether();
		frmvalidator.addValidation("campaigntype", "req",
				"Please Enter Campaign Type");
		frmvalidator.addValidation("campaigntype", "maxlen=100",
				"Please Enter maxlen 100");
		frmvalidator.addValidation("campaigntype", "minlen=3",
