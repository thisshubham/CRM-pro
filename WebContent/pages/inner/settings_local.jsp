						...
						<div class="box ">
							...
							<div class="container"
								...
								<ul class="nav nav-tabs" role="tablist">
									...
									<li role="presentation" class="active"><a href="settingsLocal.action"
										style="color: Gray;background-color: #F9F9F9;"><s:text name="add.user.menus.local" /></a></li>
									<li role="presentation"><a href="settingsUser.action"
										style="color: Gray;"><s:text name="add.user.menus.user" /></a></li>
									<li role="presentation"><a
										href="settingsDisclaimar.action" style="color: Gray;"><s:text
