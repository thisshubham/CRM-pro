...
<body>
								...
								<div class="container-fluid">
									<div class="col-lg-12  col-md-12  col-sm-12 col-xs-12"
										...
										<ul class="nav nav-tabs" role="tablist">
											...
											<li role="presentation"><a
												href="settingCompanyLocal.action" style="color: Gray;"><s:text
																...
																<s:else>
																	<div class="alert alert-info" role="alert"
																		...
																		<div class="infoIcon">
																			...
																			<s:text name="setting.company.edit.sector" />
																		</div>
																	</div>
																</s:else>
															</p>
														...
														<div class="row">
															...
															<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
																...
																<div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
																	...
																	<div id='settingEditSectorForm_sector_errorloc'
															...
															<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12" align="center" >
																<button type="submit" Class="btn btn-primary btnheight"
																	...
																	<i class="fa fa-check"></i>
																	<s:text name="project.form.button.save"></s:text>
																	<div hidden-lg hidden-md><br></div>
																</button>
	...
	<script type="text/javascript">
		var frmvalidator = new Validator("settingEditSectorForm");
