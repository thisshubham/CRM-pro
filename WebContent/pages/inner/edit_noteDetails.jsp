			...
			<div class="inner bg-light lter">
				...
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						...
						<s:form name="addCreatedNoteForm" action="updateNoteDetails"
