					...
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<ol class="breadcrumb" style="margin-top: 10px;">
							...
							<li><a href="leadDashboard.action"><s:text
										name="navbar.document"></s:text></a></li>
							<li class="active"><s:text name="navbar.document.dashboard"></s:text></li>
							<li class="active"><s:text name="navbar.document.add.document"></s:text></li>
						</ol>
						<s:form name="addCreatedLeadForm" action="addLeadDetail"
							...
							<div class="box dark">
								...
								<div class="pull-left">
									...
									<h5>
										<s:text name="add.create.lead.create.lead" />
									</h5>
								</div>
										...
										<s:else>
											...
											<div class="alert alert-info" role="alert"
												...
												<div class="infoIcon">
													...
													<s:text name="add.document.information.bar" />
												</div>
											</div>
										</s:else>
									</p>
													...
													<div class="row">
														<div class="col-lg-3 col-md-3 col-sm-3 col-xs-5">
															<s:select name="salutation" tabindex="2"
																list="{'b','a'}" cssClass="form-control" />
									...
									<div class="row">
										...
										<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
											<div class="row form-group">
												...
												<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
													<s:select list="{'b','a'}" name="companyType" id=""
									...
									<div class="row">
										...
										<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
											<div class="row form-group">
												...
												<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
													<s:select cssClass="form-control chzn-select"
														list="{'b','a'}" name="companySector" tabindex="8" />
											...
											<div class="row form-group">
												...
												<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
													<s:select name="leadSource" id=""
														cssClass="form-control chzn-select" list="{'b','a'}"
									...
									<div class="row">
										...
										<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
											<div class="row form-group">
												...
												<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
													<s:select cssClass="form-control chzn-select"
														name="ratings" list="{'b','a'}" headerKey="-1"
									...
									<div class="row">
										...
										<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
											<div class="row form-group">
												...
												<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
													<s:select cssClass="form-control chzn-select"
														name="leadStatus" list="{'b','a'}" headerKey="-1"
														tabindex="19" />
									...
									<div class="row">
										<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
											<div class="row form-group">
												...
												<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
													<s:select list="{'b','a'}" name="country" id="country"
