				...
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						...
						<s:form name="addContactForm" cssClass="form-horizontal"
							method="post" action="addPayDueDealerTransaction">
                                         ...
                                         <%-- <select class="form-control" name="accountTypeId" theme="css_xhtml" 
											...
											<option>2</option>
														...
														<div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
															 <%-- <s:select cssClass="form-control " list="dealerList" id="custId" theme="css_xhtml" 
											headerKey="-1" headerValue="Select Customer"
...
<s:hidden name ="transactionBillNo"/>
									...
									<div class="row">
										...
										<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
											...
											<s:select cssClass="form-control chzn-select"
														list="payModeList" headerKey="1" name="paymentMode"
														tabindex="5">
