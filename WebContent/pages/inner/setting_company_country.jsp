...
<body>
			...
			<div class="inner bg-light lter">
				...
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						...
						<div class="box ">
							<s:form class="form-horizontal" action="insertCountry"
								name="settingCountryForm">
								<header>
								<div class="icons">
																...
																<s:else>
																	<div class="alert alert-info" role="alert"
																		...
																		<div class="infoIcon">
																			...
																			<s:text name="add.setting.company.Country.infobar" />
																		</div>
																	</div>
																</s:else>
															</p>
																	...
																	<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
																		<div class="row form-group">
																			...
																			<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
																				...
																				<div id='settingCountryForm_countryname_errorloc'
																		...
																		<div class="row form-group">
																			...
																			<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
																				<s:textfield type="text" name="isdCode"
																					...
																					cssClass="form-control"></s:textfield>
																				<div id='settingCountryForm_isdCode_errorloc'
																					class="error_strings"></div>
																	...
																	<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
																		<div class="row form-group">
																			...
																			<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
																				...
																				<div id='settingCountryForm_countryCode_errorloc'
																					class="error_strings"></div>
																			</div>
																		</div>
																	</div>
																	<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
																		<div class="row form-group">
																			...
																			<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
																				...
																				<div
																					id='settingCountryForm_countrydisplayName_errorloc'
																					class="error_strings"></div>
																			</div>
																		</div>
																	</div>
														...
														<table id="dataTable"
															...
															<thead>
																<tr id="myrow">
																	...
																	<th><s:text name="setting.company.label.id"></s:text></th>
																	<th><s:text
																			name="setting.company.label.Country.name"></s:text></th>
																	<th><s:text name="setting.company.label.isd.code"></s:text></th>
																	<th><s:text
																			name="setting.company.label.country.code"></s:text></th>
																	<th><s:text
																			name="setting.company.label.country.display.name"></s:text></th>
																</tr>
															</thead>
															<tbody>
																<s:iterator value="showCountryList">
																	<tr>
																		<td align="center">
																			<div class="btn-group">
																			...
																			<div class="btn-group">
																				<a id="edit"
																					href="settingEditCountry.action?command=<s:property value="countryID"/>"
																		...
																		<td><a style="color: blue" href=""><s:property
																					value='countryID' /></a></td>
																		<td><s:property value="countryname" /></td>
																		<td><s:property value="isdCode" /></td>
																		<td><s:property value="countryCode" /></td>
																		<td><s:property value="countrydisplayName" /></td>
	...
	<script type="text/javascript">
		var frmvalidator = new Validator("settingCountryForm");
