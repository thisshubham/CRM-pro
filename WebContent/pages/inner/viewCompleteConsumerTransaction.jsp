...
<script type="text/javascript">
	 function showElements() {
		...
		var selectedIndex = document.getElementById('advanceConsumerTransactionSearch');
...
<div id="content">
				...
				<div class="row">
					<div class="col-lg-12">
						<ol class="breadcrumb" style="margin-top: 10px;">
							...
							<li class="active"><s:text name="Consumer Transaction"></s:text></li>
							<li class="active"><s:text name=" New Consumer Transaction"></s:text></li>
						...
						<div class="box">
							...
							<header>
								<div class="pull-left">
									<a class="icons" href="dashboard.action" data-toggle="tooltip"
										data-original-title="Back To Consumer DashBoard"> <i
										class="fa fa-table"></i>
									</a>

									<h5 class="header_color">
										<s:text name="Consumer Dashboard"></s:text>
									</h5>
								</div>
								<div class="pull-right">
									...
									<div class="btn-group">
										...
										<a href="consumerTransactionExcelReport.action" type="button" class="btn btn-default btnheight"><i
								...
								<div class="table-responsive">
									<p>
										...
										<s:else>
											...
											<div class="alert alert-info" role="alert"
												...
												<div class="infoIcon">
													...
													<s:text name="You can manage consumer transaction from here" />
												</div>
											</div>
										</s:else>
									</p>
										...
										<div class="row searchBar">
											 <s:form name="consumerAdvanceSearchForm" method="POST"
												action="populateConsumerTransactionAsPerSearch">
												<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"
													...
													<div class="col-lg-4  col-md-4  col-sm-12 col-xs-12">
														<s:select list="consumerTransactionSearchList" headerKey="-1"
															onchange="showElements();" id="advanceConsumerTransactionSearch"
                                      ...
                                      <select class="form-control" theme="css_xhtml" cssStyle="width: 250px;height:35px;" id="descriptionId"
											...
											<option>ON_DUE_PAYMENT</option>
                                                  ...
                                                  <s:textfield cssClass="form-control" id="retailerId"
																name="retailerId" placeholder="Consumer" />
									...
									<table id="dataTable"
										...
										<tbody>
											<s:iterator value="consumerTransactionDetailList">
												...
												<tr>
													...
													<td align="center">
														<div class="btn-group">
															<a id="view"
																href="viewConsumerTransactionAction.action?command=<s:property value='transactionId'/>"
														...
														<div class="btn-group">
															<a id="edit"
																href="payDueAmountOfConsumerAction.action?command=<s:property value='transactionId' />&did=<s:property value='retailerId' />"
																data-toggle="tooltip" data-original-title="Pay Due"
																data-placement="bottom"> <i class="fa fa-edit"></i>
															</a>
														</div>
														<div class="btn-group">
															<a id="delete" onclick="confirmDelete('deleteConsumerTransaction.action?command=<s:property value='transactionId' />')" data-toggle="tooltip"
	...
	<script src="outer/js1/vendor/jquery-1.10.2.min.js"></script>
