...
<script type="text/javascript">
	 function showElements() {
		...
		var selectedIndex = document.getElementById('advancePurchaseWallPaintSearch');
					...
					<div class="col-lg-12">
						<ol class="breadcrumb" style="margin-top: 10px;">
							...
							<li class="active"><s:text
									name="Purchase Wall Paint"></s:text></li>
						</ol>
						<div class="box">
							<header>
								<div class="pull-left">
									...
									<h5 class="header_color">
										<s:text name="Purchase Paint DashBoard"></s:text>
									</h5>
								</div>
								<div class="pull-right">
									<div class="btn-group">
										<a href="addNewPaintPurchase" data-toggle="tooltip"
										...
										<s:else>
											...
											<div class="alert alert-info" role="alert">
												<div class="infoIcon">
													...
													<s:text name="you can manage purchase paint from here" />
												</div>
											</div>
										</s:else>
									</p>
								<div id="collapse1" class="panel-collapse collapse">
										<div class="row searchBar">
											 <s:form name="purchaseAdvanceSearchForm" method="POST"
												action="populatePurchaseWallpaintDetailsAsPerSearch">
												<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"
													...
													<div class="col-lg-4  col-md-4  col-sm-12 col-xs-12">
														<s:select list="purchaseWallpaintSearchList" headerKey="-1"
															onchange="showElements();" id="advancePurchaseWallPaintSearch"
										...
										<thead>
											<tr id="myrow">
												...
												<th><s:text name="Quantity(liter)"></s:text></th>
										...
										<tbody>
											<s:iterator value="wallPaintPurchaseList">
												<tr>
													<td align="center">
														<div class="btn-group">
															<a id="view"
																href="viewWallpaintPurchaseDetails.action?command=<s:property value='purchaseId' />"
																data-toggle="tooltip" data-original-title="View"
																data-placement="bottom"> <i class="fa fa-eye"></i>
															</a>
														</div>
														<div class="btn-group">
															<a id="edit" href="updatePaintPurchase.action?command=<s:property value='purchaseId' />"
														...
														<div class="btn-group">
															<a id="delete" href="#"
																onclick="confirmDelete('deleteWallpaintPurchaseDetails.action?command='+<s:property value='purchaseId'/>)"
