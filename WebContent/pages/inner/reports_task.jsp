						...
						<div class="box ">
							...
							<div class="container"
								...
								<ul class="nav nav-tabs" role="tablist">
									...
									<li role="presentation"><a href="clientsReports.action" style="color: Gray;">Clients</a></li>
									<li role="presentation"><a href="contactsReports.action" style="color: Gray;">Contacts</a></li>
									...
									<li role="presentation" class="active"><a href="taskReports.action" style="background-color: #F9F9F9; color: Gray;">Task</a></li>
