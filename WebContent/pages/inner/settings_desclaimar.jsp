							...
							<div class="container"
								...
								<div class="container"
									...
									<ul class="nav nav-tabs" role="tablist">
										...
										<li role="presentation" ><a
											href="settingsLocal.action"
											style="color: Gray; background-color: #F9F9F9;"><s:text
													name="add.user.menus.local" /></a></li>
										<li role="presentation"><a href="settingsUser.action"
											style="color: Gray;"><s:text name="add.user.menus.user" /></a></li>
										<li role="presentation" class="active"><a
											href="settingsDisclaimar.action" style="color: Gray;background-color: #F9F9F9;"><s:text
													name="add.user.menus.disclaimer" /></a></li>
										<li role="presentation"><a href="settingsEmail.action"
											style="color: Gray;"><s:text name="add.user.menus.email" /></a></li>
										<li role="presentation"><a href="settingsOther.action"
											style="color: Gray;"><s:text name="add.user.menus.others" /></a></li>
									</ul>
												...
												<div class="box "
														...
														<form class="form-horizontal">
															...
															<div class="row">
																<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
																	<div class="row form-group">
																		<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
																			<label class="control-label col-lg-4">Lead
																				Name</label>
																		</div>
																		<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
																			<input type="text" class="form-control">
																		...
																		<div class="col-lg-1 col-md-1 col-sm-2 col-xs-2 ">
																			<ul class="nav nav-tabs pull-right">
																				<li><a href="#addSocial" data-toggle="tooltip"
																					...
																					class="btn btn-metis-3 btn-line form-control">
													...
													<div class="row">
														...
														<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
															<div class="row form-group">
																<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
																	<label class="control-label col-lg-4">Date Of
																		Birth </label>
																</div>
																<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
													...
													<div class="row">
														<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
															<div class="row form-group">
																<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
																	<label class="control-label col-lg-4">Marital
																		Status</label>
																</div>
																<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
																	<select class="form-control">
													...
													<div class="row">
														<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
															<div class="row form-group">
																<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
																	<label class="control-label col-lg-4">Adress
																		Line 1</label>
																</div>
																<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
																	<input type="text" class="form-control">
													...
													<div class="row">
														...
														<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
															<div class="row form-group">
																<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
																	<label class="control-label col-lg-4">Add New
																		Social</label>
																</div>
																<div class="col-lg-7 col-md-7 col-sm-10 col-xs-10">
																	<input type="text" class="form-control">
														...
														<div class="row">
															<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
																<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
																	<div class="row">
																		<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
																			<label class="control-label col-lg-4">Profile
																				Picture</label>
																		</div>
																		<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
													...
													<div class="row">
														<div
															...
															<a href="#" class="btn btn-default">Cancel</a> <a
																href="#" class="btn btn-success">Clear</a> <a href="#"
