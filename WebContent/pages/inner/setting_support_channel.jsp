...
<body>
				...
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<ol class="breadcrumb" style="margin-top: 10px;">
							...
							<li class="active"><s:text
									name="setting.support.channel.navigation.bar"></s:text></li>

						</ol>
						<div class="box ">
							<s:form class="form-horizontal" action="insertChannelDetails"
								name="supportChannelForm">
								
								<header><div class="icons">
								...
								<div class="pull-right">
									<div class="btn-group">
										...
										<a href="settingSupportChannel.action" data-toggle="tooltip"
																...
																<s:else>
																	<div class="alert alert-info" role="alert"
																		...
																		<div class="infoIcon">
																			...
																			<s:text
																				name="setting.support.channel.information.bar" />
																		</div>
																	</div>
																</s:else>
															</p>
														...
														<div class="row">
															...
															<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
																<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
																	<s:text name="setting.support.channel.label"></s:text>
																	<div class="star">*</div>
																</div>
																<div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">

																	<s:textfield type="text" name="channel"
																		class="form-control" cssClass="form-control" />
																	<div id='supportChannelForm_channel_errorloc'
															...
															<thead>
																<tr id="myrow">
																	...
																	<th style="width: 20%;"><s:text
																			name="setting.support.channel.id"></s:text></th>
																	<th><s:text name="setting.support.channel.label"></s:text></th>
																</tr>
															</thead>
															<tbody>
																<s:iterator value="showSupportChannelList">
																	<tr>
																		<td align="center">
																			<div class="btn-group">
	...
	<script type="text/javascript">
		var frmvalidator = new Validator("supportChannelForm");
		frmvalidator.EnableOnPageErrorDisplay();
		frmvalidator.EnableMsgsTogether();
		frmvalidator.addValidation("channel", "req", "Please Enter Channel");
		frmvalidator.addValidation("channel", "maxlen=100",
				"Please Enter maxlen 100");
		frmvalidator.addValidation("channel", "minlen=3",
