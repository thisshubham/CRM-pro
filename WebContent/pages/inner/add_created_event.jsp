...
<body>
					...
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<ol class="breadcrumb" style="margin-top: 10px;">
							...
							<li class="active"><s:text
									name="add.created.event.new.event"></s:text></li>
						</ol>
						<s:form name="addCreatedEventForm" action="insertCreatedEvent"
							id="block-validate">
							<div class="box dark">
								<header>
								<div class="pull-left">
									...
									<h5>
										<s:text name="add.created.event.new.event" />
									</h5>
								</div>
								...
								<div class="container-fluid">
										...
										<s:else>
											...
											<div class="alert alert-info" role="alert"
												...
												<div class="infoIcon">
													...
													<s:text name="add.created.event.information.bar" />
												</div>
											</div>
										</s:else>
									</p>
										...
										<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
											<div class="row form-group">
												...
												<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
													...
													<div id='addCreatedEventForm_eventTitle_errorloc'
										...
										<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
											<div class="row form-group">
												...
												<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
													...
													<div id='addCreatedEventForm_eventDate_errorloc'
														class="error_strings"></div>
												</div>
											</div>
										</div>
										...
										<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
											<div class="row form-group">
												...
												<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
													...
													<div id='addCreatedEventForm_eventCategory_errorloc'
														class="error_strings"></div>
												</div>
											</div>
										</div>
										...
										<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
											<div class="row form-group">
												...
												<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
													...
													<div id='addCreatedEventForm_organizeName_errorloc'
														class="error_strings"></div>
												</div>
												...
												<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
													<div class="row">
														<div class="col-lg-3 col-md-3 col-sm-3 col-xs-3"
															...
															<div id='addCreatedEventForm_mobileNo_errorloc'
																class="error_strings"></div>
										...
										<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
											<div class="row form-group">
												...
												<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
													...
													<div id='addCreatedEventForm_mobileNumber_errorloc'
														class="error_strings"></div>
												</div>
											</div>
										</div>
											...
											<div class="row form-group">
												...
												<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
													<s:textfield type="text" name="email"
														cssClass="form-control" tabindex="11" />
													<div id='addCreatedEventForm_email_errorloc'
														class="error_strings"></div>
												</div>
											...
											<div class="row form-group">
												...
												<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
													<s:textfield type="text" name="urlNo"
														cssClass="form-control" tabindex="11" />
													<div id='addCreatedEventForm_urlNo_errorloc'
														class="error_strings"></div>
												</div>
											</div>
										</div>
											...
											<div class="row form-group">
												...
												<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
													<s:select cssClass="form-control chzn-select" name="eventStatus"
														...
														tabindex="6" />
													<div id='addCreatedEventForm_eventStatus_errorloc'
														class="error_strings"></div>
												</div>
											</div>
										</div>
											...
											<div class="row form-group">
												...
												<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
													<s:textfield type="text" name="publishDate"
														...
														tabindex="14" readonly="true" />
													<div id='addCreatedEventForm_publishDate_errorloc'
														class="error_strings"></div>
												</div>
										...
										<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
											<div class="row form-group">
												...
												<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
													...
													<div id='addCreatedEventForm_eventFile_errorloc'
														class="error_strings"></div>
												</div>
											</div>
										</div>
									...
									<div class="form-group">
										<div class="row" style="margin: 1% 2%;" id="data_grid">
											<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
												<div id='addCreatedEventForm_requirment_errorloc'
													class="error_strings"></div>
									...
									<div class="row">
										<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"
											...
											<a href="eventDashboard.action" data-toggle="tooltip"
												...
												href="addCreatedEvent.action" data-toggle="tooltip"
	...
	<script type="text/javascript">
		var frmvalidator = new Validator("addCreatedEventForm");
		...
		/* function DoCustomValidation() {
			var frm1 = document.forms["addCreatedEventForm"];
			//var date11 = new Date();
