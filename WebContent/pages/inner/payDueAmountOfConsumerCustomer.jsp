...
function getConsumerCustomerDetails() {
	...
	var consumerId=document.getElementById("custId").value;
	...
	xmlhttp.onreadystatechange = function() {
		if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
			...
			/* var	array_element2= "<input type='text'  Class='form-control'  name='itemPrice' id='itemPrice' value='"+array.product.productPrice +"' readonly='true' />"; */
              var	array_element1=" <input type='text' name= 'customerAddress'  value= '"+array.consumerCustomer.consuAddress +"'   Class ='form-control' />";
			...
			var	array_element2=	" <input type='text' name = 'customerContact'  value = '"+array.consumerCustomer.consuContact +"'  Class = 'form-control' />" ;
			var	array_element3=	" <input type='text' name = 'customerState' value = '"+array.consumerCustomer.consuState +"' Class = 'form-control' />" ;
	...
	xmlhttp.open("GET", "consumerCustomerDetailsForPayDueConsumer.action?custId=" +consumerId, true);
...
if (billNumber != null) {
	...
	xmlhttp.open("GET", "transactionDetailsForPayDueConsumer.action?billNo=" +billNumber, true);
				...
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<ol class="breadcrumb" style="margin-top: 10px;">
							...
							<li><a href="completeConsumerTransaction.action"><s:text
										name="Pay Due Consumer"></s:text></a></li>
							<li class="active"><s:text name="Pay Due Dashboard"></s:text></li>
							<%-- <li class="active"><s:text name="Pay Due Consumer"></s:text></li> --%>
						</ol>
						<s:form name="addContactForm" cssClass="form-horizontal"
							method="post" action="addPayDueConsumerTransaction">
							<div class="box dark">
								<header>
								<div class="pull-left">
									<a class="icons" href="completeConsumerTransaction.action"
										data-toggle="tooltip"
										data-original-title="Back To Pay Due DashBoard"
										style="color: black;"> <i class="fa fa-th-large"></i>
									</a>
									<h5>
										<s:text name="Add Pay Due Consumer" />
									</h5>
								</div>
 ...
 --%>
                                                    <s:select cssClass="form-control " list="salutationList"
														...
														<div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
															  <%-- <s:select cssClass="form-control " list="consumerList" id="custId" theme="css_xhtml" 
											                         headerKey="-1" headerValue="Select Customer"
																name="customerName" tabindex="1" onchange="getConsumerCustomerDetails()">
															</s:select>  --%>
