...
<title>dashboard_task_window_two</title>
<style type="text/css">
.error_strings {
	color: red;
}
...
<body>
			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				...
				<div class="panel panel-default">
					<div class="panel-body">
						...
						<form name="my_form" id="my_form" class="form-horizontal"
							action="" method="post">
							<div class="form-group">
								...
								<div class="col-sm-10">
									...
									<div id='my_form_subject_errorloc' class="error_strings"></div>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-10">
									...
									<div id='my_form_description_errorloc' class="error_strings"></div>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-10">
									<div class="input-group bootstrap-datepicker">
										<input type="text" class="form-control" id="dp2" name="date">
										<span class="input-group-addon add-on"><i
											class="fa fa-calendar"></i></span>
									</div>
									<div id='my_form_date_errorloc' class="error_strings"></div>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-10">
									...
									<div id='my_form_time_errorloc' class="error_strings"></div>
								</div>
							</div>
							<br /> <br />
	...
	<script language="JavaScript" type="text/javascript"
		...
		var frmvalidator = new Validator("my_form");
