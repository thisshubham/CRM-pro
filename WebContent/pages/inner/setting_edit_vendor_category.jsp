...
<body>
				...
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<ol class="breadcrumb" style="margin-top: 10px;">
							...
							<li><a href="settingMarketingVendorCategory.action"><s:text
							...
							<li class="active"><s:text
									name="setting.marketing.menus.edit.vendor.category"></s:text></li>

						</ol>
						<div class="box ">
							<s:form class="form-horizontal"
								action="settingUpdateVendorCategory"
								name="editvendorcategoryform">
								<header>
								<div class="icons">
																...
																<s:else>
																	<div class="alert alert-info" role="alert"
																		...
																		<div class="infoIcon">
																			...
																			<s:text
																				name="setting.marketing.edit.vendorcategory.infobar" />
																		</div>
																	</div>
																</s:else>
															</p>
														...
														<div class="row">
															...
															<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
																...
																<div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
																	...
																	<div
																		id='editvendorcategoryform_vendorcategory_errorloc'
	...
	<script type="text/javascript">
		var frmvalidator = new Validator("editvendorcategoryform");
