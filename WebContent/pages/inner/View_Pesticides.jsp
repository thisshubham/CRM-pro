...
<title>View Cement Purchase</title>
</head>
<body>
			...
			<div class="box">
				<div class="container-fluid">
					<ol class="breadcrumb" style="margin-top: 10px;">
						...
						<li> <a href="productDashboard.action"><s:text name="Purchase Cement"></s:text></li>
					...
					<h5>
						<s:text name="View Cement Purchase Details" />
					</h5>
					<div class="pull-right">
						<div class="btn-group">
								...
								href="purchasePesticidesPrintPDF.action?command=<s:property value='purchaseId' />"
								...
								href="viewPreviousPurchasePesticideInfo.action?command=<s:property value='purchaseId' />"
								...
								href="viewNextPurchasePesticideInfo.action?command=<s:property value='purchaseId' />"
					...
					<div id="div-2" class="body">
									...
									<div class="alert alert-info" role="alert">
										<div class="infoIcon">
											<i class="fa fa-info-circle "> <s:text
													name=" You can view cement purchase from here" /></i>
										</div>
									</div>
								</s:else>
							</p>
						...
						<div style="padding-left: 15px; padding-right: 15px;">
							<form class="form-horizontal">
								<%-- <s:iterator value="purchaseCementVO" var="testObje"> --%>
									<div class="row">
										<div
											class="col-lg-12 col-md-12 col-sm-12 col-xs-12 viewinnertitle">
											<h5>
												<s:text name="Cement Purchase Information" />
											</h5>
										</div>
									</div>
								...
								<div class="row">
									...
									<div class="row">
										...
										<div class="col-md-12  col-sm-12 col-xs-12"
											...
											<div class="col-md-2 col-sm-12 col-xs-12">
												<label for="text1" class="control-label" id="viewlable"><s:text
														name="Quantity(no of Bags)" /></label>
											</div>
											<div class="col-md-10 col-sm-12 col-xs-12 control-label">
						...
						<div class="row">
									...
									<div class="row">
										...
										<div class="col-md-12 col-sm-12 col-xs-12"
											...
											<div class="col-md-2 col-sm-12 col-xs-12">
												<label for="text1" class="control-label" id="viewlable"><s:text
														name="Mode of Transport" /> &nbsp; ;(&nbsp<span
									...
									<div class="row">
										<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"
											align="center">
											<a href="purchaseDashbord" data-toggle="tooltip"
