...
<body>
					...
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<div class="box inverse">
							...
							<div class="container"
								...
								<s:form name="groupsContactInfoForm"
									action="updateGroupsContactInfo" method="POST">
									...
									<ul class="nav nav-tabs" role="tablist">
										...
										<li role="presentation"><a
											...
											style="color: Gray;"><s:text name="Social Information" /></a></li>
									</ul>
									<!-- Tab panes -->
																	...
																	<div class="row">
																		<div class="col-lg-3 col-md-3 col-sm-3 col-xs-5">
																			<s:select cssClass="form-control "
																				list="salutationList" name="salutation" tabindex="1">

																			</s:select>

																			<div id='groupsContactInfoForm_salutation_errorloc'
																		...
																		<div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
																			...
																			<div
																				id='groupsContactInfoForm_contactperson_errorloc'
																				class="error_strings"></div>
																		</div>
																	</div>
															...
															<div class="row form-group">
																...
																<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
																	<s:select cssClass="form-control chzn-select"
																		...
																		headerValue="Select Group" name="groupName"
																		tabindex="3">

																	</s:select>

																	<div id='groupsContactInfoForm_groupName_errorloc'
																		class="error_strings"></div>
													...
													<div class="row">
														<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
															<div class="row form-group">
																...
																<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
																	...
																	<div id='groupsContactInfoForm_nickName_errorloc'
																		class="error_strings"></div>
																</div>
															</div>
														</div>
														<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
															<div class="row form-group">
																...
																<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
																	<s:select cssClass="form-control chzn-select"
																		list="designationList" headerKey="1"
																		name="designation" tabindex="5">

																	</s:select>
																	<div id='groupsContactInfoForm_designation_errorloc'
																		class="error_strings"></div>
																</div>
															</div>
														</div>
														...
														<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
															<div class="row form-group">
																...
																<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
																	...
																	<div id='groupsContactInfoForm_phoneNumber_errorloc'
																		class="error_strings"></div>
																</div>
															</div>
														</div>
														<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
															<div class="row form-group">
																...
																<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
																	...
																	<div id='groupsContactInfoForm_referredBy_errorloc'
																		class="error_strings"></div>
																</div>
															</div>
														</div>
													...
													<div class="row">
														<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
															<div class="row form-group">
																...
																<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
																	...
																	<div id='groupsContactInfoForm_mobileNo_errorloc'
																		class="error_strings"></div>
																</div>
															</div>
														</div>
														...
														<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
															<div class="row form-group">
																...
																<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
																	<s:textfield cssClass="form-control"
																		name="mobileNumber" tabindex="9"></s:textfield>
																	<div id='groupsContactInfoForm_mobileNumber_errorloc'
																		class="error_strings"></div>
																</div>
															</div>
														</div>
														...
														<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
															<div class="row form-group">
																...
																<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
																	...
																	<div id='groupsContactInfoForm_emailId_errorloc'
																		class="error_strings"></div>
																</div>
															</div>
														</div>
														<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
															<div class="row form-group">
																...
																<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
																	...
																	<div id='groupsContactInfoForm_fax_errorloc'
																		class="error_strings"></div>
																</div>
															</div>
														</div>
														...
														<div class="row">
															<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
																<div class="row form-group">
																	...
																	<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
																		<s:textfield cssClass="form-control"
																			name="createdByName" disabled="true"></s:textfield>
																	</div>
																</div>
															</div>
															...
															<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
																<div class="row form-group">
																	<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
																		<label class="control-label col-lg-4"> <s:text
																				name="update.lead.info.creation.date"></s:text>
																		</label>
																	</div>
																	<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
																		<s:textfield cssClass="form-control"
																			name="creationDate" disabled="true"></s:textfield>
																	</div>
																</div>
															</div>
														</div>
														...
														<div class="row">
															<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
																<div class="row form-group">
																	...
																	<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
																		<s:textfield cssClass="form-control"
																			name="addressLine1" tabindex="12"></s:textfield>
																		<div id='groupsContactInfoForm_addressLine1_errorloc'
																			class="error_strings"></div>
															...
															<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
																<div class="row form-group">
																	...
																	<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
																		<s:textfield cssClass="form-control"
																			name="addressLine2" tabindex="13"></s:textfield>
																		<div id='groupsContactInfoForm_addressLine2_errorloc'
																			class="error_strings"></div>
																	</div>
																</div>
															</div>
															...
															<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
																<div class="row form-group">
																	...
																	<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
																		...
																		<div id='groupsContactInfoForm_city_errorloc'
																			class="error_strings"></div>
																	</div>
																</div>
															</div>
															<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
																<div class="row form-group">
																	...
																	<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
																		...
																		<div id='groupsContactInfoForm_state_errorloc'
																			class="error_strings"></div>
																	</div>
																</div>
															</div>
														...
														<div class="row">
															<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
																<div class="row form-group">
																	...
																	<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
																		<s:select cssClass="form-control chzn-select"
																			list="countryList" name="countryName" headerKey="1"
																			tabindex="16">


																		</s:select>
																		<div id='groupsContactInfoForm_country_errorloc'
																			class="error_strings"></div>
																	</div>
																</div>
															</div>
															<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
																...
																<div class="row form-group">
																	...
																	<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
																		...
																		<div id='groupsContactInfoForm_zipcode_errorloc'
																			class="error_strings"></div>
																	</div>
																</div>
															</div>
															...
															<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
																<div class="row form-group">
																	...
																	<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
																		...
																		<div id='groupsContactInfoForm_phone_errorloc'
																			class="error_strings"></div>
																	</div>
																</div>
															</div>
															<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
																<div class="row form-group">
																	...
																	<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
																		...
																		<div
																			id='groupsContactInfoForm_homeContactMobile_errorloc'
																			class="error_strings"></div>
																	</div>
																</div>
															</div>
														...
														<div class="row">
															<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
																<div class="row form-group">
																	...
																	<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
																		...
																		<div
																			id='groupsContactInfoForm_homeContactEmailID_errorloc'
																			class="error_strings"></div>
																	</div>
																</div>
															</div>
															<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
																<div class="row form-group">
																	...
																	<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
																		<s:textfield cssClass="form-control"
																			name="homeContactFax" tabindex="21"></s:textfield>
																		<div
																			id='groupsContactInfoForm_homeContactFax_errorloc'
																			class="error_strings"></div>
																	</div>
																</div>
															</div>
															...
															<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
																<div class="row form-group">
																	...
																	<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
																		...
																		<div
																			id='groupsContactInfoForm_workContactAddressOne_errorloc'
																			class="error_strings"></div>
																	</div>
																</div>
															</div>
															<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
																<div class="row form-group">
																	...
																	<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
																		...
																		<div
																			id='groupsContactInfoForm_workContactAddressTwo_errorloc'
																			class="error_strings"></div>
																	</div>
																</div>
															</div>
															...
															<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
																<div class="row form-group">
																	...
																	<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
																		...
																		<div
																			id='groupsContactInfoForm_workContactCity_errorloc'
																			class="error_strings"></div>
																	</div>
															...
															<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
																<div class="row form-group">
																	...
																	<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
																		...
																		<div
																			id='groupsContactInfoForm_workContactState_errorloc'
																			class="error_strings"></div>
																	</div>
														...
														<div class="row">
															<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
																<div class="row form-group">
																	...
																	<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
																		<s:select name="workContactCountryName"
																			cssClass="form-control chzn-select"
																			list="countryList" headerKey="1" tabindex="26">
																		</s:select>
																		<div
																			id='groupsContactInfoForm_workContactCountryName_errorloc'
																			class="error_strings"></div>
																	</div>
															...
															<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
																<div class="row form-group">
																	...
																	<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
																		...
																		<div
																			id='groupsContactInfoForm_workContactZipCode_errorloc'
																			class="error_strings"></div>
																	</div>
															...
															<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
																<div class="row form-group">
																	...
																	<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
																		...
																		<div
																			id='groupsContactInfoForm_workContactPhone_errorloc'
																			class="error_strings"></div>
																	</div>
															...
															<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
																<div class="row form-group">
																	...
																	<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
																		...
																		<div
																			id='groupsContactInfoForm_workContactMobile_errorloc'
																			class="error_strings"></div>
																	</div>
														...
														<div class="row">
															<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
																<div class="row form-group">
																	...
																	<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
																		...
																		<div
																			id='groupsContactInfoForm_workContactEmailId_errorloc'
																			class="error_strings"></div>
																	</div>
															...
															<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
																<div class="row form-group">
																	...
																	<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
																		<s:textfield cssClass="form-control"
																			name="workContactFax" tabindex="31"></s:textfield>
																		<div
																			id='groupsContactInfoForm_workContactFax_errorloc'
																			class="error_strings"></div>
																	</div>
														...
														<div class="form-group">
															<div class="row" style="margin: 1% 2%;" id="data_grid">
																<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
																	...
																	<div
																		id='groupsContactInfoForm_profileDescription_errorloc'
																		class="error_strings"></div>
																				...
																				<div class="fileinput fileinput-new"
																					...
																					<div>
																						<span class="btn btn-default btn-file"
																							tabindex="33"><span class="fileinput-new"><s:text
	...
	<script type="text/javascript">
		var frmvalidator = new Validator("groupsContactInfoForm");
