...
<script type="text/javascript">
	...
	function isLeadTitleExist(leadTitle) {
		xmlhttp.onreadystatechange = function() {
			if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
				document.getElementById("server1Response").innerHTML = xmlhttp.responseText;
			}
		};
		xmlhttp.open("GET", "isLeadTitleExists.action?leadTitle=" + leadTitle,
				true);
		xmlhttp.send();
	}
</script>
...
<body>
				...
				<div class="box">
					...
					<div class="pull-left">
						<a class="icons" type="button" onclick="window.close();" href=""
							...
							data-original-title="Back To New Lead"> <i
							class="fa fa-th-large"></i>
						</a>

						<h5>
							<s:text name="lead.title.model.lead.title" />
						</h5>
					</div>
					...
					<div class="row">
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
							...
							<div class="row">
								<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
									<s:form name="leadTitleForm" action="addLeadTitle"
										class="form-horizontal" id="block-validate">
										<div class="row">
											<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
												<div class="col-lg-8 col-md-8 col-sm-8 col-xs-5 ">
													<s:textfield name="leadTitle" id="leadTitle"
														placeholder="Enter Lead Title" cssClass="form-control"
														onblur="isLeadTitleExist(leadTitle.value);" />
													<div id='leadTitleForm_leadTitle_errorloc'
									...
									<div
										...
										<table class="table table-bordered responsive-table"
											...
											<thead style="background-color: gray; color: white;">
												<tr>
													<th><s:text name="lead.title.model.lead.title" /></th>
												</tr>
											</thead>
											<tbody>
												<s:iterator value="leadTitleGrid">
													<tr>
	...
	<script type="text/javascript">
		var frmvalidator = new Validator("leadTitleForm");
		frmvalidator.EnableOnPageErrorDisplay();
		frmvalidator.EnableMsgsTogether();

		//Validation for lead title.
		frmvalidator.addValidation("leadTitle", "req", "Enter Lead Title");
		frmvalidator.addValidation("leadTitle", "maxlen=50",
				"Maximun Length Of Lead Title Should Be 50 Characters");
	</script>
</body>
</html>