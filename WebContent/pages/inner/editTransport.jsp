				...
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<ol class="breadcrumb" style="margin-top: 10px;">
							...
							<li><a href=""><s:text
										name="Edit Transport"></s:text></a></li>
						</ol>
						
						
						<s:form name="addCreatedTransportForm" action="updateTransportDetail"
							id="block-validate">
							<div class="box dark">
								<header>
								<div class="pull-left">
								...
								<div class="pull-right">
									<div class="btn-group">
										...
										<a href="transportDashboardAction" data-toggle="tooltip"
											...
											class="fa fa-refresh "></i></a> <a href="transportDashboardAction"
										...
										<s:else>
											...
											<div class="alert alert-info" role="alert"
												...
												<div class="infoIcon">
													...
													<s:text name="you can update transport here" />
												</div>
											</div>
										</s:else>
									</p>
												...
												<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
													<div class="row">
														...
														<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
															...
															<div id='addCreatedTransportForm_transportAddress_errorloc'
												...
												<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
													<div class="row">
														...
														<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
															...
															<div id='addCreatedTransportForm_contactPerson_errorloc'
																class="error_strings"></div>
														</div>
													</div>
												</div>
												...
												<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
													<div class="row">
														...
														<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
															...
															<div id='addCreatedTransportForm_transporter_errorloc'
																class="error_strings"></div>
														</div>
													</div>
												</div>
										...
										<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
											<div class="row form-group">
												...
												<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
													...
													<div id='addCreatedTransportForm_transportAddress2_errorloc'class="error_strings"></diV>
												</div>
											</div>
										</div>
											...
											<div class="row form-group">
												...
												<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
													<div class="row">
														...
														<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
															<s:textfield type="text" name="creationDate"
										...
										<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
											<div class="row form-group">
												...
												<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
													...
													<div id='addCreatedTransportForm_creationDate_errorloc'class="error_strings"></diV>
												</div>
											</div>
										</div>
												...
												<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
													<div class="row">
														...
														<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
															...
															<div id='addCreatedTransportForm_contactNumber_errorloc'
																class="error_strings"></div>
														</div>
													</div>
												</div>
