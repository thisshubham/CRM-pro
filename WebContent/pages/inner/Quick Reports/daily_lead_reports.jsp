				...
				<div class="row">
					<div class="col-lg-12">
						<ol class="breadcrumb" style="margin-top: 10px;">
							...
							<li class="active"><a href="leadReports.action"><s:text name="Lead Reports"></s:text></a></li>
							<li class="active"><s:text
									name="Daily Lead Reports"></s:text></li>
						</ol>
						<div class="box">
							<header>
								<div class="pull-left">
									<a class="icons" href="leadReports.action" data-toggle="tooltip"
										data-original-title="Back To Lead Report"> <i
										class="fa fa-table"></i>
									</a>
								...
								<div class="pull-right">
									<div class="btn-group">
										...
										<a class="btn btn-success btnheight" data-toggle="tooltip"
											...
											class="fa fa-file-excel-o fontawesomeht"></i></a> <a href="dailyLeadReportsSetting.action"
											...
											href="leadReports.action" data-toggle="tooltip"
									...
									<table id="dataTable"
										...
										<thead>
											<tr id="myrow">
												...
												<%-- <th><s:text name="lead.dashboard.leadSourceName"></s:text></th>
												<th><s:text name="lead.dashboard.noOfAssociates"></s:text></th>
												<th><s:text name="lead.dashboard.add1"></s:text></th>
												<th><s:text name="lead.dashboard.city"></s:text></th>
												<th><s:text name="lead.dashboard.state"></s:text></th>
												<th><s:text name="lead.dashboard.emailID"></s:text></th>
												<th><s:text name="lead.dashboard.requirement"></s:text></th>
												<th><s:text name="lead.dashboard.website"></s:text></th>
												<th><s:text name="lead.dashboard.rating"></s:text></th>--%>
