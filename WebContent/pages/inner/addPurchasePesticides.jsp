...
function getDealerDetails() {
		...
		xmlhttp.open("GET", "dealerDetailsForCementPurchase.action?dealerId=" +dealerId, true);
			...
			<div class="inner bg-light lter">
				...
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						...
						<s:form name="addCreatedProductForm" action="insertPurchasePesticides"
							id="block-validate">
							<div class="box dark">
								<header>
								<div class="pull-left">
										...
										<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
											<div class="row form-group">
												<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
													<s:text name="add.new.purchase.purchase.invoice" />
													<div class="star">*</div>
												</div>
							...
							<s:select list="dealerList" name="dealerName" id="dealerId"
															theme="css_xhtml" headerKey="0" headerValue="Select Company Name"
											style="width:357px; height:35px;margin-left:-1%"
													...
													<div class="row">
														...
														<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="contact">
															<s:textfield type="text" name="dealerContact"
																cssClass="form-control" tabindex="2" />
															<div id='addCreatedProductForm_contact_errorloc'
																class="error_strings"></div>
														</div>
													</div>
												</div>
...
cssClass="form-control" tabindex="2" />
<div id='addCreatedProductForm_placeOfBusiness_errorloc'
class="error_strings"></div>
</div>
</div>
</div>
							...
							<%-- <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
											<div class="row form-group">
												<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
													<s:text name="add.new.purchase.sales.end.incoterm" />
												</div>
												<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
													<div class="row">

														<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
															<s:textfield type="text" name="inconterm"
																cssClass="form-control" tabindex="2" />
															<div id='addCreatedProductForm_inconterm_errorloc'
																class="error_strings"></div>
														</div>
											...
											<div class="row form-group">
												...
												<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
													<div class="input-group">
														<s:textfield  name="unitPrice" value='0'
