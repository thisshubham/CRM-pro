					...
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						...
						<div class="box ">
							...
							<div class="icons">
								...
								<a style="color: black" href="settingDashboardPage.action"
							...
							<div class="container-fluid">
								...
								<div class="col-lg-12  col-md-12 col-sm-12 col-xs-12"
									...
									<a class="quick-icons" href="renderCompanySettings.action"
										...
										data-original-title=""> <i class="fa fa-files-o fa-2x"></i>
										<span><s:text name="add.user.menus.company"></s:text></span></a> <a
										class="quick-icons" href="settingsUser.action"
										data-toggle="tooltip" data-placement="right"
										data-original-title=""> <i class="fa fa fa-user fa-2x"></i>
										<span><s:text name="add.user.menus.user"></s:text></span>
										...
										<i class="fa fa fa-comment fa-2x"></i><span><s:text
												name="setting.support.navigation.bar"></s:text></span>
									</a>
						...
						<div class="container-fluid">
							<div class="col-lg-12  col-md-12  col-sm-12 col-xs-12"
								...
								<ul class="nav nav-tabs" role="tablist">
									...
									<li role="presentation"><a
										href="settingCompanySector.action" style="color: Gray;"><s:text
												name="add.user.menus.company.sector" /></a></li>
									<li role="presentation"><a
										href="settingCompanyCountry.action" style="color: Grey;"><s:text
												...
												<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
													...
													<s:form class="form-horizontal"
														...
														<div class="row" style="margin-top: 20px;">
															<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
																<h5 class="innertitle">Company Information</h5>
														...
														<div class="row">
															...
															<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
																<div class="row form-group">
																	...
																	<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
																		<s:textfield cssClass="form-control" name="tradeNname"></s:textfield>
														...
														<div class="row">
															...
															<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
																<div class="row form-group">
																	...
																	<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
																		<s:textfield cssClass="form-control" name="userStatus"
														...
														<div class="row" style="margin-top: 20px;">
															<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
																<h5 class="innertitle">Contact Information</h5>
																<hr style="margin-top: -5px">
															</div>
														...
														<div class="row">
															...
															<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
																<div class="row form-group">
																	...
																	<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
																		<s:textfield cssClass="form-control" name="companyUrl"></s:textfield>
																	</div>
																</div>
															</div>
														</div>
														...
														<div class="row" style="margin-top: 20px;">
															<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
																<h5 class="innertitle">Social Information</h5>
																<hr style="margin-top: -5px">
															</div>
														</div>
														...
														<div class="row">
															<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
																<div class="row form-group">
																	<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
																		<label class="control-label col-lg-4">Blog URL</label>
																	</div>
																	<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
																		<s:textfield cssClass="form-control" name="blogDetail"></s:textfield>
																	</div>
																</div>
															</div>
															<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
														...
														<div class="row" style="margin-top: 20px;">
															<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
																<h5 class="innertitle">Profile Image</h5>
																<hr style="margin-top: -5px">
															</div>
														</div>
													...
													<div
														...
														<a href="" data-toggle="tooltip"
															...
															class="btn btn-default" ontheme="simple" tabindex="42"><i></i><s:text
																name="project.form.button.cancel" /> </a> 
																<a href="" data-toggle="tooltip"
															data-original-title="Reset"
															class="btn btn-default" ontheme="simple" tabindex="43"><i></i><s:text
																name="project.form.button.reset" /> </a>
														...
														<div class="row">
															<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"
																...
																<a href="omiInnerDashboard.action" data-toggle="tooltip"
																	...
																	class="btn btn-success btnheight" tabindex="43"><i
