...
<body>
					...
					<div class="col-lg-12">
						<div class="box">
							<header>
								...
								<h5>
									<s:text name="Search By Lead Owner" />
								</h5>
											...
											<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"
												...
												<div class="row" style="margin-right: 27px;">
													<div class="col-lg-1 col-md-1 col-sm-12 col-xs-12">
														<h5>
															<label> <s:text name="Lead Owner By:" />
															</label>
															<div class="star">*</div>
														</h5>
													</div>
													<s:form name="LeadByOwnerReportForm">
														<div class="col-lg-9  col-md-9 col-sm-12 col-xs-12">
															<div class="row">
																<div class="col-lg-3 col-md-3 col-sm-9 col-xs-7">
																	<s:select list="customerNameList" headerKey="-1"
																		headerValue="Select Owner Name" name="ownerName"
																		cssClass="form-control"></s:select>
																		<div id='LeadByOwnerReportForm_ownerName_errorloc'
																...
																<div class="col-lg-2 col-md-2 col-sm-3 col-xs-4">
																	<s:textfield name="leadStartDate"
																		placeholder="Select Start Date" id="dp3"
																		cssClass="form-control"></s:textfield>
																	<div id='LeadByOwnerReportForm_leadStartDate_errorloc'
																		class="error_strings"></div>
																</div>
																<div class="col-lg-1 col-md-2 col-sm-3 col-xs-4">
																	<h5>
																...
																<div class="col-lg-2 col-md-2 col-sm-3 col-xs-4">
																	...
																	<s:textfield name="leadEndDate"
																		placeholder="Select End Date" id="dp4"
																		cssClass="form-control"></s:textfield>
																	<div id='LeadByOwnerReportForm_leadEndDate_errorloc'
																		class="error_strings"></div>
	...
	<script type="text/javascript">
		var frmvalidator = new Validator("LeadByOwnerReportForm");
		frmvalidator.EnableOnPageErrorDisplay();
		frmvalidator.EnableMsgsTogether();

		
		frmvalidator.addValidation("ownerName", "dontselect=-1",
				"Select Lead Owner Name");
		...
		function DoCustomValidation() {
			var frm1 = document.forms["LeadByOwnerReportForm"];
			var ndate = frm1.leadSatrtDate.value;
