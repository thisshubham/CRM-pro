...
<body>
					...
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<ol class="breadcrumb" style="margin-top: 10px;">
							...
							<li class="active"><s:text
									name="add.user.menus.company.category"></s:text></li>

						</ol>
						<div class="box ">
							<s:form class="form-horizontal" action="insertCompanyCategory"
								name="settingCompanyCategoryForm">
								<header>
								<div class="icons">
									...
									<div class="col-lg-12  col-md-12  col-sm-12 col-xs-12"
										...
										<ul class="nav nav-tabs" role="tablist">
											...
											<li role="presentation" class="active"><a
												href="settingCompanyCategory.action"
																...
																<s:else>
																	<div class="alert alert-info" role="alert"
																		...
																		<div class="infoIcon">
																			...
																			<s:text name="add.setting.company.category.infobar" />
																		</div>
																	</div>
																</s:else>
															</p>
														...
														<div class="row">
															...
															<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
																<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
																	<s:text name="add.setting.company.category.label"></s:text>
																	<div class="star">*</div>
																</div>
																<div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">

																	<s:textfield type="text" name="category"
																		class="form-control" cssClass="form-control"
																		placeholder="Enter Company Category" />
																	<div id='settingCompanyCategoryForm_category_errorloc'
															...
															<thead>
																<tr id="myrow">
																	...
																	<th style="width: 20%;"><s:text
																			name="setting.company.category.id"></s:text></th>
																	<th><s:text name="Category"></s:text></th>
																</tr>
															</thead>
															<tbody>
																<s:iterator value="showCompanyCategoryList">
																	<tr>
																		<td align="center">

																			<div class="btn-group">
																				<a id="edit"
																					href="settingEditCategory.action?command=<s:property value='companyCategoryID'/>"
	...
	<script type="text/javascript">
		var frmvalidator = new Validator("settingCompanyCategoryForm");
		frmvalidator.EnableOnPageErrorDisplay();
		frmvalidator.EnableMsgsTogether();
		frmvalidator.addValidation("category", "req",
				"Please Enter company Category");
		frmvalidator.addValidation("category", "maxlen=100",
				"Please Enter maxlen 100");
		frmvalidator.addValidation("category", "minlen=3",
