...
<body>
				...
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<ol class="breadcrumb" style="margin-top: 10px;">
							...
							<li><a href="settingCompanyType.action"><s:text
										name="add.user.menus.company"></s:text></a></li>
							<li class="active"><s:text
									name="add.user.menus.company.type"></s:text></li>
							<li class="active"><s:text
									name="setting.company.menu.edit.company.type"></s:text></li>


						</ol>
						<div class="box ">
							<s:form class="form-horizontal" action="settingUpdateCompanyType"
								name="settingCompanyTypeForm">
								<header>
								<div class="icons">
									...
									<div class="col-lg-12  col-md-12  col-sm-12 col-xs-12"
										...
										<ul class="nav nav-tabs" role="tablist">
											...
											<li role="presentation" class="active"><a
												href="settingCompanyType.action"
																...
																<s:else>
																	<div class="alert alert-info" role="alert"
																		...
																		<div class="infoIcon">
																			...
																			<s:text
																				name="setting.company.edit.company.type.infobar" />
																		</div>
																	</div>
																</s:else>
															</p>
													...
													<div class="row">
														...
														<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
															<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
																<s:text name="add.setting.company.type.label"></s:text>
																<div class="star">*</div>
															</div>
															<div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">

																<s:textfield type="text" name="companyType"
																	class="form-control" cssClass="form-control"
																	placeholder="Company Type" />
																<div id='settingCompanyTypeForm_companyType_errorloc'
	...
	<script type="text/javascript">
		var frmvalidator = new Validator("settingCompanyTypeForm");
		frmvalidator.EnableOnPageErrorDisplay();
		frmvalidator.EnableMsgsTogether();
		frmvalidator.addValidation("companyType", "req",
				"Please Enter company Type");
		frmvalidator.addValidation("companyType", "maxlen=100",
				"Please Enter maxlen 100");
		frmvalidator.addValidation("companyType", "minlen=3",
