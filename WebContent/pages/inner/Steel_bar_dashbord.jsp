...
<script type="text/javascript">
	 function showElements() {
		...
		var selectedIndex = document.getElementById('advancePurchaseSteelbarSearch');
					...
					<div class="col-lg-12">
						<ol class="breadcrumb" style="margin-top: 10px;">
							...
							<li class="active"><s:text
									name="Purchase Steel Bars"></s:text></li>
						</ol>
						<div class="box">
							<header>
								<div class="pull-left">
									...
									<h5 class="header_color">
										<s:text name="Steel Bars Dashboard"></s:text>
									</h5>
								</div>
								<div class="pull-right">
									<div class="btn-group">
										<a href="addNewSteelbar" data-toggle="tooltip"
										...
										<a class="btn btn-success btnheight" data-toggle="tooltip"
											data-original-title="Refresh" href="steelBarDashbord.action"><i
											class="fa fa-refresh "></i></a> <a
											href="purchaseSteelbarExcelReport.action" type="button"
										...
										<s:else>
											...
											<div class="alert alert-info" role="alert">
												<div class="infoIcon">
													...
													<s:text name="you can manage purchase steel from here " />
												</div>
											</div>
										</s:else>
									</p>
							...
							<div id="collapse1" class="panel-collapse collapse">
										<div class="row searchBar">
											 <s:form name="purchaseAdvanceSearchForm" method="POST"
												action="populatePurchaseSteelbarDetailsAsPerSearch">
												<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"
													...
													<div class="col-lg-4  col-md-4  col-sm-12 col-xs-12">
														<s:select list="purchaseSteelbarSearchList" headerKey="-1"
															onchange="showElements();" id="advancePurchaseSteelbarSearch"
									...
									<table id="dataTable"
										...
										<thead>
											<tr id="myrow">
												...
												<th><s:text name="Quantity (Ton)"></s:text></th>
												<th><s:text name="Quantity (Kg)"></s:text></th>
										...
										<tbody>
											<s:iterator value="steelBarPurchaseList">
												<tr>
													<td align="center">
														<div class="btn-group">
															<a id="view"
																href="viewSteelbarPurchaseDetails.action?command=<s:property value='purchaseId' />"
														...
														<div class="btn-group">
															<a id="edit"
																href="editPurchaseSteelbarDetail.action?command=<s:property value='purchaseId' />"
														...
														<div class="btn-group">
															<a id="delete" href="#"
																onclick="confirmDelete('deleteSpecificSteelbarPurchase.action?command='+<s:property value='purchaseId'/>)"
													...
													<td><s:property value="quantityInKg"/></td>
