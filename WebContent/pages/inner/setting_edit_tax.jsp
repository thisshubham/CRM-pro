				...
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<ol class="breadcrumb" style="margin-top: 10px;">
							...
							<li><a href="settingFinanceTaxes.action"><s:text
										name="setting.finance.navigation.bar"></s:text></a></li>
							<li class="active"><s:text
									name="setting.finance.taxes.navigation.bar"></s:text></li>
							<li class="active"><s:text
									name="setting.finance.menu.edit.tax"></s:text></li>

						</ol>
						<div class="box ">
							<s:form class="form-horizontal" name="settingFinanceTaxForm"
								action="settingUpdateTax">
								<header>
								<div class="icons">
									...
									<div class="col-lg-12  col-md-12  col-sm-12 col-xs-12"
										...
										<ul class="nav nav-tabs" role="tablist">
											<li role="presentation" class="active"><a
												href="settingFinanceTaxes.action"
																...
																<s:else>
																	<div class="alert alert-info" role="alert"
																		...
																		<div class="infoIcon">
																			...
																			<s:text name="setting.finance.edit.tax.info.bar" />
																		</div>
																	</div>
																</s:else>
															</p>
															...
															<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
																<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12"
																	...
																	<div class="form-group">
																		<h5 class="innertitle">
																			<s:label class="innerc">Tax Components</s:label>
																		</h5>
																	</div>
