								...
								<div class="table-responsive">
										...
										<div class="row">
											<div class="col-lg-8  col-md-8  col-sm-12 col-xs-12">
												<div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
													<label style="margin-left: 14px;"><h5>Custom
															Search :</h5></label>
													...
													<div class="form-group">
														<div class="row">
															<div class="col-lg-12">
																...
																<div class="col-lg-4 col-xs-3" style="padding-top: 3px">
																	<div class="btn-group">
											...
											<div class="col-lg-4  col-md-4  col-sm-12 col-xs-12">
												<div class="col-lg-6  col-md-6  col-sm-12 col-xs-12">
													<div class="form-group" style="margin-left: 14px;">
														<a href="addCreatedAssignment.action" data-toggle="tooltip"
															data-original-title="Add" data-placement="bottom"
															class="btn btn-primary "> <i class="fa fa-plus ">&nbsp;Add
																Assignment</i>
												...
												<div class="col-lg-6  col-md-6  col-sm-12 col-xs-12">
													<div class="form-group" style="margin-left: 14px;">
														...
														</a> <a href="loginl.htm" data-toggle="tooltip"
									...
									<table id="dataTable"
										...
										<tbody>
											...
											<tr>
												<td><a href="viewFollowUpAssignment.action" id="row_a_link">12546358958</a></td>
												...
												<td><div class="btn-group">
													...
													<div class="btn-group">
														<a href="updateFollowUpAssignment.action" data-toggle="tooltip"
