...
<body>
				...
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<ol class="breadcrumb" style="margin-top: 10px;">
							...
							<li><a href="settingProductUsesUnit.action"><s:text
									name="setting.product.navigation.bar"></s:text></a></li>
							<li class="active"><s:text
									name="setting.product.uses.unit.navigation.bar"></s:text></li>
							
							<li class="active"><s:text
									name="setting.product.edit.menus.uses.unit"></s:text></li>


						</ol>
						<div class="box ">
							<s:form class="form-horizontal"
								action="settingUpdateProductUsesUnit"
								name="editproductUsesUnitForm">
								<header>
								<div class="icons">
																...
																<s:else>
																	<div class="alert alert-info" role="alert"
																		...
																		<div class="infoIcon">
																			...
																			<s:text name="setting.product.edit.product.uses.unit" />
																		</div>
																	</div>
																</s:else>
															</p>
														...
														<div class="row">
															...
															<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
																...
																<div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
																	...
																	<div
																		id='editproductUsesUnitForm_productUsesUnit_errorloc'
 ...
 --%>
	...
	<script type="text/javascript">
		var frmvalidator = new Validator("editproductUsesUnitForm");
		frmvalidator.EnableOnPageErrorDisplay();
		frmvalidator.EnableMsgsTogether();
		frmvalidator.addValidation("productUsesUnit", "req",
				"Please Enter Product Uses Unit");
