...
<body>
				...
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<ol class="breadcrumb" style="margin-top: 10px;">
							...
							<li class="active"><s:text
									name="setting.marketing.leadsource.navigation.bar"></s:text></li>

						</ol>
						<div class="box ">
						<s:form class="form-horizontal" action="insertAccountTypeDetails" name="accountTypeForm">
							<header>
							<div class="icons">
							...
							<div class="pull-right">
								<div class="btn-group">
									...
									<button type="button" data-toggle="tooltip"
										...
										</button><a href="omiInnerDashboard.action"
								...
								<div class="col-lg-12  col-md-12  col-sm-12 col-xs-12"
									...
									<ul class="nav nav-tabs" role="tablist">
										...
										<li role="presentation" class="active"><a
											href="settingMarketingAccountType.action"
																...
																<s:else>
																	<div class="alert alert-info" role="alert"
																		...
																		<div class="infoIcon">
																			...
																			<s:text name="setting.marketing.accounttype.information.bar" />
																		</div>
																	</div>
																</s:else>
															</p>
														...
														<div class="row">
															...
															<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
																<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
																	<s:text name="setting.marketing.accounttype.label"></s:text>
																	<div class="star">*</div>
																</div>
																<div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
																	...
																	<s:textfield type="text"
																		...
																		<div
																	id='accountTypeForm_accountType_errorloc'
															...
															<thead>
																<tr id="myrow">
																	...
																	<th style="width: 20%;"><s:text
																			name="setting.marketing.accounttype.id"></s:text></th>
																	<th><s:text
																			name="setting.marketing.accounttype.label"></s:text></th>
																</tr>
															</thead>
															<tbody>
																<s:iterator value="showMarketingAccountTypeList">
																	<tr>
																		<td align="center">
																			
																			</div>
																			<div class="btn-group">
																				<a id="edit" href="settingEditAccountType.action?command=<s:property value='accountTypeId'/>" data-toggle="tooltip"
	...
	<script type="text/javascript">
		var frmvalidator = new Validator("accountTypeForm");
		frmvalidator.EnableOnPageErrorDisplay();
		frmvalidator.EnableMsgsTogether();
		frmvalidator.addValidation("accountType", "req",
				"Please Enter Account Type");
		frmvalidator.addValidation("accountType", "maxlen=100",
				"Please Enter maxlen 100");
		frmvalidator.addValidation("accountType", "minlen=3",
