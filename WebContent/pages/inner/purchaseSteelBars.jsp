		...
		xmlhttp.onreadystatechange = function() {
			if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
				...
				/* var	array_element2= "<input type='text'  Class='form-control'  name='itemPrice' id='itemPrice' value='"+array.product.productPrice +"' readonly='true' />"; */
                  var	array_element1=" <input type='text' name= 'dealerAddress' placeholder= 'Address' value= '"+array.dealer.dealerAddress +"' style='width: 357px;height:35px;'  Class ='form-control' />";
				
				var	array_element2=	" <input type='text' name = 'dealerContact' placeholder = 'ContactNo' value = '"+array.dealer.dealerContact +"'  style ='width:357px;height:35px;'    Class = 'form-control' />" ;
...
function calculation(){
	...
	var quant= document.getElementById("quantityId").value*1000;
			...
			<div class="inner bg-light lter">
				...
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						...
						<s:form name="addCreatedProductForm" action="addPurchaseSteelbarsDetails"
							id="block-validate">
							<div class="box dark">
								<header>
								<div class="pull-left">
