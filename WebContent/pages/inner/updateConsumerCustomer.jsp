					...
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<ol class="breadcrumb" style="margin-top: 10px;">
							...
							<li><a href="contactsDashboard.action"><s:text
										name="Consumer"></s:text></a></li>
							<li class="active"><s:text name="Consumer Dashboard"></s:text></li>
							<li class="active"><s:text name="New Customer"></s:text></li>
						</ol>
						<s:form name="addContactForm" cssClass="form-horizontal"
							method="post" action="updateConsumerDetailsDone">
							<div class="box dark">
								<header>
								<div class="pull-left">
									<a class="icons" href="contactsDashboard.action"
										data-toggle="tooltip"
										data-original-title="Back To Consumer DashBoard"
										style="color: black;"> <i class="fa fa-th-large"></i>
									</a>
									<h5>
										<s:text name="New Consumer" />
									</h5>
								</div>
								<div class="pull-right">
									<div class="btn-group">
										...
										<a href="consumerDashboardAction" data-toggle="tooltip"
											data-original-title="Reset"
											class="btn btn-success btnheight"><i
											class="fa fa-refresh "></i></a> <a
											href="consumerDashboardAction" data-toggle="tooltip"
								...
								<div class="container-fluid">
										...
										<s:else>
											...
											<div class="alert alert-info" role="alert"
												...
												<div class="infoIcon">
													...
													<s:text name="You can see update consumer from here " />
												</div>
											</div>
										</s:else>
									</p>
									<div class="row" style="margin-top: 20px;">
										<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
											<h5 class="innertitle">
												<s:text name="Consumer Information"></s:text>
											</h5>
													...
													<%-- <div class="row">
														<div class="col-lg-3 col-md-3 col-sm-3 col-xs-3"
															...
															<div id='addContactForm_mobileNo_errorloc'
																class="error_strings"></div>
															<div id='addContactForm_mobileNum1Isd_errorloc'
																class="error_strings"></div>
														</div>
													...
													<%-- <div class="row">
														<div class="col-lg-3 col-md-3 col-sm-3 col-xs-3"
															...
															<s:textfield cssClass="form-control"
																...
																placeholder="%{getText('project.placeholder.isd')}"></s:textfield>
															<div id='addContactForm_mobileNo2_errorloc'
																class="error_strings"></div>
															<div
																id='addContactForm_mobileNum1Isd2_errorloc'
																class="error_strings"></div>
														</div>
														<div class="col-lg-9 col-md-9 col-sm-9 col-xs-9"
															style="padding-right: 0; padding-left: 0px; width: 71%">
													...
													<%-- <div class="row">
														<div class="col-lg-3 col-md-3 col-sm-3 col-xs-3"
															...
															<div id='addContactForm_homeContFaxnumStd_errorloc'
																class="error_strings"></div>
															<div id='addContactForm_faxNo_errorloc'
																class="error_strings"></div>
														</div>
														<div class="col-lg-3 col-md-3 col-sm-3 col-xs-3"
															style="padding-right: 0; padding-left: 0;">
 ...
 <script src="assets/js/script.js"></script>
	...
	<script type="text/javascript">
		...
		frmvalidator.addValidation("contactPerson", "maxlen=50",
				"Maximun Length of contactPerson  is 8");
		...
		//validations for CreatedBy
		frmvalidator.addValidation("createdBy", "req", " Enter your createdby");
		...
		//validations for product DOB
		frmvalidator.addValidation("dob", "req", " Enter your dob");
		frmvalidator.addValidation("dob", "maxlen=50",
				"Maximun Length of dob  is 6");
		
		
		//validations for phon number isd
		frmvalidator.addValidation("phoneNumberIsd", "req", " Enter your phon number isd");
		frmvalidator.addValidation("phoneNumberIsd", "maxlen=50",
	             "Maximun Length of phoneNumberIsd  is 10");
	
		//validations for phoneNo
		frmvalidator.addValidation("phoneNo", "req", " Enter your phon number");
		frmvalidator.addValidation("phoneNo", "maxlen=50",
				"Maximun Length of phoneNo  is 10");
		...
		//validations for Referred
		frmvalidator.addValidation("referredBy", "req", " Enter your referred by");
		frmvalidator.addValidation("referredBy", "maxlen=50",
				"Maximun Length of referredBy  is 15");
		

		
		//validations for addresss1
		...
		frmvalidator.addValidation("country", "maxlen=50",
				"Maximun Length of country  is 10");
		...
		frmvalidator.addValidation("pinCode", "maxlen=50",
				"Maximun Length of pinCode  is 8");
		
		//validations for phone number
		frmvalidator.addValidation("phoneNumberIsd2", "req", " Enter your phone number");
		...
		//validations for phoneNo
		frmvalidator.addValidation("phoneNo", "req", " Enter your phone number 2");
		frmvalidator.addValidation("phoneNo", "maxlen=50",
		...
		//validations for mobileNum1Isd
		frmvalidator.addValidation("mobileNum1Isd", "req", " Enter your mobile number");
		frmvalidator.addValidation("mobileNum1Isd", "maxlen=50",
				"Maximun Length of mobileNum1Isd  is 15");
		
		
		
		//validations for mobile
		frmvalidator.addValidation("mobileNo2", "req", " Enter your mobile");
		frmvalidator.addValidation("mobileNo2", "maxlen=50",
				"Maximun Length of mobileNo2 is 10\5");
		
		//validations for primary mailid
		frmvalidator.addValidation("peimaryMailId", "req", " Enter your primary mailId");
		frmvalidator.addValidation("peimaryMailId", "maxlen=50",
				"Maximun Length of peimaryMailId  is 15");
		
		//validations for alternative
		...
		//validations for home fexnum
		frmvalidator.addValidation("homeContFaxNumIsd", "req", " Enter your home Faxnum");
		frmvalidator.addValidation("homeContFaxNumIsd", "maxlen=50",
				"Maximun Length of homeContFaxNumIsd  is 15");
		
		//validations for home fax num std
		frmvalidator.addValidation("homeContFaxnumStd", "req", " Enter Home Count FaxStd");
		frmvalidator.addValidation("homeContFaxnumStd", "maxlen=50",
				"Maximun Length of homeContFaxnumStd  is 15");
		
		
		//validations for fax No                                                          
		frmvalidator.addValidation("faxNo", "req", " Enter your Fax number");
		frmvalidator.addValidation("faxNo", "maxlen=10",
				"Maximun Length of faxNo  is 1");
		
		//validations for home website
