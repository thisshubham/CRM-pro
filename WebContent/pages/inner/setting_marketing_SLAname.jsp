				...
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<ol class="breadcrumb" style="margin-top: 10px;">
							...
							<li class="active"><s:text
									name="setting.marketing.SLAname.navigation.bar"></s:text></li>
						...
						<div class="box ">
							...
							<div class="pull-right">
								<div class="btn-group">
									...
									<a href="settingMarketingSLAName.action" data-toggle="tooltip"
								...
								<div class="col-lg-12  col-md-12  col-sm-12 col-xs-12"
									...
									<ul class="nav nav-tabs" role="tablist">
										...
										<li role="presentation" class="active"><a
											href="settingMarketingSLAName.action"
															...
															<p>
																...
																<s:else>
																	...
																	<div class="infoIcon">
																		...
																		name="setting.marketing.SLAname.information.bar" />
																</s:else>
															</p>
														</div>
													</div>
														...
														<div class="row">
															...
															<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
																<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
																	<s:text name="setting.marketing.SLAname.label"></s:text>
																	<div class="star">*</div>
																</div>
																<div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">

																	<s:textfield type="text"
																		name="setting.marketing.SLAname.label"
															...
															<thead>
																<tr id="myrow">
																	...
																	<th style="width: 20%;"><s:text
																			name="setting.marketing.SLAname.id"></s:text></th>
																	<th><s:text name="setting.marketing.SLAname.label"></s:text></th>
																</tr>
															</thead>
															<tbody>
