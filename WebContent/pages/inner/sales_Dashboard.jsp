						...
						<div class="box">
							<header>
								...
								<div class="pull-right">
									<div class="btn-group">
										<a href="salesBill.action" data-toggle="tooltip"
											data-original-title="New Estimate"
											class="btn btn-primary btnheight"><i
											class="fa fa-plus fontawesomeht ">&nbsp;<%-- <s:text
													name="add.new.ticket.panel.heading"></s:text> --%>New Estimate</i></a>
										...
										<s:else>
											<div class="alert alert-info" role="alert">
												<div class="infoIcon">
													...
													You Can See Estimate Information here
												</div>
											</div>
										</s:else>
									</p>
									...
									<table id="dataTable"
										...
										<thead>
											<tr id="myrow">
												...
												<th><%-- <s:text name="add.new.ticket.ticketId"></s:text> --%>Id</th>
												<th><%-- <s:text name="add.new.ticket.category"></s:text> --%>Estimate Id</th>
												<th><%-- <s:text name="add.new.ticket.ticketOwner"></s:text> --%>Estimate Date</th>
												<th><%-- <s:text name="add.new.ticket.priority"></s:text> --%>Discription</th>
												<th><%-- <s:text name="add.new.ticket.channel"></s:text> --%>Created By</th>
												<th><%-- <s:text name="add.new.ticket.dueDate"></s:text> --%>Net Total</th>
												<th><%-- <s:text name="add.new.ticket.productName"></s:text> --%>Sub Total</th>
												<th><%-- <s:text name="add.new.ticket.contactName"></s:text> --%>Total</th>
												<th><%-- <s:text name="add.new.ticket.status"></s:text> --%>Client Name</th>
											</tr>
										</thead>
										<tbody>
											<s:iterator value="estimateList">
												<tr>
													<td align="center">
														<div class="btn-group">
													<a id="view"
														...
														<div class="btn-group">
															 <a id="edit"
																href="editTicket?command=<s:property value='id' />"
														...
														<div class="btn-group">
															...
															<a href="deleteEstimateAction?command=<s:property value='id' />"
																data-toggle="tooltip" data-original-title="Delete"
																data-placement="bottom" data-placement="bottom"> 
																<i class="fa fa-trash-o"></i>
															</a> 
													...
													<td><s:property value="estimateId" /></td>
