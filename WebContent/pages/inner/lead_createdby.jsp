...
<body>
					...
					<div class="col-lg-12">
						<div class="box">
							<header>
								...
								<h5>
									<s:text name="Search By Lead Created" />
								</h5>
											...
											<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"
												...
												<div class="row" style="margin-right: 27px;">
													<div class="col-lg-1 col-md-1 col-sm-12 col-xs-12">
														<h5>
															<label> <s:text name="Created By :" />
															</label>
															<div class="star">*</div>
														</h5>
													</div>
													<s:form name="LeadReportByLeadCreatedByForm">
														<div class="col-lg-9  col-md-9 col-sm-12 col-xs-12">
															<div class="row">
																<div class="col-lg-3 col-md-3 col-sm-9 col-xs-7">
																	<!-- <input type="text" name="leadDate" value=""
																	id="dp3" class="form-control"> -->
																	<s:select list="customerNameList" headerKey="-1"
																		headerValue="Select Create By" name="createBy"
																		cssClass="form-control"></s:select>
																	<div
																		id='LeadReportByLeadCreatedByForm_createBy_errorloc'
																...
																<div class="col-lg-2 col-md-3 col-sm-9 col-xs-7">
																	...
																	<div
																		id='LeadReportByLeadCreatedByForm_leadStartDate_errorloc'
																		class="error_strings"></div>
																</div>
																...
																<div class="col-lg-2 col-md-3 col-sm-9 col-xs-7">
																	<s:textfield name="leadEndDate"
																		...
																		cssClass="form-control" />
																	<div
																		id='LeadReportByLeadCreatedByForm_leadEndDate_errorloc'
																		class="error_strings"></div>
									...
									<table id="dataTable"
										...
										<thead>
											<tr id="myrow">
												...
												<th><s:text name="update.group.createdby"></s:text></th>
	...
	<script type="text/javascript">
		var frmvalidator = new Validator("LeadReportByLeadCreatedByForm");
		frmvalidator.EnableOnPageErrorDisplay();
		frmvalidator.EnableMsgsTogether();

		frmvalidator.addValidation("createBy", "dontselect=-1",
				"Select Lead Created By");
		...
		function DoCustomValidation() {
			var frm1 = document.forms["LeadReportByLeadCreatedByForm"];
